...
def qsar_assay_fingerprint_analysis(aid_input):
    ...
    X_train, X_test, Y_train, Y_test = train_test_split(result_df.drop('Activity', axis=1), result_df['Activity'], test_size=0.4, random_state=42)
