...
# systemq or qlisp or qlispc
try:
    from qlisp import Capture, Signal
    ...
    from qlispc import Capture, Signal
    from qlispc import compile as _compile
    from qlispc import get_arch, register_arch
