...
class LongTermRaoABC():
    ...
    def __init__(self, * , ssList, dss, nModes, sht_engine = "SpectralMoments", engine = "python") :
...
class LongTermRao(LongTermRaoABC):
    ...
    def __init__(self, rao, ssList, dss, sht_engine = "SpectralMoments", engine = "python") :
        """Compute long-term value, using scatter-diagram and RAO as input.
        ...
        LongTermRaoABC.__init__(self, dss = dss, ssList = ssList, nModes = self.rao.getNModes(), engine = engine)
...
class LongTermSD( LongTermRao ):
    ...
    def __init__(self, rao , sd, nb_hstep, gamma, spreadingType = sp.SpreadingType.No, 
                 spreadingValue = 3., dss = 10800, sht_engine = "SpectralMoments", num_threads = 1, engine = "python"):
        """Compute long-term value, using scatter-diagram and RAO as input.
        ...
        LongTermRao.__init__(self, rao , ssList = ssList, sht_engine = sht_engine, dss = dss, engine = engine )
