...
def test(exchangeName="", params={}):
    ...
    if "createLimitOrder" in params and params["createLimitOrder"]:
        print("testing create order...")
        try:
            resp = ttxtExchange.create_limit_order(symbol=tickerToTest, amount=100, side="buy", price=0.040)
    ...
    if "create_market_order" in params and params["create_market_order"]:
        ...
        try:
            resp = ttxtExchange.create_market_order(symbol=tickerToTest, side="buy", amount=100)
    ...
    if "cancelOrder" in params and params["cancelOrder"]:
        ...
        try:
            resp = ttxtExchange.cancel_order(id=1765447011198390272, symbol=tickerToTest)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, 
                     ...
                     "myTrades": False}
    test(params=testingParams, exchangeName="bitget")
