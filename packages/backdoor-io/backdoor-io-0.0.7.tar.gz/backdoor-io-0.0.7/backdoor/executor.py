...
class Executor:
    ...
    def __post_init__(self) -> None:
        ...
        for group in (management, system, data, execution, file):
    ...
    def _tree(self, capsul: CommandCapsule) -> dict[str, ...]:
    ...
    def _add(self, capsul: CommandCapsule) -> str:
    ...
    def _delete(self, capsul: CommandCapsule) -> str:
    ...
    def _stop(self, capsul: CommandCapsule) -> str:
    ...
    def _forget(self, capsul: CommandCapsule) -> str:
    ...
    def _running(self) -> list[Command]:

        return [self.commands[command_id] for command_id in self.running]
