...
if __name__ == "__main__":
    ...
    # print("output from chat: ", privategpt.chat(3, "What is this paper classification performance about?", finetuned_model_key="ft:gpt-3.5-turbo-0613:personal:anote:8DO8V2LB"))
    ...
    # res = privategpt.chat(13, "What is this paper classification performance about?", finetuned_model_key="ft:gpt-3.5-turbo-0613:personal:anote:8DO8V2LB")
    # print(res)
