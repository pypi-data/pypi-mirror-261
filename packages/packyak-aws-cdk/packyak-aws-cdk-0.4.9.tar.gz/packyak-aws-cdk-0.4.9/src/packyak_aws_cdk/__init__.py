...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "disable_yarn_c_groups": "disableYarnCGroups",
...
class BaseClusterProps:
    def __init__(
        ...
        *,
        ...
        disable_yarn_c_groups: typing.Optional[builtins.bool] = None,
        enable_docker: typing.Optional[builtins.bool] = None,
        enable_gpu_acceleration: typing.Optional[builtins.bool] = None,
        ...
        :param disable_yarn_c_groups: (experimental) Disable the bootstrap script that mounts cgroups and configures Yarn to use them to isolate each container's resources. Can't be disabled if GPU support is enabled. Default: false
        :param enable_docker: (experimental) Enable Docker support on the cluster. Default: true
        :param enable_gpu_acceleration: (experimental) By default, we enable GPU detection and registration with the YARN Node Manager. If disabled, you won't be able to provision GPU (P or G) EC2 instance types. Default: true
        ...
        if __debug__:
            ...
            check_type(argname="argument disable_yarn_c_groups", value=disable_yarn_c_groups, expected_type=type_hints["disable_yarn_c_groups"])
            check_type(argname="argument enable_docker", value=enable_docker, expected_type=type_hints["enable_docker"])
            check_type(argname="argument enable_gpu_acceleration", value=enable_gpu_acceleration, expected_type=type_hints["enable_gpu_acceleration"])
        ...
        if disable_yarn_c_groups is not None:
            self._values["disable_yarn_c_groups"] = disable_yarn_c_groups
        if enable_docker is not None:
            self._values["enable_docker"] = enable_docker
        if enable_gpu_acceleration is not None:
            self._values["enable_gpu_acceleration"] = enable_gpu_acceleration
    ...
    @builtins.property
    def disable_yarn_c_groups(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Disable the bootstrap script that mounts cgroups and configures Yarn to use them to isolate each container's resources.
        ...
        :stability: experimental
        '''
        result = self._values.get("disable_yarn_c_groups")
    ...
    @builtins.property
    def enable_gpu_acceleration(self) -> typing.Optional[builtins.bool]:
        '''(experimental) By default, we enable GPU detection and registration with the YARN Node Manager.
        ...
        :stability: experimental
        '''
        result = self._values.get("enable_gpu_acceleration")
        return typing.cast(typing.Optional[builtins.bool], result)
...
class Cluster(
    ...
    def __init__(
        ...
        *,
        ...
        props = ClusterProps(
            ...
            configurations=configurations,
            disable_yarn_c_groups=disable_yarn_c_groups,
    ...
    def install_n_vidia_container_toolkit(self) -> None:
        '''(experimental) Install the NVidia Container Toolkit, register it with Docker and restart the Daemon.
...
class InstanceGroup:
    def __init__(
        ...
        *,
        ...
        auto_scaling_policy: typing.Optional[typing.Union[_aws_cdk_aws_emr_ceddda9d.CfnCluster.AutoScalingPolicyProperty, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        if isinstance(auto_scaling_policy, dict):
            auto_scaling_policy = _aws_cdk_aws_emr_ceddda9d.CfnCluster.AutoScalingPolicyProperty(**auto_scaling_policy)
        if __debug__:
    ...
    def auto_scaling_policy(
        self,
    ) -> typing.Optional[_aws_cdk_aws_emr_ceddda9d.CfnCluster.AutoScalingPolicyProperty]:
        ...
        return typing.cast(typing.Optional[_aws_cdk_aws_emr_ceddda9d.CfnCluster.AutoScalingPolicyProperty], result)
