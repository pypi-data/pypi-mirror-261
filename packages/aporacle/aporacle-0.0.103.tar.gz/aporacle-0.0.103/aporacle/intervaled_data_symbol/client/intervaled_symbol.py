...
class IntervaledSymbol(Symbol):
    ...
    def create_prices_output_record(self, chain: str, epoch: int):
        prices = {"chain": chain, "epoch": epoch, "symbol": self.symbol, "asset": self.asset, "type": "prices"}
    ...
    def create_returns_output_record(self, chain: str, epoch: int):
        returns = {"chain": chain, "epoch": epoch, "symbol": self.symbol, "asset": self.asset, "type": "returns"}
