...
def python_project_options(
    ...
    def decorator(func):
        ...
        @optgroup.option(
            "--project-root",
            help="This should be the directory location of the Python project that will analyzed.",
...
def typescript_project_options(
    option_group_help_text: str, action: Literal["register"]
):
