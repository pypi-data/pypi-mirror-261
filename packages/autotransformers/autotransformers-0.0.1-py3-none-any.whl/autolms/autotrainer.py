...
class AutoTrainer:
    """
    Main class of autolms. Fine-tune and evaluate several models on several datasets.
    ...
    Parameters
    ----------
    model_configs: List[autolms.ModelConfig]
    ...
    dataset_configs: List[autolms.DatasetConfig]
        Configurations for the datasets, instances of DatasetConfig, each describing
        how each dataset should be processed.
    metrics_dir: str
        Directory to save the metrics for the experiments, as returned by `autolms.ResultsGetter`.
    hp_search_mode: str
    ...
    clean: bool
        ...
        using autolms.CkptCleaner. Best model checkpoint is also saved when unuseful
    ...
    skip_mixes: List[autolms.SkipMix]
    ...
    def train_one_model_fixed_params(
        ...
        Parameters
        ----------
        model_config: autolms.ModelConfig
            Configuration for the model.
        dataset_config: autolms.DatasetConfig,
