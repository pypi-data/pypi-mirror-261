...
def create_resource_group(
    ...
    # The --id option is actually completely ignored, and redundant with the argument (which itself is manipulated by the ApiResourceGroup class)
    # It's here mainly to allow auto-completion (OhMyZsh, Fig, etc)
    @click.option(
        "-i",
        "--id",
        help=f"Identifier of the {resource_title}. "
        "It is an alternative to providing it directly as an argument, and is mainly used for auto-completion purposes.",
