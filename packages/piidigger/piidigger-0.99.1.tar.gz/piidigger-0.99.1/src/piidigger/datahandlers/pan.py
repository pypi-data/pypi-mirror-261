...
def findMatch(line: str) -> dict:
    ...
    # If you know of more, or can shed light on any corrections, please submit an issue at https://github.com/flyguy62n/PIIDigger/issues or submit a PR on the repo
