...
- Pre-built binaries for Windows (see [dist](https://github.com/flyguy62n/PIIDigger/dist/) folder)
...
Just remember to re-activate your virtual environment before you run PIIDigger again in the future.
### Binary Packages
If Python is not available, you can download OS-specific binaries from the [dist/](https://github.com/flyguy62n/PIIDigger/dist/) folder above.
