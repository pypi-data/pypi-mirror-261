...
import piidigger.console as console
import piidigger.filescan as filescan
...
def commandLineParser() -> argparse.ArgumentParser:
    ...
    configControl.add_argument(
        ...
        default=0,
        type=int,
        help='Override the number processes to use for searching files.  Will use the lesser of CPU cores or this value.  On production servers, consider setting this to less than the number of logical CPUs.  See \'--cpu-count\' below.',
        )
