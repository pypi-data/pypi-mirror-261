...
from typing import Any, Callable, Generic, Iterable, Iterator, Literal, Never, Optional, Self, TypeGuard, TypeVar, TypedDict, Union, overload
...
class Graph:
    ...
    def __getitem__(self, cls : type[T]) -> IsoSet[T]:
        ...
        """
        vertices = Graph.__IsoSet(v for v in self.vertices if isinstance(v, cls))
        edges = Graph.__IsoSet(e for e in self.edges if isinstance(e, cls))
...
del RLock, Thread, Any, Callable, Iterable, Iterator, Generic, Literal, Never, Optional, TypeVar, TypedDict, Union, WeakKeyDictionary, WeakValueDictionary, Color, ColorSetting, SizeSetting, SwitchSetting, WeightSetting, InstanceReferencingClass, IsoSet, T