...
class ORMInstance(IDatabaseService):
    ...
    def select_from_json(self, json_input: str, table_name: str) -> List:
    ...
    def insert(self, dictionary_input: Dict[str, Any], table_name: str) -> ResultSet:
        try:
    ...
    def delete(self, dictionary_input: Dict[str, Any], table_name: str) -> ResultSet:
        try:
    ...
    def _bind_delete_or_insert(self, filtered_columns: Dict[str, Column],
                               prepared_statement: PreparedStatement) -> ResultSet:
