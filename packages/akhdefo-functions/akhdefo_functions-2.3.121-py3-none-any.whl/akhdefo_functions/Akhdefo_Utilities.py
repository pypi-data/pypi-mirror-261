...
def measure_displacement_from_camera(hls_url, alpha=0.1, save_output=False, output_filename=None, ssim_threshold=0.4, 
    ...
    while True:
       ...
       # Create a figure and two subplots for min and max displacements
        fig2, (ax2, ax1) = plt.subplots(2, 1, sharex=False, figsize=(15, 10), constrained_layout=True)
        ...
        ax1.set_ylabel('Displacement', fontsize=12, fontweight='bold', color='darkred')
        ax1.set_xlabel('Time', fontsize=12, fontweight='bold', color='darkred')

        # Add a title
        ax1.set_title('Minimum and Maximum Displacement Over Time in Pixel Unit', fontsize=14, fontweight='bold', color='navy')
        ...
        #  # Resize the colorbar to match the image height
        minmax_plot = cv2.resize(plt_img2, (frame_width, frame_height))
        plt.close('all')
