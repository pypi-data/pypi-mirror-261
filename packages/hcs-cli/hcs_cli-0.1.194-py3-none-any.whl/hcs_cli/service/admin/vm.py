...
class VM:
    ...
    def wait_for_agent_available(self, timeout: str):
        return self.wait_for(
            field="agentStatus", expected_values="AVAILABLE", unexpected_values=["ERROR"], timeout=timeout
        )

    def wait_for(self, field: str, expected_values: list, unexpected_values: list, timeout: str):
        name = "vm/" + id
