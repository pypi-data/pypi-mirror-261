...
class CreateBatchTransferRequestTransfersInner(BaseModel):
    """
    ...
    beneficiary_details: Optional[CreateBatchTransferRequestTransfersInnerBeneficiaryDetails] = None
    ...
    fundsource_id: Optional[StrictStr] = Field(None, description="It is the ID of the fund source from where you want to debit the transfer amount.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBatchTransferRequestTransfersInner:
        """Create an instance of CreateBatchTransferRequestTransfersInner from a JSON string"""
        return cls.from_dict(json.loads(json_str))
    
    @classmethod
    def from_json_for_one_of(cls, json_str: str) -> CreateBatchTransferRequestTransfersInner:
        """Create an instance of CreateBatchTransferRequestTransfersInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBatchTransferRequestTransfersInner:
        """Create an instance of CreateBatchTransferRequestTransfersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBatchTransferRequestTransfersInner.parse_obj(obj)

        _obj = CreateBatchTransferRequestTransfersInner.parse_obj({
            ...
            "beneficiary_details": CreateBatchTransferRequestTransfersInnerBeneficiaryDetails.from_dict(obj.get("beneficiary_details")) if obj.get("beneficiary_details") is not None else None,
