...
def operator_presets_cleanup(
        ...
        *,
        ...
        properties: typing.Optional[bpy.types.bpy_prop_collection[
            'bpy.types.OperatorFileListElement']] = None):
    ''' Remove outdated operator properties from presets that may cause problems :File: `startup/bl_operators/presets.py\:697 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/presets.py#L697>`__
