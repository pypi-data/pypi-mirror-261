...
class PointCloudConfig(Buffer):
    ...
    def getTransformationMatrix(self) -> List[List[float[4]][4]]: ...
    def set(self, config: RawPointCloudConfig) -> PointCloudConfig: ...
    def setSparse(self, arg0: bool) -> PointCloudConfig: ...
    @overload
    def setTransformationMatrix(self, arg0: List[List[float[3]][3]]) -> PointCloudConfig: ...
    @overload
    def setTransformationMatrix(self, arg0: List[List[float[4]][4]]) -> PointCloudConfig: ...
...
class RawPointCloudConfig(RawBuffer):
    sparse: bool
    transformationMatrix: List[List[float[4]][4]]
    def __init__(self) -> None: ...
