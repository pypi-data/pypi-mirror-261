...
class IntellisenseResponse(object):
    ...
    def __init__(self, auto_complete_list=None, try_again_soon_for_more=None, sql_with_marker=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param sql_with_marker:  The overall SQL this is for with a character marker for where the Intellisense is for (required)
    ...
    def sql_with_marker(self):
        ...
        The overall SQL this is for with a character marker for where the Intellisense is for  # noqa: E501
