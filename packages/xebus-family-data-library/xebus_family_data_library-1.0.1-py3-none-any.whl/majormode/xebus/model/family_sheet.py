...
from majormode.xebus.utils.family_sheet import normalize_key, normalize_names_codes_mapping
...
class FamilyDataSectionedSheet(SectionedSheet):
    ...
    def __init__(
        ...
        self.__grades_names_mapping: dict[str, int] = normalize_names_codes_mapping(grades_names_mapping)

        self.__languages_names_mapping: dict[str, Locale] | None = languages_names_mapping \
            and normalize_names_codes_mapping(languages_names_mapping)

        self.__nationalities_names_mapping: dict[str, Country] | None = nationalities_names_mapping \
            and normalize_names_codes_mapping(nationalities_names_mapping)
