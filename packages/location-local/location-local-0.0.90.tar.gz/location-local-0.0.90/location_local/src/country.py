...
class CountriesLocal(GenericCRUD):
    ...
    @staticmethod
    def get_country_id_by_country_name(country_name: str,
        ...
        country_id_json = CountriesLocal.country_ml.select_one_dict_by_where(
    ...
    def get_country_name(location: str) -> str:
        ...
        geocoder = OpenCageGeocode(our_get_env("OPENCAGE_KEY"))
