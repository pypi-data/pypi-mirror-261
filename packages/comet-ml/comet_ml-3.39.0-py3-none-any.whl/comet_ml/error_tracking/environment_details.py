...
def collect() -> Dict[str, Any]:
    """Return environment details without personally identifiable information"""
    ...
    result = {
        ...
        "user": env_logging.get_user(),
        "python_exe": sys.executable,
        "sdk_version": env_logging.get_comet_version(),
        ...
        "cuda_visible_devices": _get_cuda_visible_devices(),
    }
