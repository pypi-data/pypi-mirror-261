...
def make_chat_completion(
        **kwargs
        ...
        import sys
        is_running_inside_notebook = ('ipykernel' in sys.modules)
        if is_running_inside_notebook:
            print("Warning you are running inside Jupyter notebook and this will block the kernel. Use 'amake_chat_completion' instead.")
        return asyncio.run(amake_chat_completion(**kwargs))
