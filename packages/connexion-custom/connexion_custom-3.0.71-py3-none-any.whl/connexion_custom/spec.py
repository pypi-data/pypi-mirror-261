...
class Swagger2Specification(Specification):
    ...
    openapi_schema = json.loads(
        pkgutil.get_data("connexion_custom", "resources/schemas/v2.0/schema.json")  # type: ignore
    )
...
class OpenAPISpecification(Specification):
    ...
    openapi_schema = json.loads(
        pkgutil.get_data("connexion_custom", "resources/schemas/v3.0/schema.json")  # type: ignore
    )
