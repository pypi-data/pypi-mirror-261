...
from connexion_custom.exceptions import TypeValidationError
from connexion_custom.utils import all_json, coerce_type, deep_merge

logger = logging.getLogger("connexion_custom.decorators.uri_parsing")
...
class AlwaysMultiURIParser(Swagger2URIParser):
    ...
    connexion_custom behavior in version 1.4.2
    """
