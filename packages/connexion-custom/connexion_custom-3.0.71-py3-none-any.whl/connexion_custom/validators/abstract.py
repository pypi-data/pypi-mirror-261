...
from connexion_custom.exceptions import BadRequestProblem
...
class AbstractRequestBodyValidator:
    ...
    def _validate(self, body: t.Any) -> t.Optional[dict]:
        ...
        :raises: :class:`connexion_custom.exceptions.BadRequestProblem`
        """
...
class AbstractResponseBodyValidator:
    ...
    def _validate(self, body: t.Any) -> t.Optional[dict]:
        ...
        :raises: :class:`connexion_custom.exceptions.NonConformingResponse`
        """
