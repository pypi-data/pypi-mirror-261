...
from connexion_custom import jsonifier
from connexion_custom.frameworks.abstract import Framework
from connexion_custom.lifecycle import WSGIRequest
...
class Flask(Framework):
    ...
    @classmethod
    def connexion_custom_to_framework_response(cls, response):
...
class FlaskJSONProvider(flask.json.provider.DefaultJSONProvider):
    """Custom JSONProvider which adds connexion_custom defaults on top of Flask's"""
