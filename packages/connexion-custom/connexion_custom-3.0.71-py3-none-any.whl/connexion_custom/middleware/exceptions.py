...
from connexion_custom import http_facts
from connexion_custom.exceptions import InternalServerError, ProblemException, problem
...
class ExceptionMiddleware(StarletteExceptionMiddleware):
    ...
    existing connexion_custom behavior."""
    ...
    def add_exception_handler(
        ...
        super().add_exception_handler(
            exc_class_or_status_code, handler=connexion_custom_wrapper(handler)
        )
