...
from connexion_custom.exceptions import InternalServerError
from connexion_custom.lifecycle import ConnexionRequest, ConnexionResponse
from connexion_custom.middleware.exceptions import connexion_custom_wrapper
...
class ServerErrorMiddleware(StarletteServerErrorMiddleware):
    ...
    exceptions to existing connexion_custom behavior."""
    ...
    def __init__(
        ...
        handler = connexion_custom_wrapper(handler) if handler else None
