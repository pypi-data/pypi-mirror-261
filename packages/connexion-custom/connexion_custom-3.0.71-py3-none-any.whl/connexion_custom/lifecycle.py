...
from connexion_custom.utils import is_json_mimetype


class _RequestInterface:
    @property
    def context(self) -> t.Dict[str, t.Any]:
        """The connexion_custom context of the current request cycle."""
...
class WSGIRequest(_RequestInterface):
    ...
    def context(self):
        if self._context is None:
            ...
            self._context = extensions.setdefault("connexion_custom_context", {})
