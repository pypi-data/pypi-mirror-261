...
try:
    from connexion_custom.apps.flask import FlaskApi, FlaskApp
...
from connexion_custom.apps.asynchronous import AsyncApi, AsyncApp
from connexion_custom.context import request
from connexion_custom.middleware import ConnexionMiddleware
