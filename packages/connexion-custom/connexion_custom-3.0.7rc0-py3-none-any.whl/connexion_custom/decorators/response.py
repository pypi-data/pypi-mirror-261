...
from connexion_custom.context import operation
from connexion_custom.datastructures import NoContent
...
from connexion_custom.lifecycle import ConnexionResponse
    ...
    def __call__(self, function: t.Callable) -> t.Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if self.framework.is_framework_response(handler_response):
                ...
                return self.framework.connexion_custom_to_framework_response(handler_response)
            else:
