...
from connexion_custom.frameworks import starlette as starlette_utils
from connexion_custom.middleware.abstract import (
    ROUTING_CONTEXT,
    AbstractRoutingAPI,
    SpecMiddleware,
)
...
class RoutingOperation:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        connexion_custom_routing = extensions.setdefault(ROUTING_CONTEXT, {})
        connexion_custom_routing.update(
