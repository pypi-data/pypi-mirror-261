...
extra_requires = {'conda': dependencies.get(platform.system().lower(), ['bowtie'])}
console_scripts = {'console_scripts': [
    'wanglab.bat=python %~dp0/wanglab %*'
]}
console_scripts = console_scripts if platform.system().lower() == 'windows' else {}
# install_requires += extra_requires.get('conda', [])
