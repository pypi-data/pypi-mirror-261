...
import chainfury.chat as chat_type
...
class Action:
    ...
    def __call__(self, *args, **kwargs):
        # if len(args):
        #     # just tell the dev this, it'll figure the rest out
        #     raise ValueError(
        #         "Only keyword arguments are allowed.\nPass everything as key = value"
        #     )
