...
class RegisterCallRequestBody:
    ...
    to_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('from_number'), 'exclude': lambda f: f is None }})
