...
class CreateAgentRequestBody:
    ...
    activate_hipaa_compliance: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('activate_hipaa_compliance'), 'exclude': lambda f: f is None }})
