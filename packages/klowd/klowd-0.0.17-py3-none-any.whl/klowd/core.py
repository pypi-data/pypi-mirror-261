...
class Drive:
    klowdUrl='https://klowd.ru'
    kloud_token=None
    
    def grant_access(self, kloudUrl=None):
        if kloudUrl is not None:
            self.klowdUrl = kloudUrl
    ...
    async def fetch(self, url, **kwargs):
        ...
        return await pyodide.http.pyfetch(f'{self.klowdUrl}{url}', **modified_kwargs, headers=headers)
