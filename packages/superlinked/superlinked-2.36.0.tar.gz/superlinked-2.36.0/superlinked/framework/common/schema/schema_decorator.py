...
from superlinked.framework.common.schema.exception import MultipleIdFieldException
...
class SchemaDecorator:
    ...
    def __get_decorated(
        ...
        id_field_name: str = SchemaDecorator.__get_id_field_name(schema_cls)
