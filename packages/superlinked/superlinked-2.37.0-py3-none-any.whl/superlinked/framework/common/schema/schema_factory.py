...
class SchemaFactory:
    ...
    def __generate(
        ...
        self.__schema_validators[schema_type].check_class_attributes(cls)
        self.__schema_validators[schema_type].check_unannotated_members(cls)
        ...
        return SchemaDecorator.decorate(
            cls, schema_type, schema_name, schema_field_descriptors
        )
