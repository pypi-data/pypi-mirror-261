...
class RecencySpace(Space):
    ...
    def __init__(
        ...
        self.timestamp = SpaceFieldSet(self, cast(set[SchemaField], self.field_set))
    ...
    def __run_parameter_checks(self) -> None:
        ...
        if any(param.weight < 0 for param in self.period_time_list):
            logger.warning(
                ...
                "Check an example notebook at: https://github.com/superlinked/superlinked-alpha/blob/main"
