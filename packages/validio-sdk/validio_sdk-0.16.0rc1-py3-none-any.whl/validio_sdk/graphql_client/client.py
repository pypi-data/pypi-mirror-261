...
from .input_types import (
    ...
    TableauCredentialSecretChangedInput,
...
from .tableau_credential_secret_changed import (
    TableauCredentialSecretChanged,
    TableauCredentialSecretChangedTableauCredentialSecretChanged,
)
...
class Client(AsyncBaseClient):
    ...
    async def tableau_credential_secret_changed(
        self, input: TableauCredentialSecretChangedInput
    ) -> TableauCredentialSecretChangedTableauCredentialSecretChanged:
        query = gql(
            """
            query TableauCredentialSecretChanged($input: TableauCredentialSecretChangedInput!) {
              tableauCredentialSecretChanged(input: $input) {
                ...CredentialSecretChanged
              }
            }
        ...
        response = await self.execute(query=query, variables=variables)
        data = self.get_data(response)
        return TableauCredentialSecretChanged.model_validate(
            data
        ).tableau_credential_secret_changed
