    ...
    credential: Optional[
        Annotated[
            Union[
                ...
                "CredentialCreationCredentialTableauCredential",
            ],
            Field(discriminator="typename__"),
        ]
    ]
...
class CredentialCreationCredentialTableauCredential(BaseModel):
    typename__: Literal["TableauCredential"] = Field(alias="__typename")
    id: CredentialId
    name: str
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    resource_name: str = Field(alias="resourceName")
    resource_namespace: str = Field(alias="resourceNamespace")
    stats: "CredentialCreationCredentialTableauCredentialStats"
    config: "CredentialCreationCredentialTableauCredentialConfig"


class CredentialCreationCredentialTableauCredentialStats(BaseModel):
    source_count: int = Field(alias="sourceCount")
    catalog_asset_count: int = Field(alias="catalogAssetCount")


class CredentialCreationCredentialTableauCredentialConfig(BaseModel):
    host: str
    site: str
    user: str
    client_id: str = Field(alias="clientId")
    ...
    credential: Optional[
        Annotated[
            Union[
                ...
                "CredentialUpdateCredentialTableauCredential",
            ],
            Field(discriminator="typename__"),
        ]
    ]
...
class CredentialUpdateCredentialTableauCredential(BaseModel):
    typename__: Literal["TableauCredential"] = Field(alias="__typename")
    id: CredentialId
    name: str
    created_at: datetime = Field(alias="createdAt")
    ...
    resource_name: str = Field(alias="resourceName")
    resource_namespace: str = Field(alias="resourceNamespace")
    stats: "CredentialUpdateCredentialTableauCredentialStats"
    config: "CredentialUpdateCredentialTableauCredentialConfig"


class CredentialUpdateCredentialTableauCredentialStats(BaseModel):
    source_count: int = Field(alias="sourceCount")
    catalog_asset_count: int = Field(alias="catalogAssetCount")


class CredentialUpdateCredentialTableauCredentialConfig(BaseModel):
    host: str
    site: str
    user: str
    client_id: str = Field(alias="clientId")
...
CredentialCreationCredentialTableauCredential.model_rebuild()
CredentialCreationCredentialTableauCredentialStats.model_rebuild()
CredentialCreationCredentialTableauCredentialConfig.model_rebuild()
...
CredentialUpdateCredentialTableauCredential.model_rebuild()
CredentialUpdateCredentialTableauCredentialStats.model_rebuild()
CredentialUpdateCredentialTableauCredentialConfig.model_rebuild()
