    ...
    credential_by_resource_name: Optional[
        Annotated[
            Union[
                ...
                "GetCredentialByResourceNameCredentialByResourceNameTableauCredential",
            ],
...
class GetCredentialByResourceNameCredentialByResourceNameTableauCredential(BaseModel):
    ...
    resource_name: str = Field(alias="resourceName")
    resource_namespace: str = Field(alias="resourceNamespace")
    stats: "GetCredentialByResourceNameCredentialByResourceNameTableauCredentialStats"
    config: "GetCredentialByResourceNameCredentialByResourceNameTableauCredentialConfig"


class GetCredentialByResourceNameCredentialByResourceNameTableauCredentialStats(
    BaseModel
):
    source_count: int = Field(alias="sourceCount")
    catalog_asset_count: int = Field(alias="catalogAssetCount")
...
class GetCredentialByResourceNameCredentialByResourceNameTableauCredentialConfig(
    BaseModel
):
    host: str
    site: str
...
GetCredentialByResourceNameCredentialByResourceNameTableauCredential.model_rebuild()
GetCredentialByResourceNameCredentialByResourceNameTableauCredentialStats.model_rebuild()
GetCredentialByResourceNameCredentialByResourceNameTableauCredentialConfig.model_rebuild()
