    ...
    credentials_list: List[
        Annotated[
            Union[
                ...
                "ListCredentialsCredentialsListTableauCredential",
            ],
...
class ListCredentialsCredentialsListTableauCredential(BaseModel):
    ...
    resource_name: str = Field(alias="resourceName")
    resource_namespace: str = Field(alias="resourceNamespace")
    stats: "ListCredentialsCredentialsListTableauCredentialStats"
    config: "ListCredentialsCredentialsListTableauCredentialConfig"


class ListCredentialsCredentialsListTableauCredentialStats(BaseModel):
    source_count: int = Field(alias="sourceCount")
    catalog_asset_count: int = Field(alias="catalogAssetCount")


class ListCredentialsCredentialsListTableauCredentialConfig(BaseModel):
    host: str
    site: str
    user: str
    client_id: str = Field(alias="clientId")
...
ListCredentialsCredentialsListTableauCredential.model_rebuild()
ListCredentialsCredentialsListTableauCredentialStats.model_rebuild()
ListCredentialsCredentialsListTableauCredentialConfig.model_rebuild()
