...
# SpandrelLabel - cSpandrelLabel interface
...
class SpandrelLabel:
    ...
    def get_name_list(self) -> SpandrelNameList:
        ...
        is_multi_story = [bool()]
        [ret, _number_names,
         spandrel_name, is_multi_story] = self.spandrel_label.GetNameList(_number_names,
                                                                          spandrel_name,
                                                                          is_multi_story)
        handle(ret)
    ...
    def get_section_properties(self, spandrel_name: str) -> SectionProperties:
        ...
        [ret, number_stories, story_name,
         ...
         cg_right_x, cg_right_y, cg_right_z] = self.spandrel_label.GetSectionProperties(spandrel_name, number_stories,
                                                                                        story_name,
                                                                                        num_area_obj, num_line_obj,
                                                                                        length, depth_left,
                                                                                        thickness_left,
                                                                                        depth_right, thickness_right,
                                                                                        mat_prop,
                                                                                        cg_left_x, cg_left_y, cg_left_z,
                                                                                        cg_right_x, cg_right_y,
                                                                                        cg_right_z)
        handle(ret)
        return {'spandrel_name': spandrel_name,
