...
for series_number, series in study.series_dictionary.items():
    for index, volume in enumerate(series.get_volume_list()):
        print(f"\nSeries# {series_number} Vol.# {index}")
        d = volume.get_volume_dictionary()
        print(f"Image Type_TRACEW: {d['Image Type_TRACEW']}")
        print(f"Image Type: {d['ImageType']}")
        print(f"likely_diffusion: {d['likely_diffusion']}")
        print(f"Diffusionb-value: {d['Diffusionb-value']}")
        print(f"HasDiffusionGradientOrientation: {d['HasDiffusionGradientOrientation']}")
        print(volume.diffusion_gradient)
