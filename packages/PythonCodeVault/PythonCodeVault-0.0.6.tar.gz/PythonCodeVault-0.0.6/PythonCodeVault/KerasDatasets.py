...
class BinaryClassificationDataset(Sequence):
    ...
    def __init__(self, base_dir = './data', fail_folder = 'Fail', pass_folder = 'Pass', batch_size = 32, augmentations = None, shuffle_data = True, extension = 'tiff', tiff_layer = [0], json_shape = (224,224,1), dtype = np.float32):
