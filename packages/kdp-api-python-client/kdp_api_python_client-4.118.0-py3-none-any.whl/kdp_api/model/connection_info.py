"""
    ...
    The version of the OpenAPI document: 4.118.0
...
class ConnectionInfo(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            process_with_ocr (bool): URL and S3 data sources only - Process the Uploaded PDF and image files (JPG, PNG and TIFF) with OCR. Setting this value to true will result in the file being processed with text recognition, storing the OCR extracted text in the body of the dataset record; if left as the default setting of false, the body element will not be set or returned in the dataset record. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
