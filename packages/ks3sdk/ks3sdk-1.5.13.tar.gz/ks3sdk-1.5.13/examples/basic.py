...
def uploadObjectFromFile(filename):
  ...
  ret = k.set_contents_from_filename('/Users/jiahua/Downloads/' + filename, encrypt_key=True)
...
def downloadObjectAndSave(bucket_name, key_name, headers=None):
  ...
  ret = k.get_contents_to_filename('/Users/jiahua/Downloads/test_download', headers=headers)
  print(ret)
...
downloadObjectAndSave(bucket_name, '307_test', headers={
  'range': 'bytes=0-5'
})
# count = 20
# while True:
# uploadObjectFromFile('zuoxiao009.jpg')
