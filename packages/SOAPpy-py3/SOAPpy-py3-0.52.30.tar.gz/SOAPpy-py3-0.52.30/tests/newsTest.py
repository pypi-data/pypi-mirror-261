...
SoapEndpointURL = (
    "http://www22.brinkster.com/prasads/BreakingNewsService.asmx?WSDL"
)
...
server = SOAPProxy(
    ...
    soapaction="http://tempuri.org/GetCNNNews",
    encoding=None,
    http_proxy=proxy,
)
...
print(
    server._ns("ns1", MethodNamespaceURI)
    ._sa("http://tempuri.org/GetCNNNews")
    .GetCNNNews()
)
