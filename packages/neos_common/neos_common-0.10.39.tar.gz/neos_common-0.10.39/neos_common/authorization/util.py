...
PermissionArgs = typing.Union[
    ...
    typing.Tuple[base.Action, base.ResourceType, typing.Optional[str]],
    # action, resource_type, resource_id, partition, account_id
    typing.Tuple[base.Action, base.ResourceType, typing.Optional[str], typing.Optional[str], typing.Optional[str]],
]
