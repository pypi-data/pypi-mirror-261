...
class wrapper_jira:
    def __init__(self, jira_api, debug = False):
        ...
        self._n8n_auth = (jira_api["N8N_USERNAME"], jira_api["N8N_PASSWORD"])
    ...
    def _issue_factory(self, issue):
        ...
        if not issue['allocation_data']:
            ...
            item = {
                ...
                'cod_imposto': 'C6',
                'valor_bruto': issue['json_data']['Valor'].replace('.', ',')
            }
    ...
    def _get_nf_jira(self, issue_id):
        try:
            ...
            chave_acesso = form_request.json()["state"]["answers"]["1"]["text"]
