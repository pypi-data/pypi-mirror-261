...
class CreateInterface(BaseCreateInterface):
    ...
    def digestion(
        ...
        lock_token_passed: Optional[str] = None,
    ):
        """
        Creates a digestion.
        ...
        return self._digestion(
            ...
            state=state,
            lock_token_passed=lock_token_passed,
        )
    ...
    def _digestion_by_model(
        ...
        return self.digestion(**data.model_dump(), lock_token_passed=lock_token_passed)
    ...
    def _ingestion_by_model(
        ...
        return self.ingestion(**data.model_dump(), lock_token_passed=lock_token_passed)
    ...
    def _log_by_model(
        ...
        return self.log(**data.model_dump(), lock_token_passed=lock_token_passed)
    ...
    def _log_object_by_model(
        ...
        return self.log_object(
            log_id=log_id, **data.model_dump(), lock_token_passed=lock_token_passed
        )
    ...
    def _record_by_model(
        ...
        return self.record(
            topic_id=topic_id, **data.model_dump(), lock_token_passed=lock_token_passed
        )
    ...
    def _tag_by_model(self, log_id: UUID, data: models.TagCreateRequest, lock_token_passed: Optional[str] = None):
        return self.tag(log_id=log_id, **data.model_dump(), lock_token_passed=lock_token_passed)
    ...
    def _topic_by_model(
        self, data: models.TopicCreateRequest, lock_token_passed: Optional[str] = None
    ):
        return self.topic(**data.model_dump(), lock_token_passed=lock_token_passed)
