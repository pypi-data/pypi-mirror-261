...
class DeleteInterface(BaseDeleteInterface):
    ...
    def digestion(self, digestion_id: UUID, lock_token_passed: Optional[str] = None):
        """
        Delete a digestion.
    ...
    def group(self, group_id: UUID, lock_token_passed: Optional[str] = None):
        """
        Delete a group.
    ...
    def ingestion(self, ingestion_id: UUID, lock_token_passed: Optional[str] = None):
        """
        Delete an ingestion.
    ...
    def log(self, log_id: UUID, lock_token_passed: Optional[str] = None):
        """
        Delete a log.
        ...
        Returns:
            None
        """
        return self._log(log_id=log_id, lock_token_passed=lock_token_passed)
    ...
    def log_object(
        self, log_id: UUID, object_key: str, lock_token_passed: Optional[str] = None
    ):
        """
        Delete a log object.
    ...
    def record(
        ...
        """
        return self._record(
            timestamp=timestamp, topic_id=topic_id, lock_token_passed=lock_token_passed
        )
    ...
    def tag(self, tag_id: UUID, log_id: Optional[UUID] = None, lock_token_passed: Optional[str] = None):
        """
        Delete a tag.
    ...
    def topic(self, topic_id: UUID, lock_token_passed: Optional[str] = None):
        """
        Delete a topic.
