...
class UpdateInterface(BaseUpdateInterface):
    ...
    def digestion(
        ...
        Args:
            ...
            lock_token_passed: TODO: update this description
        Returns:
    ...
    def tag(
        self, tag_id: UUID, data: models.TagUpdateRequest, log_id: Optional[UUID] = None, lock_token_passed: Optional[str] = None
    ):
        """
        Update a tag.
