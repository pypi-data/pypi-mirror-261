...
class Delete(DeleteInterface, RESTInterface):
    ...
    def _digestion(self, digestion_id: UUID, lock_token_passed: str | None = None):
        self._delete_resource(
            f"digestions/{digestion_id}",
            additiona_params={"lock_token_passed": lock_token_passed},
        )
        return
    ...
    def _digestion_part(
        ...
        lock_token_passed: str | None = None,
    ):
        self._delete_resource(
    ...
    def _group(self, group_id: UUID, lock_token_passed: str | None = None):
        self._delete_resource(
            f"groups/{group_id}",
            additiona_params={"lock_token_passed": lock_token_passed},
        )
    ...
    def _ingestion(self, ingestion_id: UUID, lock_token_passed: str | None = None):
        self._delete_resource(
    ...
    def _log(self, log_id: UUID, lock_token_passed: str | None = None):
        self._delete_resource(
            f"logs/{log_id}", additiona_params={"lock_token_passed": lock_token_passed}
        )
        return

    def _log_object(
        self, log_id: UUID, object_key: str, lock_token_passed: str | None = None
    ):
        self._delete_resource(
    ...
    def _query(
        self, log_id: UUID, query_id: UUID, lock_token_passed: str | None = None
    ):
        self._delete_resource(
    ...
    def _record(
        self, timestamp: float, topic_id: UUID, lock_token_passed: str | None = None
    ):
        self._delete_resource(
    ...
    def _tag(self, log_id: UUID, tag_id: UUID, lock_token_passed: str | None = None):
        self._delete_resource(
    ...
    def _topic(self, topic_id: UUID, lock_token_passed: str | None = None):
        self._delete_resource(
            f"topics/{topic_id}",
            additiona_params={"lock_token_passed": lock_token_passed},
        )
