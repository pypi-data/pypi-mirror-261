...
class FeatureStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TrainingTestSplit = channel.stream_stream(
                '/featureform.serving.proto.Feature/TrainingTestSplit',
                request_serializer=featureform_dot_proto_dot_serving__pb2.TrainingTestSplitRequest.SerializeToString,
...
class FeatureServicer(object):
    ...
    def TrainingTestSplit(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_FeatureServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TrainingTestSplit': grpc.stream_stream_rpc_method_handler(
                    servicer.TrainingTestSplit,
                    request_deserializer=featureform_dot_proto_dot_serving__pb2.TrainingTestSplitRequest.FromString,
...
class Feature(object):
    ...
    @staticmethod
    def TrainingTestSplit(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/featureform.serving.proto.Feature/TrainingTestSplit',
            featureform_dot_proto_dot_serving__pb2.TrainingTestSplitRequest.SerializeToString,
