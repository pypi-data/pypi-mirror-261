...
#: list of markers with crosses  - *azcam.console.plot.style_x*
style_x = [
    "bx",
    "rx",
    "gx",
...
#: list of markers with circles - *azcam.console.plot.style_o*
style_o = [
    "bo",
    "ro",
    "go",
...
#: list of markers with dots - *azcam.console.plot.style_dot*
style_dot = [
    "b.",
    "r.",
    "g.",
...
#: list of line styles - *azcam.console.plot.style_lines*
style_lines = [
    "b-",
    "r-",
    "g-",
