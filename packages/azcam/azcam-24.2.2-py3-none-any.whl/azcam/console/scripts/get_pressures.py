...
def get_pressures(delay=1.0, logfile="get_pressures.log", plot_type=1):
    ...
    if plot_type:
        ...
        sub.grid(1)
        azcam.console.plot.plt.title("Measured Pressure")
        azcam.console.plot.plt.ylabel("Pressure [Torr]")
    ...
    with open("Pressure.txt", "a+") as datafile:
        ...
        while loop:
            ...
            if plot_type == 1:
                azcam.console.plot.plt.plot(times, pressures, "b.")
            elif plot_type == 2:
                azcam.console.plot.plt.semilogy(times, pressures, "b.-")
