...
function ImageTest() {
    ...
    var cmd = "/api/parameters/set_par?parameter=imagetest&value=" + imagetest;
    $("#message").text(cmd);
    $.getJSON(cmd, {},
        function(data) {
...
function GetExposureInfo() {
    $.getJSON('/api/parameters/get_par?parameter=imagetitle', {},
        function(data) {
    ...
    $.getJSON('/api/parameters/get_par?parameter=imagetest', {},
        function(data) {
    ...
    $.getJSON('/api/parameters/get_par?parameter=exposuresequencetotal', {},
        function(data) {
            $("#seq_total").val(data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=exposuresequencedelay', {},
        function(data) {
            $("#seq_delay").val(data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=exposuresequenceflush', {},
        function(data) {
...
function GetFilename() {
    $.getJSON('/api/parameters/get_par?parameter=imagefolder', {},
        function(data) {
            $("#imagefolder").val(decodeURI(data.data));
        });
    $.getJSON('/api/parameters/get_par?parameter=imagesequencenumber', {},
        function(data) {
            $("#imagesequencenumber").val(data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=imageroot', {},
        function(data) {
            $("#imageroot").val(data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=imageautoincrementsequencenumber', {},
        function(data) {
            $("#imageautoincrementsequencenumber").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=imageincludesequencenumber', {},
        function(data) {
            $("#imageincludesequencenumber").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=imageautoname', {},
        function(data) {
            $("#imageautoname").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=imageoverwrite', {},
        function(data) {
...
function imagefolder() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imagefolder&value=' + imagefolder, {},
        function(data) {});
...
function imagesequencenumber() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imagesequencenumber&value=' + imagenumber, {},
        function(data) {});
...
function imageroot() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imageroot&value=' + imageroot, {},
        function(data) {});
...
function imageautoincrementsequencenumber() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imageautoincrementsequencenumber&value=' + imageautoincrementsequencenumber, {},
        function(data) {});
...
function imageoverwrite() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imageoverwrite&value=' + imageoverwrite, {},
        function(data) {});
...
function imageincludesequencenumber() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imageincludesequencenumber&value=' + imageincludesequencenumber, {},
        function(data) {});
...
function imageautoname() {
    ...
    $.getJSON('/api/parameters/set_par?parameter=imageautoname&value=' + imageautoname, {},
        function(data) {});
...
function flusharray() {
    ...
    x = (x ? 1 : 0)
    $.getJSON('/api/parameters/set_par?parameter=flusharray&value=' + x, {},
        function(data) {});
...
function displayimage() {
    ...
    x = (x ? 1 : 0)
    $.getJSON('/api/parameters/set_par?parameter=displayimage&value=' + x, {},
        function(data) {});
    return false;
}
...
function instrumentenabled() {
    ...
    x = (x ? 1 : 0)
    $.getJSON('/api/parameters/set_par?parameter=instrumentenabled&value=' + x, {},
        function(data) {});
    return false;
}
...
function telescopeenabled() {
    ...
    x = (x ? 1 : 0)
    $.getJSON('/api/parameters/set_par?parameter=telescopeenabled&value=' + x, {},
        function(data) {});
    return false;
}
...
function autotitle() {
    ...
    x = (x ? 1 : 0)
    $.getJSON('/api/parameters/set_par?parameter=autotitle&value=' + x, {},
        function(data) {});
    return false;
}

function GetOptions() {
    $.getJSON('/api/parameters/get_par?parameter=flusharray', {},
        function(data) {
            $("#flusharray").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=displayimage', {},
        function(data) {
            $("#displayimage").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=instrumentenabled', {},
        function(data) {
            $("#instrumentenabled").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=telescopeenabled', {},
        function(data) {
            $("#telescopeenabled").prop("checked", data.data);
        });
    $.getJSON('/api/parameters/get_par?parameter=autotitle', {},
        function(data) {
