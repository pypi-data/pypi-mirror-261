"""
*azcam.console.tools.console_tools* contains the `ConsoleTools` base tool class.
"""
...
def create_console_tools() -> None:
    ...
    from azcam.console.tools.controller import ControllerConsole
    from azcam.console.tools.exposure import ExposureConsole
    from azcam.console.tools.instrument import InstrumentConsole
    from azcam.console.tools.telescope import TelescopeConsole
    from azcam.console.tools.tempcon import TempconConsole
