...
def show_sequence_stats(file_root="itl.", starting_sequence=1):
    ...
    azcam.console.plot.plt.title("Mean")
    azcam.console.plot.plt.xlabel("Image Number")
    azcam.console.plot.plt.ylabel("Mean [DN]")
    ax.xaxis.set_major_locator(MaxNLocator(integer=True))
    ax.grid(1)
    azcam.console.plot.plt.plot(image_numbers, means)
    azcam.console.plot.save_figure(fignum, "means.png")

    fig, ax = azcam.console.plot.plt.subplots(constrained_layout=True)
    fignum = fig.number
    azcam.console.plot.move_window(fignum)
    azcam.console.plot.plt.title("Standard Deviation")
    azcam.console.plot.plt.xlabel("Image Number")
    azcam.console.plot.plt.ylabel("Sigma [DN]")
    ax.xaxis.set_major_locator(MaxNLocator(integer=True))
    ax.grid(1)
    azcam.console.plot.plt.plot(image_numbers, sigmas)
    azcam.console.plot.save_figure(fignum, "sigmas.png")
    ...
    fignum = fig.number
    azcam.console.plot.move_window(fignum)
    azcam.console.plot.plt.title("Mean Differences")
    azcam.console.plot.plt.xlabel("Image Number")
    azcam.console.plot.plt.ylabel("Mean [DN]")
    ax.xaxis.set_major_locator(MaxNLocator(integer=True))
    ax.grid(1)
    azcam.console.plot.plt.plot(image_numbers[:-1], means_delta, "bs")
    azcam.console.plot.save_figure(fignum, "differences.png")
