...
def plot_header_times(fileroot="itl.", starting_sequence=1, keyword="UT"):
    ...
    azcam.console.plot.plt.title("%s in Header" % keyword)
    azcam.console.plot.plt.xlabel("Image Number")
    azcam.console.plot.plt.ylabel("Relative Time (sec)")
    ax.grid(1)
    azcam.console.plot.plt.plot(times)
    azcam.console.plot.save_figure(fignum, "%s_relative.png" % keyword)
    ...
    fignum = fig.number
    azcam.console.plot.move_window(fignum)
    azcam.console.plot.plt.title("%s Difference" % keyword)
    azcam.console.plot.plt.xlabel("Image Number")
    azcam.console.plot.plt.ylabel("Relative Time (sec)")
    ax.grid(1)
    azcam.console.plot.plt.plot(times)
    azcam.console.plot.update()
    azcam.console.plot.save_figure(fignum, "%s_difference.png" % keyword)
