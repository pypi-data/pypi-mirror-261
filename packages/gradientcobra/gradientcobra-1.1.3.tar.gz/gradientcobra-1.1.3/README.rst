...
For more information about how to use the package:

- `gradientcobra documentation <https://hassothea.github.io/files/CodesPhD/gradientcobra_doc.html>`__.

Read more about aggregation and kernel methods:
