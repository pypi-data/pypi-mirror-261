...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_5.setTitle(_translate("Dialog", "Credentials"))
        self.label_16.setText(_translate("Dialog", "Username"))
        self.label_17.setText(_translate("Dialog", "Password"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "Callbook"))
