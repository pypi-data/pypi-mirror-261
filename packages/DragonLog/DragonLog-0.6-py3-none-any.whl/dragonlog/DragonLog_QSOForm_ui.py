...
class Ui_QSOFormDialog(object):
    def setupUi(self, QSOFormDialog):
        ...
        self.searchCallbookPushButton = QtWidgets.QPushButton(parent=QSOFormDialog)
        ...
        self.timeNowPushButton = QtWidgets.QPushButton(parent=QSOFormDialog)
        ...
        self.commentsTextEdit = QtWidgets.QTextEdit(parent=QSOFormDialog)
        ...
        self.savePushButton.clicked.connect(QSOFormDialog.accept) # type: ignore
