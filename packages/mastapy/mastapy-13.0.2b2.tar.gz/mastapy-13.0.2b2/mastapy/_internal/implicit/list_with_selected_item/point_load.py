...
class ListWithSelectedItem_PointLoad(_2473.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2473.PointLoad.TYPE":
        ...
        return _2473.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2473.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2473.PointLoad]":
