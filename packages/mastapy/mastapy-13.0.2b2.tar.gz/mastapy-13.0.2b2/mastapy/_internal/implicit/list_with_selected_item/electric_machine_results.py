...
class ListWithSelectedItem_ElectricMachineResults(
    _1328.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1328.ElectricMachineResults.TYPE":
        ...
        return _1328.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1328.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1328.ElectricMachineResults]":
