...
class ListWithSelectedItem_ColumnTitle(
    _1819.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1819.ColumnTitle.TYPE":
        ...
        return _1819.ColumnTitle.TYPE

    @property
    def selected_value(self: Self) -> "_1819.ColumnTitle":
    ...
    @property
    def available_values(self: Self) -> "List[_1819.ColumnTitle]":
