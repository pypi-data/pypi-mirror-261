...
class ListWithSelectedItem_DesignState(
    _5665.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5665.DesignState.TYPE":
        ...
        return _5665.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5665.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5665.DesignState]":
