...
class ListWithSelectedItem_StaticLoadCase(
    _6807.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6807.StaticLoadCase.TYPE":
        ...
        return _6807.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6807.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6807.StaticLoadCase]":
