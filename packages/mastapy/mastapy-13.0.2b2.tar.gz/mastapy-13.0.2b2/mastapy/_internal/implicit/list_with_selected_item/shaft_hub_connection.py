...
class ListWithSelectedItem_ShaftHubConnection(
    _2600.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2600.ShaftHubConnection.TYPE":
        ...
        return _2600.ShaftHubConnection.TYPE

    @property
    def selected_value(self: Self) -> "_2600.ShaftHubConnection":
    ...
    @property
    def available_values(self: Self) -> "List[_2600.ShaftHubConnection]":
