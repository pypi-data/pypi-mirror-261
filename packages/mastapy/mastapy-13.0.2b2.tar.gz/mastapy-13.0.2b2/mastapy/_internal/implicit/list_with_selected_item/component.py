...
class ListWithSelectedItem_Component(_2446.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2446.Component.TYPE":
        ...
        return _2446.Component.TYPE

    @property
    def selected_value(self: Self) -> "_2446.Component":
    ...
    @property
    def available_values(self: Self) -> "List[_2446.Component]":
