...
class ListWithSelectedItem_Datum(_2450.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2450.Datum.TYPE":
        ...
        return _2450.Datum.TYPE

    @property
    def selected_value(self: Self) -> "_2450.Datum":
    ...
    @property
    def available_values(self: Self) -> "List[_2450.Datum]":
