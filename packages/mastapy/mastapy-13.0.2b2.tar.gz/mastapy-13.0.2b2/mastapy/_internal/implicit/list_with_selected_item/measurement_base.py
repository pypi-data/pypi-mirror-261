...
class ListWithSelectedItem_MeasurementBase(
    _1607.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1607.MeasurementBase.TYPE":
        ...
        return _1607.MeasurementBase.TYPE

    @property
    def selected_value(self: Self) -> "_1607.MeasurementBase":
    ...
    @property
    def available_values(self: Self) -> "List[_1607.MeasurementBase]":
