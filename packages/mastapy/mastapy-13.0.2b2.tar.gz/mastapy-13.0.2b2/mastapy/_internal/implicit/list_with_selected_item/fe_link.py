...
class ListWithSelectedItem_FELink(_2420.FELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2420.FELink.TYPE":
        ...
        return _2420.FELink.TYPE

    @property
    def selected_value(self: Self) -> "_2420.FELink":
    ...
    @property
    def available_values(self: Self) -> "List[_2420.FELink]":
