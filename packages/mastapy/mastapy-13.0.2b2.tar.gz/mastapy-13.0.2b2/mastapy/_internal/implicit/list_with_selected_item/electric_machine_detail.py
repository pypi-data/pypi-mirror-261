...
class ListWithSelectedItem_ElectricMachineDetail(
    _1263.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1263.ElectricMachineDetail.TYPE":
        ...
        return _1263.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1263.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1263.ElectricMachineDetail]":
