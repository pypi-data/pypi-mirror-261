...
class ListWithSelectedItem_FESubstructureNode(
    _2387.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2387.FESubstructureNode.TYPE":
        ...
        return _2387.FESubstructureNode.TYPE

    @property
    def selected_value(self: Self) -> "_2387.FESubstructureNode":
    ...
    @property
    def available_values(self: Self) -> "List[_2387.FESubstructureNode]":
