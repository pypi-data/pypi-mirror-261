...
class ListWithSelectedItem_SystemDirectory(
    _1602.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1602.SystemDirectory.TYPE":
        ...
        return _1602.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1602.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1602.SystemDirectory]":
