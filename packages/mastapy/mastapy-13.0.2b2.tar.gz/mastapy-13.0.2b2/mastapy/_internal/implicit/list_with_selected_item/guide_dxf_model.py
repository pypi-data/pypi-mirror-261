...
class ListWithSelectedItem_GuideDxfModel(
    _2457.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2457.GuideDxfModel.TYPE":
        ...
        return _2457.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2457.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2457.GuideDxfModel]":
