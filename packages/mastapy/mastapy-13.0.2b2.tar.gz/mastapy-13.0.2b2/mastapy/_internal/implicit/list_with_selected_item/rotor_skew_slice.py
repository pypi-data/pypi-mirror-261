...
class ListWithSelectedItem_RotorSkewSlice(
    _1297.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1297.RotorSkewSlice.TYPE":
        ...
        return _1297.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1297.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1297.RotorSkewSlice]":
