...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1969.BallBearingContactCalculation":
        ...
        return _1969.BallBearingContactCalculation

    @classmethod
    def implicit_type(cls) -> "_1969.BallBearingContactCalculation.type_()":
        ...
        return _1969.BallBearingContactCalculation.type_()

    @property
    def value(self: Self) -> "_1969.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: Self) -> "_1969.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: Self) -> "_1969.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
