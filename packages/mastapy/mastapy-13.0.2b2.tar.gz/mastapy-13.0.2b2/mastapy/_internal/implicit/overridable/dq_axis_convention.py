...
class Overridable_DQAxisConvention(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1261.DQAxisConvention":
        ...
        return _1261.DQAxisConvention

    @classmethod
    def implicit_type(cls) -> "_1261.DQAxisConvention.type_()":
        ...
        return _1261.DQAxisConvention.type_()

    @property
    def value(self: Self) -> "_1261.DQAxisConvention":
    ...
    @property
    def override_value(self: Self) -> "_1261.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
    ...
    @property
    def calculated_value(self: Self) -> "_1261.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
