...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1497.ComplexPartDisplayOption":
        ...
        return _1497.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1497.ComplexPartDisplayOption.type_()":
        ...
        return _1497.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1497.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1497.ComplexPartDisplayOption]":
