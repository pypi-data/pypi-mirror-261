...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1794.Severity":
        ...
        return _1794.Severity

    @classmethod
    def implicit_type(cls) -> "_1794.Severity.type_()":
        ...
        return _1794.Severity.type_()

    @property
    def selected_value(self: Self) -> "_1794.Severity":
    ...
    @property
    def available_values(self: Self) -> "List[_1794.Severity]":
