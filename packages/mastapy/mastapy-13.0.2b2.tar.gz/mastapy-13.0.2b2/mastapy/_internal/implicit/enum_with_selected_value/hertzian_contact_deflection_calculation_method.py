...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1575.HertzianContactDeflectionCalculationMethod":
        ...
        return _1575.HertzianContactDeflectionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1575.HertzianContactDeflectionCalculationMethod.type_()":
        ...
        return _1575.HertzianContactDeflectionCalculationMethod.type_()

    @property
    def selected_value(
        self: Self,
    ) -> "_1575.HertzianContactDeflectionCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1575.HertzianContactDeflectionCalculationMethod]":
