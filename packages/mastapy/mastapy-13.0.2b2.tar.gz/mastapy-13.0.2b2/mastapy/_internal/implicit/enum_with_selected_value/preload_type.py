...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1963.PreloadType":
        ...
        return _1963.PreloadType

    @classmethod
    def implicit_type(cls) -> "_1963.PreloadType.type_()":
        ...
        return _1963.PreloadType.type_()

    @property
    def selected_value(self: Self) -> "_1963.PreloadType":
    ...
    @property
    def available_values(self: Self) -> "List[_1963.PreloadType]":
