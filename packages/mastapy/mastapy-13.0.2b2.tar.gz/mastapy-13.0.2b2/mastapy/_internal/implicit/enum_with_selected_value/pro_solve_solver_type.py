...
from mastapy.fe_tools.vfx_tools.vfx_enums import _1241
...
class EnumWithSelectedValue_ProSolveSolverType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1241.ProSolveSolverType":
        ...
        return _1241.ProSolveSolverType

    @classmethod
    def implicit_type(cls) -> "_1241.ProSolveSolverType.type_()":
        ...
        return _1241.ProSolveSolverType.type_()

    @property
    def selected_value(self: Self) -> "_1241.ProSolveSolverType":
    ...
    @property
    def available_values(self: Self) -> "List[_1241.ProSolveSolverType]":
