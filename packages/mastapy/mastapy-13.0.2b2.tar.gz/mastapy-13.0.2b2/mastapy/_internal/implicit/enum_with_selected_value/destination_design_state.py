...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6994.DestinationDesignState":
        ...
        return _6994.DestinationDesignState

    @classmethod
    def implicit_type(cls) -> "_6994.DestinationDesignState.type_()":
        ...
        return _6994.DestinationDesignState.type_()

    @property
    def selected_value(self: Self) -> "_6994.DestinationDesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_6994.DestinationDesignState]":
