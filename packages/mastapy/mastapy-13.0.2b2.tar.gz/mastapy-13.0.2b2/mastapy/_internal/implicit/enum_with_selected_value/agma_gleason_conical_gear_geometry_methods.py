...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1180.AGMAGleasonConicalGearGeometryMethods":
        ...
        return _1180.AGMAGleasonConicalGearGeometryMethods

    @classmethod
    def implicit_type(cls) -> "_1180.AGMAGleasonConicalGearGeometryMethods.type_()":
        ...
        return _1180.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: Self) -> "_1180.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1180.AGMAGleasonConicalGearGeometryMethods]":
