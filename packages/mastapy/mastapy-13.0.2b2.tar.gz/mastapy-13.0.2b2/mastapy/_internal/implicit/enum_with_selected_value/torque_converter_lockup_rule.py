...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5511.TorqueConverterLockupRule":
        ...
        return _5511.TorqueConverterLockupRule

    @classmethod
    def implicit_type(cls) -> "_5511.TorqueConverterLockupRule.type_()":
        ...
        return _5511.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: Self) -> "_5511.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: Self) -> "List[_5511.TorqueConverterLockupRule]":
