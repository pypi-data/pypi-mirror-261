...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1747.CadPageOrientation":
        ...
        return _1747.CadPageOrientation

    @classmethod
    def implicit_type(cls) -> "_1747.CadPageOrientation.type_()":
        ...
        return _1747.CadPageOrientation.type_()

    @property
    def selected_value(self: Self) -> "_1747.CadPageOrientation":
    ...
    @property
    def available_values(self: Self) -> "List[_1747.CadPageOrientation]":
