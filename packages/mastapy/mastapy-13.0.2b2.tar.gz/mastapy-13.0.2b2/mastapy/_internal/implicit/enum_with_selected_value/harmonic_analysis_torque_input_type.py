...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5771.HarmonicAnalysisTorqueInputType":
        ...
        return _5771.HarmonicAnalysisTorqueInputType

    @classmethod
    def implicit_type(cls) -> "_5771.HarmonicAnalysisTorqueInputType.type_()":
        ...
        return _5771.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: Self) -> "_5771.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5771.HarmonicAnalysisTorqueInputType]":
