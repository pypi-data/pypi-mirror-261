...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1904.InternalClearanceClass":
        ...
        return _1904.InternalClearanceClass

    @classmethod
    def implicit_type(cls) -> "_1904.InternalClearanceClass.type_()":
        ...
        return _1904.InternalClearanceClass.type_()

    @property
    def selected_value(self: Self) -> "_1904.InternalClearanceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1904.InternalClearanceClass]":
