...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2154.FatigueLoadLimitCalculationMethodEnum":
        ...
        return _2154.FatigueLoadLimitCalculationMethodEnum

    @classmethod
    def implicit_type(cls) -> "_2154.FatigueLoadLimitCalculationMethodEnum.type_()":
        ...
        return _2154.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: Self) -> "_2154.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2154.FatigueLoadLimitCalculationMethodEnum]":
