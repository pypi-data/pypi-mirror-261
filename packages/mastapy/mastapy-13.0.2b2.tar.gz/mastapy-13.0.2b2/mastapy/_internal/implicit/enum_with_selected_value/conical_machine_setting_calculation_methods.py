...
class EnumWithSelectedValue_ConicalMachineSettingCalculationMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1158.ConicalMachineSettingCalculationMethods":
        ...
        return _1158.ConicalMachineSettingCalculationMethods

    @classmethod
    def implicit_type(cls) -> "_1158.ConicalMachineSettingCalculationMethods.type_()":
        ...
        return _1158.ConicalMachineSettingCalculationMethods.type_()

    @property
    def selected_value(self: Self) -> "_1158.ConicalMachineSettingCalculationMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1158.ConicalMachineSettingCalculationMethods]":
