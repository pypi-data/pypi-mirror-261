...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6980.TorqueSpecificationForSystemDeflection":
        ...
        return _6980.TorqueSpecificationForSystemDeflection

    @classmethod
    def implicit_type(cls) -> "_6980.TorqueSpecificationForSystemDeflection.type_()":
        ...
        return _6980.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: Self) -> "_6980.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_6980.TorqueSpecificationForSystemDeflection]":
