...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5440.GearMeshStiffnessModel":
        ...
        return _5440.GearMeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5440.GearMeshStiffnessModel.type_()":
        ...
        return _5440.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5440.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5440.GearMeshStiffnessModel]":
