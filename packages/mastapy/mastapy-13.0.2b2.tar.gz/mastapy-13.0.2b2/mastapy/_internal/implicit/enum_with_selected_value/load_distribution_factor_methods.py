...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1170.LoadDistributionFactorMethods":
        ...
        return _1170.LoadDistributionFactorMethods

    @classmethod
    def implicit_type(cls) -> "_1170.LoadDistributionFactorMethods.type_()":
        ...
        return _1170.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: Self) -> "_1170.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1170.LoadDistributionFactorMethods]":
