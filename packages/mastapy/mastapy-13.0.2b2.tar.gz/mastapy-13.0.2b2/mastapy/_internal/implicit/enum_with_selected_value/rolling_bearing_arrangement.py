...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1894.RollingBearingArrangement":
        ...
        return _1894.RollingBearingArrangement

    @classmethod
    def implicit_type(cls) -> "_1894.RollingBearingArrangement.type_()":
        ...
        return _1894.RollingBearingArrangement.type_()

    @property
    def selected_value(self: Self) -> "_1894.RollingBearingArrangement":
    ...
    @property
    def available_values(self: Self) -> "List[_1894.RollingBearingArrangement]":
