...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1964.LoadedBallElementPropertyType":
        ...
        return _1964.LoadedBallElementPropertyType

    @classmethod
    def implicit_type(cls) -> "_1964.LoadedBallElementPropertyType.type_()":
        ...
        return _1964.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: Self) -> "_1964.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: Self) -> "List[_1964.LoadedBallElementPropertyType]":
