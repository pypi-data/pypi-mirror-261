...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2400.LinkNodeSource":
        ...
        return _2400.LinkNodeSource

    @classmethod
    def implicit_type(cls) -> "_2400.LinkNodeSource.type_()":
        ...
        return _2400.LinkNodeSource.type_()

    @property
    def selected_value(self: Self) -> "_2400.LinkNodeSource":
    ...
    @property
    def available_values(self: Self) -> "List[_2400.LinkNodeSource]":
