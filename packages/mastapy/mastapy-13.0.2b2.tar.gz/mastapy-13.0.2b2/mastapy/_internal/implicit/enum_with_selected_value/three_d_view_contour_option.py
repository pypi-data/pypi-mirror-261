...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1823.ThreeDViewContourOption":
        ...
        return _1823.ThreeDViewContourOption

    @classmethod
    def implicit_type(cls) -> "_1823.ThreeDViewContourOption.type_()":
        ...
        return _1823.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: Self) -> "_1823.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1823.ThreeDViewContourOption]":
