...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2368.ComponentOrientationOption":
        ...
        return _2368.ComponentOrientationOption

    @classmethod
    def implicit_type(cls) -> "_2368.ComponentOrientationOption.type_()":
        ...
        return _2368.ComponentOrientationOption.type_()

    @property
    def selected_value(self: Self) -> "_2368.ComponentOrientationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2368.ComponentOrientationOption]":
