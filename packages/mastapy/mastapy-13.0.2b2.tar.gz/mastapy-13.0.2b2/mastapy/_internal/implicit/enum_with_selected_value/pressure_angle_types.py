...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1406.PressureAngleTypes":
        ...
        return _1406.PressureAngleTypes

    @classmethod
    def implicit_type(cls) -> "_1406.PressureAngleTypes.type_()":
        ...
        return _1406.PressureAngleTypes.type_()

    @property
    def selected_value(self: Self) -> "_1406.PressureAngleTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1406.PressureAngleTypes]":
