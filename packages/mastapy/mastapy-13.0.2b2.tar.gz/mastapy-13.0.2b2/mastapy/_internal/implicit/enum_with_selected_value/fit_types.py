...
class EnumWithSelectedValue_FitTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1397.FitTypes":
        ...
        return _1397.FitTypes

    @classmethod
    def implicit_type(cls) -> "_1397.FitTypes.type_()":
        ...
        return _1397.FitTypes.type_()

    @property
    def selected_value(self: Self) -> "_1397.FitTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1397.FitTypes]":
