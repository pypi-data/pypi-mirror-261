...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1366.LoadCaseType":
        ...
        return _1366.LoadCaseType

    @classmethod
    def implicit_type(cls) -> "_1366.LoadCaseType.type_()":
        ...
        return _1366.LoadCaseType.type_()

    @property
    def selected_value(self: Self) -> "_1366.LoadCaseType":
    ...
    @property
    def available_values(self: Self) -> "List[_1366.LoadCaseType]":
