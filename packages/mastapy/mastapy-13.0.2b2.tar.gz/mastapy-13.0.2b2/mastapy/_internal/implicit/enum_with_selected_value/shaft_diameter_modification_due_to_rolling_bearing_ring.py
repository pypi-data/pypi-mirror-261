...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2477.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        return _2477.ShaftDiameterModificationDueToRollingBearingRing

    @classmethod
    def implicit_type(
        cls,
    ) -> "_2477.ShaftDiameterModificationDueToRollingBearingRing.type_()":
        ...
        return _2477.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_2477.ShaftDiameterModificationDueToRollingBearingRing]":
