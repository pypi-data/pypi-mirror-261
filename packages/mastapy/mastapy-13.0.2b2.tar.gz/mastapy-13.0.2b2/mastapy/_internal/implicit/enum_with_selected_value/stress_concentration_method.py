...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2111.StressConcentrationMethod":
        ...
        return _2111.StressConcentrationMethod

    @classmethod
    def implicit_type(cls) -> "_2111.StressConcentrationMethod.type_()":
        ...
        return _2111.StressConcentrationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2111.StressConcentrationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_2111.StressConcentrationMethod]":
