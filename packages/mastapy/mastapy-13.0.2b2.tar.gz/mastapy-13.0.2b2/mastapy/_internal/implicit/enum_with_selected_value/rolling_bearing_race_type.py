...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1897.RollingBearingRaceType":
        ...
        return _1897.RollingBearingRaceType

    @classmethod
    def implicit_type(cls) -> "_1897.RollingBearingRaceType.type_()":
        ...
        return _1897.RollingBearingRaceType.type_()

    @property
    def selected_value(self: Self) -> "_1897.RollingBearingRaceType":
    ...
    @property
    def available_values(self: Self) -> "List[_1897.RollingBearingRaceType]":
