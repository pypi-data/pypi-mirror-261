...
class EnumWithSelectedValue_DesignEntityId(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2206.DesignEntityId":
        ...
        return _2206.DesignEntityId

    @classmethod
    def implicit_type(cls) -> "_2206.DesignEntityId.type_()":
        ...
        return _2206.DesignEntityId.type_()

    @property
    def selected_value(self: Self) -> "_2206.DesignEntityId":
    ...
    @property
    def available_values(self: Self) -> "List[_2206.DesignEntityId]":
