...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2597.RigidConnectorTypes":
        ...
        return _2597.RigidConnectorTypes

    @classmethod
    def implicit_type(cls) -> "_2597.RigidConnectorTypes.type_()":
        ...
        return _2597.RigidConnectorTypes.type_()

    @property
    def selected_value(self: Self) -> "_2597.RigidConnectorTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_2597.RigidConnectorTypes]":
