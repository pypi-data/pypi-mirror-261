...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2264.ExcitationAnalysisViewOption":
        ...
        return _2264.ExcitationAnalysisViewOption

    @classmethod
    def implicit_type(cls) -> "_2264.ExcitationAnalysisViewOption.type_()":
        ...
        return _2264.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: Self) -> "_2264.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2264.ExcitationAnalysisViewOption]":
