...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4629.DynamicsResponseType":
        ...
        return _4629.DynamicsResponseType

    @classmethod
    def implicit_type(cls) -> "_4629.DynamicsResponseType.type_()":
        ...
        return _4629.DynamicsResponseType.type_()

    @property
    def selected_value(self: Self) -> "_4629.DynamicsResponseType":
    ...
    @property
    def available_values(self: Self) -> "List[_4629.DynamicsResponseType]":
