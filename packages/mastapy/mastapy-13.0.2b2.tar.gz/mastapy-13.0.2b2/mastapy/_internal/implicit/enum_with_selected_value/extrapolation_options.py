...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1512.ExtrapolationOptions":
        ...
        return _1512.ExtrapolationOptions

    @classmethod
    def implicit_type(cls) -> "_1512.ExtrapolationOptions.type_()":
        ...
        return _1512.ExtrapolationOptions.type_()

    @property
    def selected_value(self: Self) -> "_1512.ExtrapolationOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1512.ExtrapolationOptions]":
