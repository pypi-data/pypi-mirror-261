...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_5747.ExportOutputType":
        ...
        return _5747.ExportOutputType

    @classmethod
    def implicit_type(cls) -> "_5747.ExportOutputType.type_()":
        ...
        return _5747.ExportOutputType.type_()

    @property
    def selected_value(self: Self) -> "_5747.ExportOutputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5747.ExportOutputType]":
