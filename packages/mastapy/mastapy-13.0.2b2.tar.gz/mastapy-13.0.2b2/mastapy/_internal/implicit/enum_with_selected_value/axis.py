...
class EnumWithSelectedValue_Axis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1494.Axis":
    ...
    @classmethod
    def implicit_type(cls) -> "_1494.Axis.type_()":
        ...
        return _1494.Axis.type_()

    @property
    def selected_value(self: Self) -> "_1494.Axis":
    ...
    @property
    def available_values(self: Self) -> "List[_1494.Axis]":
