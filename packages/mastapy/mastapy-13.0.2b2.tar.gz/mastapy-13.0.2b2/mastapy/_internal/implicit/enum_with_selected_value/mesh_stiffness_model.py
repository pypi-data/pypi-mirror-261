...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2216.MeshStiffnessModel":
        ...
        return _2216.MeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_2216.MeshStiffnessModel.type_()":
        ...
        return _2216.MeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_2216.MeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2216.MeshStiffnessModel]":
