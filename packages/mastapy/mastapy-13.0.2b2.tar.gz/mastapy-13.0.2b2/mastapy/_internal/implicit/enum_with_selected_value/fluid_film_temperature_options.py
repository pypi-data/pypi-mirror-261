...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1886.FluidFilmTemperatureOptions":
        ...
        return _1886.FluidFilmTemperatureOptions

    @classmethod
    def implicit_type(cls) -> "_1886.FluidFilmTemperatureOptions.type_()":
        ...
        return _1886.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: Self) -> "_1886.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1886.FluidFilmTemperatureOptions]":
