...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1925.SupportToleranceLocationDesignation":
        ...
        return _1925.SupportToleranceLocationDesignation

    @classmethod
    def implicit_type(cls) -> "_1925.SupportToleranceLocationDesignation.type_()":
        ...
        return _1925.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: Self) -> "_1925.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1925.SupportToleranceLocationDesignation]":
