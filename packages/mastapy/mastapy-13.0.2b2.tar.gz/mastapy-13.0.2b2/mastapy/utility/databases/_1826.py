...
if TYPE_CHECKING:
    from mastapy.utility.databases import _1828, _1830, _1833
...
class Database(_0.APIBase, Generic[TKey, TValue]):
    ...
    class _Cast_Database:
        ...
        @property
        def named_database(self: "Database._Cast_Database") -> "_1830.NamedDatabase":
            from mastapy.utility.databases import _1830

            return self._parent._cast(_1830.NamedDatabase)

        @property
        def sql_database(self: "Database._Cast_Database") -> "_1833.SQLDatabase":
