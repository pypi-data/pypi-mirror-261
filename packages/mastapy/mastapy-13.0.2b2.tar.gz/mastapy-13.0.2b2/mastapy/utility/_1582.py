...
if TYPE_CHECKING:
    from mastapy.utility import _1595, _1581
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: Self) -> "_1595.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: Self) -> "List[_1581.DispatcherHelper]":
