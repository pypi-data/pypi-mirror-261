...
class OilSeal(_2449.Connector):
    ...
    class _Cast_OilSeal:
        ...
        @property
        def connector(self: "OilSeal._Cast_OilSeal") -> "_2449.Connector":
        ...
        @property
        def component(self: "OilSeal._Cast_OilSeal") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "OilSeal._Cast_OilSeal") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "OilSeal._Cast_OilSeal") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
    ...
    @property
    def drag_torque_vs_rotational_speed(self: Self) -> "_1537.Vector2DListAccessor":
