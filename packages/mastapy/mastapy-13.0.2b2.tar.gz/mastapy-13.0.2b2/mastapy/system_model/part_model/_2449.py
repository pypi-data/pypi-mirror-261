...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2437, _2446, _2447, _2441, _2468, _2470
...
class Connector(_2466.MountableComponent):
    ...
    class _Cast_Connector:
        ...
        @property
        def component(self: "Connector._Cast_Connector") -> "_2446.Component":
            return self._parent._cast(_2446.Component)

        @property
        def part(self: "Connector._Cast_Connector") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "Connector._Cast_Connector") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205

            return self._parent._cast(_2205.DesignEntity)

        @property
        def bearing(self: "Connector._Cast_Connector") -> "_2441.Bearing":
            from mastapy.system_model.part_model import _2441

            return self._parent._cast(_2441.Bearing)

        @property
        def oil_seal(self: "Connector._Cast_Connector") -> "_2468.OilSeal":
