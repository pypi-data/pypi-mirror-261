...
class ConceptCoupling(_2585.Coupling):
    ...
    class _Cast_ConceptCoupling:
        ...
        @property
        def coupling(self: "ConceptCoupling._Cast_ConceptCoupling") -> "_2585.Coupling":
        ...
        @property
        def part(self: "ConceptCoupling._Cast_ConceptCoupling") -> "_2470.Part":
    ...
    @property
    def efficiency_vs_speed_ratio(self: Self) -> "_1537.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def efficiency_vs_speed_ratio(self: Self, value: "_1537.Vector2DListAccessor"):
