...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1464, _1465
...
class RingPins(_2466.MountableComponent):
    ...
    class _Cast_RingPins:
        ...
        @property
        def component(self: "RingPins._Cast_RingPins") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "RingPins._Cast_RingPins") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "RingPins._Cast_RingPins") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
    ...
    @property
    def ring_pins_design(self: Self) -> "_1464.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: Self) -> "_1465.RingPinsMaterial":
