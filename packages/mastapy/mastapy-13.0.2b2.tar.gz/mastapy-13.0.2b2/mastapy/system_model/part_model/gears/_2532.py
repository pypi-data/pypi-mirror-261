...
class Gear(_2466.MountableComponent):
    ...
    class _Cast_Gear:
        ...
        @property
        def mountable_component(self: "Gear._Cast_Gear") -> "_2466.MountableComponent":
            return self._parent._cast(_2466.MountableComponent)

        @property
        def component(self: "Gear._Cast_Gear") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "Gear._Cast_Gear") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "Gear._Cast_Gear") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
        ...
        @property
        def bevel_gear(self: "Gear._Cast_Gear") -> "_2521.BevelGear":
            from mastapy.system_model.part_model.gears import _2521

            return self._parent._cast(_2521.BevelGear)

        @property
        def concept_gear(self: "Gear._Cast_Gear") -> "_2523.ConceptGear":
            from mastapy.system_model.part_model.gears import _2523

            return self._parent._cast(_2523.ConceptGear)

        @property
        def conical_gear(self: "Gear._Cast_Gear") -> "_2525.ConicalGear":
            from mastapy.system_model.part_model.gears import _2525

            return self._parent._cast(_2525.ConicalGear)

        @property
        def cylindrical_gear(self: "Gear._Cast_Gear") -> "_2527.CylindricalGear":
        ...
        @property
        def face_gear(self: "Gear._Cast_Gear") -> "_2530.FaceGear":
            from mastapy.system_model.part_model.gears import _2530

            return self._parent._cast(_2530.FaceGear)

        @property
        def hypoid_gear(self: "Gear._Cast_Gear") -> "_2536.HypoidGear":
        ...
        @property
        def spiral_bevel_gear(self: "Gear._Cast_Gear") -> "_2545.SpiralBevelGear":
        ...
        @property
        def straight_bevel_gear(self: "Gear._Cast_Gear") -> "_2549.StraightBevelGear":
        ...
        @property
        def worm_gear(self: "Gear._Cast_Gear") -> "_2553.WormGear":
            from mastapy.system_model.part_model.gears import _2553

            return self._parent._cast(_2553.WormGear)

        @property
        def zerol_bevel_gear(self: "Gear._Cast_Gear") -> "_2555.ZerolBevelGear":
    ...
    @property
    def active_gear_design(self: Self) -> "_948.GearDesign":
