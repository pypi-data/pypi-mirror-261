...
class WormGear(_2532.Gear):
    ...
    class _Cast_WormGear:
        ...
        @property
        def gear(self: "WormGear._Cast_WormGear") -> "_2532.Gear":
        ...
        @property
        def component(self: "WormGear._Cast_WormGear") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "WormGear._Cast_WormGear") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "WormGear._Cast_WormGear") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
    ...
    @property
    def active_gear_design(self: Self) -> "_958.WormGearDesign":
    ...
    @property
    def worm_gear_design(self: Self) -> "_958.WormGearDesign":
        """mastapy.gears.gear_designs.worm.WormGearDesign
