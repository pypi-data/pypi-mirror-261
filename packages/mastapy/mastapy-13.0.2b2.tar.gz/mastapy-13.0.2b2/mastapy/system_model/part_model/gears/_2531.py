...
class FaceGearSet(_2534.GearSet):
    ...
    class _Cast_FaceGearSet:
        ...
        @property
        def gear_set(self: "FaceGearSet._Cast_FaceGearSet") -> "_2534.GearSet":
        ...
        @property
        def part(self: "FaceGearSet._Cast_FaceGearSet") -> "_2470.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_996.FaceGearSetDesign":
