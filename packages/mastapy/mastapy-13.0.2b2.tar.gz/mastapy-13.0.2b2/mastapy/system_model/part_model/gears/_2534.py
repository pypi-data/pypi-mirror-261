...
class GearSet(_2478.SpecialisedAssembly):
    ...
    class _Cast_GearSet:
        ...
        @property
        def part(self: "GearSet._Cast_GearSet") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "GearSet._Cast_GearSet") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
        ...
        @property
        def bevel_gear_set(self: "GearSet._Cast_GearSet") -> "_2522.BevelGearSet":
            from mastapy.system_model.part_model.gears import _2522

            return self._parent._cast(_2522.BevelGearSet)

        @property
        def concept_gear_set(self: "GearSet._Cast_GearSet") -> "_2524.ConceptGearSet":
            from mastapy.system_model.part_model.gears import _2524

            return self._parent._cast(_2524.ConceptGearSet)

        @property
        def conical_gear_set(self: "GearSet._Cast_GearSet") -> "_2526.ConicalGearSet":
        ...
        @property
        def face_gear_set(self: "GearSet._Cast_GearSet") -> "_2531.FaceGearSet":
            from mastapy.system_model.part_model.gears import _2531

            return self._parent._cast(_2531.FaceGearSet)

        @property
        def hypoid_gear_set(self: "GearSet._Cast_GearSet") -> "_2537.HypoidGearSet":
        ...
        @property
        def worm_gear_set(self: "GearSet._Cast_GearSet") -> "_2554.WormGearSet":
    ...
    def active_design(self: Self, value: "_951.GearSetDesign"):
        wrapper_type = (
    ...
    @property
    def active_gear_set_design(self: Self) -> "_951.GearSetDesign":
    ...
    @property
    def gear_set_designs(self: Self) -> "List[_951.GearSetDesign]":
    ...
    @enforce_parameter_types
    def add_gear_set_design(self: Self, design: "_951.GearSetDesign"):
    ...
    @enforce_parameter_types
    def remove_design(self: Self, design: "_951.GearSetDesign"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def set_active_gear_set_design(self: Self, gear_set_design: "_951.GearSetDesign"):
        """Method does not return.
