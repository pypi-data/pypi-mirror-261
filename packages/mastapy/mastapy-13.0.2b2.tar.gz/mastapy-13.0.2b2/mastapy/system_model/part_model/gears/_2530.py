...
class FaceGear(_2532.Gear):
    ...
    class _Cast_FaceGear:
        ...
        @property
        def gear(self: "FaceGear._Cast_FaceGear") -> "_2532.Gear":
        ...
        @property
        def component(self: "FaceGear._Cast_FaceGear") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "FaceGear._Cast_FaceGear") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "FaceGear._Cast_FaceGear") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
    ...
    @property
    def active_gear_design(self: Self) -> "_990.FaceGearDesign":
    ...
    @property
    def face_gear_design(self: Self) -> "_990.FaceGearDesign":
        """mastapy.gears.gear_designs.face.FaceGearDesign
