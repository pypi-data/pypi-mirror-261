...
from mastapy.system_model.part_model import _2473, _2474
...
if TYPE_CHECKING:
    from mastapy.system_model import _2209, _2213
...
class DutyCycleImporter(_0.APIBase):
    ...
    @property
    def duty_cycles_to_import(self: Self) -> "List[_2213.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: Self,
    ) -> "List[_2209.DutyCycleImporterDesignEntityMatch[_2473.PointLoad]]":
    ...
    def power_load_destinations(
        self: Self,
    ) -> "List[_2209.DutyCycleImporterDesignEntityMatch[_2474.PowerLoad]]":
