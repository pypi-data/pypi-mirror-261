...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self: Self) -> "_4353.DutyCycleResultsForAllGearSets":
    ...
    def results_for_all_bearings(
        self: Self,
    ) -> "List[_4355.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: Self,
    ) -> "List[_4356.DutyCycleResultsForSingleShaft]":
