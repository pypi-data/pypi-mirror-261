...
class CylindricalGearManufactureError(_6894.GearManufactureError):
    ...
    @property
    def pitch_errors_left_flank(self: Self) -> "_1537.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def pitch_errors_left_flank(self: Self, value: "_1537.Vector2DListAccessor"):
        self.wrapped.PitchErrorsLeftFlank = value.wrapped

    @property
    def pitch_errors_right_flank(self: Self) -> "_1537.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def pitch_errors_right_flank(self: Self, value: "_1537.Vector2DListAccessor"):
