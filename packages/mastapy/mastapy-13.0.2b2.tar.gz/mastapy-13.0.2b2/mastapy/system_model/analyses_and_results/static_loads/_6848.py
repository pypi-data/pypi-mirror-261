...
class ConicalGearManufactureError(_6894.GearManufactureError):
    ...
    @property
    def pitch_errors_concave_flank(self: Self) -> "_1537.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def pitch_errors_concave_flank(self: Self, value: "_1537.Vector2DListAccessor"):
        self.wrapped.PitchErrorsConcaveFlank = value.wrapped

    @property
    def pitch_errors_convex_flank(self: Self) -> "_1537.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def pitch_errors_convex_flank(self: Self, value: "_1537.Vector2DListAccessor"):
