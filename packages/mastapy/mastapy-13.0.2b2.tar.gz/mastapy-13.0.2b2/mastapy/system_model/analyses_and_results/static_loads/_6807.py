...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5768, _5772
    from mastapy.system_model.analyses_and_results.load_case_groups import (
        _5663,
        _5664,
        _5665,
    )
    from mastapy.system_model.analyses_and_results.static_loads import _6820, _6814
...
class StaticLoadCase(_6806.LoadCase):
    ...
    class _Cast_StaticLoadCase:
        ...
        @property
        def load_case(self: "StaticLoadCase._Cast_StaticLoadCase") -> "_6806.LoadCase":
            return self._parent._cast(_6806.LoadCase)

        @property
        def context(self: "StaticLoadCase._Cast_StaticLoadCase") -> "_2652.Context":
