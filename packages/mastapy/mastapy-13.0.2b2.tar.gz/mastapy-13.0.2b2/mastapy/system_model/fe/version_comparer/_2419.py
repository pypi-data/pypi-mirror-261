...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1566, _1564
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self: Self) -> "_1566.VectorWithLinearAndAngularComponents":
    ...
    @property
    def new_result(self: Self) -> "_1564.NodeResults":
    ...
    @property
    def original_result(self: Self) -> "_1564.NodeResults":
        """mastapy.math_utility.measured_vectors.NodeResults
