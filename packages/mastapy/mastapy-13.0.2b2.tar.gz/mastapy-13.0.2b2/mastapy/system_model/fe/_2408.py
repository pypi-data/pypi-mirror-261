...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2359, _2366
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self: Self) -> "_2359.AlignmentMethodForRaceBearing":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2359", "AlignmentMethodForRaceBearing"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2359.AlignmentMethodForRaceBearing"):
    ...
    @property
    def links(self: Self) -> "List[_2366.BearingRaceNodeLink]":
