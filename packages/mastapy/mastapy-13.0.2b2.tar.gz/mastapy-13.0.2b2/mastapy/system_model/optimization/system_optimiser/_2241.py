...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.optimization.system_optimiser import _2242, _2243, _2239
    from mastapy.utility.logging import _1810
    from mastapy.system_model.part_model.gears import _2528, _2534
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(self: Self, value: "_5666.DutyCycle"):
        wrapper_type = (
    ...
    @property
    def design(self: Self) -> "_2202.Design":
    ...
    @property
    def details(self: Self) -> "_2242.SystemOptimiserDetails":
    ...
    @property
    def log(self: Self) -> "_1810.Logger":
    ...
    @property
    def tooth_number_finder(self: Self) -> "_2243.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: Self,
    ) -> "List[_5670.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: Self) -> "List[_2239.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: Self) -> "_5666.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: Self, value: "_5666.DutyCycle"):
