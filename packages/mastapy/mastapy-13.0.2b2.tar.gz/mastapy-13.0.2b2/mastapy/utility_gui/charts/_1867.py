...
if TYPE_CHECKING:
    from mastapy.utility.report import _1745, _1750
...
class ThreeDChartDefinition(_1861.NDChartDefinition):
    ...
    @property
    def x_axis_range(self: Self) -> "_1491.Range":
    ...
    def x_axis_range(self: Self, value: "_1491.Range"):
        self.wrapped.XAxisRange = value.wrapped

    @property
    def y_axis_range(self: Self) -> "_1491.Range":
        """mastapy.math_utility.Range"""
    ...
    @y_axis_range.setter
    @enforce_parameter_types
    def y_axis_range(self: Self, value: "_1491.Range"):
        self.wrapped.YAxisRange = value.wrapped

    @property
    def z_axis_range(self: Self) -> "_1491.Range":
        """mastapy.math_utility.Range"""
    ...
    @z_axis_range.setter
    @enforce_parameter_types
    def z_axis_range(self: Self, value: "_1491.Range"):
