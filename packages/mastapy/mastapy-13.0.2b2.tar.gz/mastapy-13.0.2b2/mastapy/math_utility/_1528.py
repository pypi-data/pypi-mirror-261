...
if TYPE_CHECKING:
    from mastapy.math_utility import _1511, _1526, _1538, _1516
...
class RealVector(_1527.RealMatrix):
    """RealVector
    ...
    class _Cast_RealVector:
        ...
        @property
        def real_matrix(self: "RealVector._Cast_RealVector") -> "_1527.RealMatrix":
        ...
        @property
        def quaternion(self: "RealVector._Cast_RealVector") -> "_1526.Quaternion":
            from mastapy.math_utility import _1526

            return self._parent._cast(_1526.Quaternion)

        @property
        def vector_6d(self: "RealVector._Cast_RealVector") -> "_1538.Vector6D":
