...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1106, _1107
...
class ProfileModification(_579.Modification):
    ...
    @property
    def measured_data(self: Self) -> "_1537.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_data(self: Self, value: "_1537.Vector2DListAccessor"):
