...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.conical.micro_geometry import _1173, _1175, _1176
...
class Modification(_0.APIBase):
    ...
    class _Cast_Modification:
        ...
        def cylindrical_gear_bias_modification(
            ...
            return self._parent._cast(_1094.CylindricalGearBiasModification)
        ...
        def cylindrical_gear_lead_modification(
            ...
            return self._parent._cast(_1097.CylindricalGearLeadModification)
        ...
        def cylindrical_gear_profile_modification(
            ...
            return self._parent._cast(_1106.CylindricalGearProfileModification)
        ...
        def cylindrical_gear_triangular_end_modification(
            ...
            return self._parent._cast(_1111.CylindricalGearTriangularEndModification)
        ...
        def conical_gear_bias_modification(
            ...
            return self._parent._cast(_1173.ConicalGearBiasModification)
        ...
        def conical_gear_lead_modification(
            ...
            return self._parent._cast(_1175.ConicalGearLeadModification)

        @property
        def conical_gear_profile_modification(
            self: "Modification._Cast_Modification",
        ) -> "_1176.ConicalGearProfileModification":
            from mastapy.gears.gear_designs.conical.micro_geometry import _1176

            return self._parent._cast(_1176.ConicalGearProfileModification)
    ...
    @property
    def settings(self: Self) -> "_1023.CylindricalGearMicroGeometrySettingsItem":
