...
class FlankMicroGeometry(_0.APIBase):
    ...
    class _Cast_FlankMicroGeometry:
        ...
        def cylindrical_gear_flank_micro_geometry(
            ...
            return self._parent._cast(_1096.CylindricalGearFlankMicroGeometry)
        ...
        def conical_gear_flank_micro_geometry(
            ...
            return self._parent._cast(_1174.ConicalGearFlankMicroGeometry)
    ...
    @property
    def gear_design(self: Self) -> "_948.GearDesign":
