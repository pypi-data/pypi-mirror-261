...
if TYPE_CHECKING:
    from mastapy.gears.analysis import _1219, _1227, _1224, _1225, _1226
    ...
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1099, _1100
...
class GearMeshDesignAnalysis(_1217.AbstractGearMeshAnalysis):
    """GearMeshDesignAnalysis
    ...
    class _Cast_GearMeshDesignAnalysis:
        ...
        def cylindrical_gear_mesh_micro_geometry_duty_cycle(
            ...
            return self._parent._cast(_1100.CylindricalGearMeshMicroGeometryDutyCycle)
        ...
        def gear_mesh_implementation_analysis_duty_cycle(
            ...
            return self._parent._cast(_1225.GearMeshImplementationAnalysisDutyCycle)
    ...
    @property
    def gear_a(self: Self) -> "_1219.GearDesignAnalysis":
    ...
    @property
    def gear_b(self: Self) -> "_1219.GearDesignAnalysis":
        """mastapy.gears.analysis.GearDesignAnalysis
    ...
    @property
    def gear_set(self: Self) -> "_1227.GearSetDesignAnalysis":
