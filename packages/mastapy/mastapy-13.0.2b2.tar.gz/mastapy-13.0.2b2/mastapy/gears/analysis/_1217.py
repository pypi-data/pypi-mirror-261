...
if TYPE_CHECKING:
    from mastapy.gears.analysis import _1216, _1223, _1224, _1225, _1226
...
class AbstractGearMeshAnalysis(_0.APIBase):
    ...
    @property
    def gear_a(self: Self) -> "_1216.AbstractGearAnalysis":
    ...
    @property
    def gear_b(self: Self) -> "_1216.AbstractGearAnalysis":
        """mastapy.gears.analysis.AbstractGearAnalysis
