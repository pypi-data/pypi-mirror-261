...
class FaceGearSetParetoOptimiser(_912.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_996.FaceGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_996.FaceGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_996.FaceGearSetDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearSetDesign]
