...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1551, _1548, _1543
...
TAnalysis = TypeVar("TAnalysis", bound="_1218.AbstractGearSetAnalysis")
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_DesignSpaceSearchBase:
        ...
        def micro_geometry_gear_set_design_space_search(
            ...
            return self._parent._cast(_920.MicroGeometryGearSetDesignSpaceSearch)
        ...
        def spiral_bevel_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_939.SpiralBevelGearSetParetoOptimiser)
        ...
        def straight_bevel_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_940.StraightBevelGearSetParetoOptimiser)
    ...
    @property
    def input_setters(self: Self) -> "List[_1543.InputSetter[TAnalysis]]":
    ...
    @property
    def optimisation_targets(self: Self) -> "List[_923.OptimisationTarget[TAnalysis]]":
    ...
    def reasons_for_invalid_candidates(
        self: Self,
    ) -> "List[_938.ReasonsForInvalidDesigns]":
