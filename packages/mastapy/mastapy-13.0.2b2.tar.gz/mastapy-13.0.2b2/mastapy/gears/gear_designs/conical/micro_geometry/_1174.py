...
class ConicalGearFlankMicroGeometry(_570.FlankMicroGeometry):
    ...
    @property
    def bias(self: Self) -> "_1173.ConicalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1175.ConicalGearLeadModification":
    ...
    @property
    def profile_relief(self: Self) -> "_1176.ConicalGearProfileModification":
    ...
    @property
    def gear_design(self: Self) -> "_1155.ConicalGearDesign":
