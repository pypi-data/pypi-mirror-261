...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.concept import _1179, _1177
...
class ConceptGearMeshDesign(_950.GearMeshDesign):
    """ConceptGearMeshDesign
    ...
    @property
    def concept_gear_set(self: Self) -> "_1179.ConceptGearSetDesign":
