...
class BevelGearDesign(_1194.AGMAGleasonConicalGearDesign):
    """BevelGearDesign
    ...
    @property
    def finishing_method(self: Self) -> "_1187.FinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1187", "FinishingMethods"
        )(value)

    @finishing_method.setter
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_1187.FinishingMethods"):
