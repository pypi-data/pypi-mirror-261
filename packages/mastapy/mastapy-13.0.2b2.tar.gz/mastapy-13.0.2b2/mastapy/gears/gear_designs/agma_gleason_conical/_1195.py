...
from mastapy.gears.gear_designs.conical import _1170, _1156
...
class AGMAGleasonConicalGearMeshDesign(_1156.ConicalGearMeshDesign):
    """AGMAGleasonConicalGearMeshDesign
    ...
    @enforce_parameter_types
    def load_distribution_factor_method(
        self: Self, value: "_1170.LoadDistributionFactorMethods"
    ):
