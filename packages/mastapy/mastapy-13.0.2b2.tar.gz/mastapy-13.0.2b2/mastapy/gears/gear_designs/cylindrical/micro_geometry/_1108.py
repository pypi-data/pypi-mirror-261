...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1029, _1042, _1013
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1102, _1099
    from mastapy.gears.analysis import _1227, _1218
...
class CylindricalGearSetMicroGeometry(_1232.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    class _Cast_CylindricalGearSetMicroGeometry:
        ...
        def gear_set_implementation_detail(
            ...
            return self._parent._cast(_1232.GearSetImplementationDetail)
    ...
    @property
    def cylindrical_gear_set_design(self: Self) -> "_1029.CylindricalGearSetDesign":
    ...
    def cylindrical_gear_micro_geometries(
        self: Self,
    ) -> "List[_1102.CylindricalGearMicroGeometryBase]":
    ...
    def cylindrical_mesh_micro_geometries(
        self: Self,
    ) -> "List[_1099.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: Self, gear_set_design: "_1029.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: Self, gear_set_design: "_1042.CylindricalPlanetaryGearSetDesign"
    ) -> "_1232.GearSetImplementationDetail":
        """mastapy.gears.analysis.GearSetImplementationDetail
