...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1040, _1013, _1019
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self: Self) -> "_1040.CylindricalMeshedGearFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1040.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def flanks(self: Self) -> "List[_1040.CylindricalMeshedGearFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1040.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def mesh(self: Self) -> "_1019.CylindricalGearMeshDesign":
