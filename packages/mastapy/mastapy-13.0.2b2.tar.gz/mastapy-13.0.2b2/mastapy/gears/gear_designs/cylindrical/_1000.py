...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1059, _1038
...
class BacklashSpecification(_1069.RelativeValuesSpecification["BacklashSpecification"]):
    """BacklashSpecification
    ...
    class _Cast_BacklashSpecification:
        ...
        def relative_values_specification(
            ...
            return self._parent._cast(_1069.RelativeValuesSpecification)
    ...
    @property
    def left_flank(self: Self) -> "_1059.LinearBacklashSpecification":
    ...
    @property
    def right_flank(self: Self) -> "_1059.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
    ...
    @property
    def angular_backlash(self: Self) -> "List[_1038.CylindricalMeshAngularBacklash]":
    ...
    @property
    def flanks(self: Self) -> "List[_1059.LinearBacklashSpecification]":
    ...
    @property
    def both_flanks(self: Self) -> "_1059.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
