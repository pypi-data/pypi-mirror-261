...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1118, _1125
...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    @property
    def profile_evaluation(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
    ...
    @property
    def profile_start(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
