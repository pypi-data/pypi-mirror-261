...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1073, _1074
...
class Scuffing(_1588.IndependentReportablePropertiesBase["Scuffing"]):
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: Self, value: "_1072.ScuffingCoefficientOfFrictionMethods"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: Self, value: "_1073.ScuffingTemperatureMethodsAGMA"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: Self, value: "_1074.ScuffingTemperatureMethodsISO"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",
