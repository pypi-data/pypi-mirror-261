...
class CylindricalGearDefaults(_1596.PerMachineSettings):
    ...
    @property
    def finish_stock_type(self: Self) -> "_1091.FinishStockType":
    ...
    @enforce_parameter_types
    def finish_stock_type(self: Self, value: "_1091.FinishStockType"):
    ...
    @property
    def system_of_fits_defaults(self: Self) -> "_1141.DIN3967SystemOfGearFits":
