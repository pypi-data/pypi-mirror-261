...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1065, _1066
...
class CylindricalPlanetGearDesign(_1013.CylindricalGearDesign):
    """CylindricalPlanetGearDesign
    ...
    @property
    def planet_assembly_indices(self: Self) -> "List[_1065.NamedPlanetAssemblyIndex]":
    ...
    def planetary_sidebands_amplitude_factors(
        self: Self,
    ) -> "List[_1066.NamedPlanetSideBandAmplitudeFactor]":
