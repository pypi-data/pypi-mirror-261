...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1003, _1049
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        self: Self, value: "_1003.CreateNewSuitableCutterOption"
    ):
    ...
    @property
    def gears(self: Self) -> "List[_1049.GearManufacturingConfigSetupViewModel]":
