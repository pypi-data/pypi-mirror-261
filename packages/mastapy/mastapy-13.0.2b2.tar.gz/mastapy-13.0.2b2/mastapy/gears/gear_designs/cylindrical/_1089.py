...
class Usage(_1588.IndependentReportablePropertiesBase["Usage"]):
    ...
    @property
    def spur_gear_load_sharing_code(self: Self) -> "_1076.SpurGearLoadSharingCodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1076", "SpurGearLoadSharingCodes"
        )(value)

    @spur_gear_load_sharing_code.setter
    @enforce_parameter_types
    def spur_gear_load_sharing_code(
        self: Self, value: "_1076.SpurGearLoadSharingCodes"
    ):
        value = conversion.mp_to_pn_enum(
