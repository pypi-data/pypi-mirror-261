...
class CylindricalGearSetDesign(_951.GearSetDesign):
    """CylindricalGearSetDesign
    ...
    @property
    def gear_fit_system(self: Self) -> "_1048.GearFitSystems":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1048", "GearFitSystems"
        )(value)

    @gear_fit_system.setter
    @enforce_parameter_types
    def gear_fit_system(self: Self, value: "_1048.GearFitSystems"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def profile_shift_distribution_rule(
        self: Self, value: "_999.AddendumModificationDistributionRule"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.AddendumModificationDistributionRule",
    ...
    @property
    def ltca_settings(self: Self) -> "_1061.LTCASettings":
    ...
    @property
    def left_flank(self: Self) -> "_1030.CylindricalGearSetFlankDesign":
    ...
    @property
    def micropitting(self: Self) -> "_1064.Micropitting":
    ...
    @property
    def right_flank(self: Self) -> "_1030.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def scuffing(self: Self) -> "_1071.Scuffing":
    ...
    @property
    def usage(self: Self) -> "_1089.Usage":
    ...
    @property
    def gears(self: Self) -> "List[_1013.CylindricalGearDesign]":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_1013.CylindricalGearDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign]
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_1019.CylindricalGearMeshDesign]":
    ...
    @property
    def flanks(self: Self) -> "List[_1030.CylindricalGearSetFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1030.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1108.CylindricalGearSetMicroGeometry]":
    ...
    def add_new_micro_geometry(self: Self) -> "_1108.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry"""
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(
        self: Self, gears: "List[_1013.CylindricalGearDesign]"
    ) -> "_1108.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def delete_micro_geometry(
        self: Self, micro_geometry: "_1108.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
    ...
    def set_active_micro_geometry(
        self: Self, value: "_1108.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
