...
class CylindricalGearProfileModification(_582.ProfileModification):
    ...
    @property
    def barrelling_peak_point(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
    ...
    @property
    def evaluation_lower_limit(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    @property
    def evaluation_upper_limit(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
