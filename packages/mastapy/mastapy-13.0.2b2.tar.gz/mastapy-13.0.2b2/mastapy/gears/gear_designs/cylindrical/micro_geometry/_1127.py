...
class ProfileReliefWithDeviation(_1129.ReliefWithDeviation):
    """ProfileReliefWithDeviation
    ...
    class _Cast_ProfileReliefWithDeviation:
        ...
        def relief_with_deviation(
            ...
            return self._parent._cast(_1129.ReliefWithDeviation)
    ...
    @property
    def position_on_profile(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
