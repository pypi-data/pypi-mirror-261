...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _996, _994, _993
...
class FaceGearSetMicroGeometry(_1232.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    @property
    def face_gear_set_design(self: Self) -> "_996.FaceGearSetDesign":
    ...
    @property
    def face_gear_micro_geometries(self: Self) -> "List[_994.FaceGearMicroGeometry]":
    ...
    def face_mesh_micro_geometries(
        self: Self,
    ) -> "List[_993.FaceGearMeshMicroGeometry]":
