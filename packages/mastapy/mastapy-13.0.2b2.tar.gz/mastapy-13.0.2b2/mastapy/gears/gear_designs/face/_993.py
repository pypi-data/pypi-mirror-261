...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _997, _992, _994
...
class FaceGearMeshMicroGeometry(_1226.GearMeshImplementationDetail):
    """FaceGearMeshMicroGeometry
    ...
    @property
    def face_gear_set_micro_geometry(self: Self) -> "_997.FaceGearSetMicroGeometry":
    ...
    @property
    def face_mesh(self: Self) -> "_992.FaceGearMeshDesign":
