...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _997, _998, _995, _990, _992
...
class FaceGearSetDesign(_951.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def face_gear(self: Self) -> "_998.FaceGearWheelDesign":
    ...
    @property
    def pinion(self: Self) -> "_995.FaceGearPinionDesign":
    ...
    @property
    def gears(self: Self) -> "List[_990.FaceGearDesign]":
    ...
    @property
    def face_gears(self: Self) -> "List[_990.FaceGearDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearDesign]
    ...
    @property
    def face_meshes(self: Self) -> "List[_992.FaceGearMeshDesign]":
