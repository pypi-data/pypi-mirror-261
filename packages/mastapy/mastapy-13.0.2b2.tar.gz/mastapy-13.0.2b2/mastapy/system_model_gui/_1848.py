...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility import _1513, _1495
...
class MASTAGUI(_0.APIBase):
    ...
    def add_fe_substructure_from_data(
        self: Self,
        vertices_and_facets: "_1513.FacetedBody",
        geometry_modeller_design_information: "_155.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _156.GeometryModellerDimension]",
        body_moniker: "str",
    ):
    ...
    def add_line_from_geometry_modeller(
        self: Self, circles_on_axis: "_1495.CirclesOnAxis"
    ):
        """Method does not return.
    ...
    def circle_pairs_from_geometry_modeller(
        self: Self,
        preselection_circles: "_1495.CirclesOnAxis",
        selected_circles: "List[_1495.CirclesOnAxis]",
    ):
        """Method does not return.
    ...
    def create_new_circles_on_axis(self: Self) -> "_1495.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: Self) -> "_1513.FacetedBody":
