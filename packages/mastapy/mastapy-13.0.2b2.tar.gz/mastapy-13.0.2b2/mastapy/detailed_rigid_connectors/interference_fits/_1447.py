...
from mastapy.detailed_rigid_connectors.interference_fits import _1450
...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1445, _1446
    from mastapy.detailed_rigid_connectors.keyed_joints import _1439
...
class InterferenceFitDesign(_1389.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    class _Cast_InterferenceFitDesign:
        ...
        def keyed_joint_design(
            ...
            return self._parent._cast(_1439.KeyedJointDesign)
    ...
    @property
    def assembly_method(self: Self) -> "_1445.AssemblyMethods":
    ...
    def assembly_method(self: Self, value: "_1445.AssemblyMethods"):
    ...
    @property
    def calculation_method(self: Self) -> "_1446.CalculationMethods":
    ...
    @enforce_parameter_types
    def calculation_method(self: Self, value: "_1446.CalculationMethods"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(self: Self, value: "_1450.Table4JointInterfaceTypes"):
