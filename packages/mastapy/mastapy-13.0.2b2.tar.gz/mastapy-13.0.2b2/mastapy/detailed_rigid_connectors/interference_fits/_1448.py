...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints import _1441
...
class InterferenceFitHalfDesign(_1390.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    class _Cast_InterferenceFitHalfDesign:
        ...
        def keyway_joint_half_design(
            ...
            return self._parent._cast(_1441.KeywayJointHalfDesign)
    ...
    @property
    def stress_region(self: Self) -> "_1449.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1449", "StressRegions"
        )(value)
