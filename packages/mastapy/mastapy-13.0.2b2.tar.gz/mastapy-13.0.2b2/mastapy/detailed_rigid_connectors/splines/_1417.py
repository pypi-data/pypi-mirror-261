...
from mastapy.detailed_rigid_connectors.splines import _1396, _1419
...
class SplineJointDesign(_1389.DetailedRigidConnectorDesign):
    """SplineJointDesign
    ...
    class _Cast_SplineJointDesign:
        ...
        def detailed_rigid_connector_design(
            ...
            return self._parent._cast(_1389.DetailedRigidConnectorDesign)
        ...
        def custom_spline_joint_design(
            ...
            return self._parent._cast(_1392.CustomSplineJointDesign)
        ...
        def din5480_spline_joint_design(
            ...
            return self._parent._cast(_1395.DIN5480SplineJointDesign)
        ...
        def gbt3478_spline_joint_design(
            ...
            return self._parent._cast(_1399.GBT3478SplineJointDesign)
        ...
        def iso4156_spline_joint_design(
            ...
            return self._parent._cast(_1402.ISO4156SplineJointDesign)
        ...
        def jisb1603_spline_joint_design(
            ...
            return self._parent._cast(_1403.JISB1603SplineJointDesign)
        ...
        def sae_spline_joint_design(
            ...
            return self._parent._cast(_1410.SAESplineJointDesign)
        ...
        def standard_spline_joint_design(
            ...
            return self._parent._cast(_1422.StandardSplineJointDesign)
    ...
    @enforce_parameter_types
    def dudley_maximum_effective_length_option(
        self: Self, value: "_1396.DudleyEffectiveLengthApproximationOption"
    ):
    ...
    @property
    def fatigue_life_factor_type(self: Self) -> "_1408.SAEFatigueLifeFactorTypes":
    ...
    @enforce_parameter_types
    def fatigue_life_factor_type(self: Self, value: "_1408.SAEFatigueLifeFactorTypes"):
    ...
    @property
    def root_type(self: Self) -> "_1407.RootTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1407", "RootTypes"
        )(value)

    @root_type.setter
    @enforce_parameter_types
    def root_type(self: Self, value: "_1407.RootTypes"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def spline_fixture_type(self: Self) -> "_1415.SplineFixtureTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1415", "SplineFixtureTypes"
        )(value)

    @spline_fixture_type.setter
    @enforce_parameter_types
    def spline_fixture_type(self: Self, value: "_1415.SplineFixtureTypes"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def spline_rating_type(self: Self, value: "_1419.SplineRatingTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_cycles(self: Self) -> "_1411.SAETorqueCycles":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1411", "SAETorqueCycles"
        )(value)

    @torque_cycles.setter
    @enforce_parameter_types
    def torque_cycles(self: Self, value: "_1411.SAETorqueCycles"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def external_half(self: Self) -> "_1416.SplineHalfDesign":
    ...
    @property
    def internal_half(self: Self) -> "_1416.SplineHalfDesign":
        """mastapy.detailed_rigid_connectors.splines.SplineHalfDesign
