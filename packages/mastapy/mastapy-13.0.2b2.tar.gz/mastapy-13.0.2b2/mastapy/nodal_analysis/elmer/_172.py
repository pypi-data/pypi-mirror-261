...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1327, _1339
...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def electric_machine_mechanical_results_viewable(
            ...
            return self._parent._cast(_1327.ElectricMachineMechanicalResultsViewable)
        ...
        def electric_machine_results_viewable(
            ...
            return self._parent._cast(_1339.ElectricMachineResultsViewable)
    ...
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1529.ResultOptionsFor3DVector"):
