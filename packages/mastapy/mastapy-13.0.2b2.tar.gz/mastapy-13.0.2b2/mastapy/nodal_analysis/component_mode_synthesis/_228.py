...
if TYPE_CHECKING:
    ...
    from mastapy.fe_tools.vfx_tools import _1239
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self: Self) -> "_1505.DataPrecision":
    ...
    @property
    def solver_options(self: Self) -> "_1239.ProSolveOptions":
