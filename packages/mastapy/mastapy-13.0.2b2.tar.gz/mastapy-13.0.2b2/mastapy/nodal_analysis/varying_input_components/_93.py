...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @property
    def value_vs_angle(self: Self) -> "_1537.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def value_vs_angle(self: Self, value: "_1537.Vector2DListAccessor"):
    ...
    @property
    def value_vs_position(self: Self) -> "_1537.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_position(self: Self, value: "_1537.Vector2DListAccessor"):
        self.wrapped.ValueVsPosition = value.wrapped

    @property
    def value_vs_time(self: Self) -> "_1537.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_time(self: Self, value: "_1537.Vector2DListAccessor"):
