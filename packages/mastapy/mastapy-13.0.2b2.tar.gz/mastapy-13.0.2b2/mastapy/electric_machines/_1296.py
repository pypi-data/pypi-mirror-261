...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1283, _1312, _1313
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    class _Cast_RotorInternalLayerSpecification:
        ...
        def u_shaped_layer_specification(
            ...
            return self._parent._cast(_1312.UShapedLayerSpecification)
        ...
        def v_shaped_magnet_layer_specification(
            ...
            return self._parent._cast(_1313.VShapedMagnetLayerSpecification)
    ...
    @property
    def magnets(self: Self) -> "_1283.MagnetForLayer":
