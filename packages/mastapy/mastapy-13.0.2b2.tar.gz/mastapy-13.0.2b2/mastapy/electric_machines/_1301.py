...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1302, _1308
...
class Stator(_1244.AbstractStator):
    """Stator
    ...
    class _Cast_Stator:
        ...
        @property
        def abstract_stator(self: "Stator._Cast_Stator") -> "_1244.AbstractStator":
            return self._parent._cast(_1244.AbstractStator)
    ...
    def stator_cut_out_specifications(
        self: Self,
    ) -> "List[_1302.StatorCutOutSpecification]":
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1308.ToothAndSlot":
