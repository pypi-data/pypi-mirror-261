...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1360, _1373, _1358
...
class SingleOperatingPointAnalysis(_1354.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    class _Cast_SingleOperatingPointAnalysis:
        ...
        def electric_machine_analysis(
            ...
            return self._parent._cast(_1354.ElectricMachineAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1360.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: Self,
    ) -> "List[_1373.SlotDetailForAnalysis]":
