...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1376, _1361
...
class SpeedTorqueCurveLoadCase(_1369.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """SpeedTorqueCurveLoadCase
