...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1342, _1344
...
class ElectricMachineDQModel(_0.APIBase):
    ...
    class _Cast_ElectricMachineDQModel:
        ...
        def linear_dq_model(
            ...
            return self._parent._cast(_1342.LinearDQModel)
        ...
        def non_linear_dq_model(
            ...
            return self._parent._cast(_1344.NonLinearDQModel)
