...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1368, _1365
...
class OnLoadElectricMachineResults(_1328.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    class _Cast_OnLoadElectricMachineResults:
        ...
        def electric_machine_results(
            ...
            return self._parent._cast(_1328.ElectricMachineResults)
    ...
    @property
    def motoring_or_generating(self: Self) -> "_1368.MotoringOrGenerating":
    ...
    @property
    def power_factor_direction(self: Self) -> "_1365.LeadingOrLagging":
    ...
    @property
    def windings(self: Self) -> "_1318.Windings":
