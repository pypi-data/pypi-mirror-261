...
from mastapy.electric_machines.harmonic_load_data import _1384, _1381, _1385
...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.harmonic_load_data import _1387, _1388, _1382
...
class ElectricMachineHarmonicLoadDataBase(_1385.SpeedDependentHarmonicLoadData):
    """ElectricMachineHarmonicLoadDataBase
    ...
    class _Cast_ElectricMachineHarmonicLoadDataBase:
        ...
        def dynamic_force_results(
            ...
            return self._parent._cast(_1323.DynamicForceResults)
    ...
    @enforce_parameter_types
    def data_type_for_force_moment_distribution_and_temporal_spatial_harmonics_charts(
        self: Self, value: "_1384.HarmonicLoadDataType"
    ):
    ...
    @enforce_parameter_types
    def display_option_for_slice_data(self: Self, value: "_1381.ForceDisplayOption"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @slice.setter
    @enforce_parameter_types
    def slice(self: Self, value: "_1297.RotorSkewSlice"):
        wrapper_type = (
    ...
    @property
    def rotor_x_force(self: Self) -> "_1523.MultipleFourierSeriesInterpolator":
    ...
    @property
    def rotor_y_force(self: Self) -> "_1523.MultipleFourierSeriesInterpolator":
        """mastapy.math_utility.MultipleFourierSeriesInterpolator
    ...
    @property
    def stator_axial_loads(self: Self) -> "_1387.StatorToothLoadInterpolator":
    ...
    @property
    def stator_radial_loads(self: Self) -> "_1387.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tangential_loads(self: Self) -> "_1387.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tooth_moments(self: Self) -> "_1388.StatorToothMomentInterpolator":
    ...
    def multiple_fourier_series_interpolator_for(
        self: Self,
        harmonic_load_data_type: "_1384.HarmonicLoadDataType",
        slice_index: "int",
