...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.harmonic_load_data import _1380, _1385
...
class HarmonicLoadDataBase(_0.APIBase):
    ...
    def data_type(self: Self, value: "_1384.HarmonicLoadDataType"):
    ...
    def set_selected_harmonic_load_data_with_fourier_series(
        self: Self, fourier_series: "_1515.FourierSeries"
    ):
        """Method does not return.
