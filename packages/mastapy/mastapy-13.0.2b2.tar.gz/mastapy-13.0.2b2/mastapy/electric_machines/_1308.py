...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1310, _1309
...
class ToothAndSlot(_1245.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    class _Cast_ToothAndSlot:
        ...
        def abstract_tooth_and_slot(
            ...
            return self._parent._cast(_1245.AbstractToothAndSlot)
    ...
    @property
    def tooth_taper_specification(self: Self) -> "_1310.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1310", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(self: Self, value: "_1310.ToothTaperSpecification"):
    ...
    @property
    def tooth_slot_style(self: Self) -> "_1309.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1309", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: Self, value: "_1309.ToothSlotStyle"):
        value = conversion.mp_to_pn_enum(
