...
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1292.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    class _Cast_InteriorPermanentMagnetAndSynchronousReluctanceRotor:
        ...
        def permanent_magnet_rotor(
            ...
            return self._parent._cast(_1292.PermanentMagnetRotor)
        ...
        def rotor(
            ...
            return self._parent._cast(_1295.Rotor)
    ...
    @property
    def flux_barrier_style(self: Self) -> "_1272.FluxBarrierStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1272", "FluxBarrierStyle"
        )(value)

    @flux_barrier_style.setter
    @enforce_parameter_types
    def flux_barrier_style(self: Self, value: "_1272.FluxBarrierStyle"):
    ...
    @property
    def rotor_type(self: Self) -> "_1298.RotorType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1298", "RotorType"
        )(value)

    @rotor_type.setter
    @enforce_parameter_types
    def rotor_type(self: Self, value: "_1298.RotorType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def cooling_duct_layers(self: Self) -> "List[_1256.CoolingDuctLayerSpecification]":
    ...
    @property
    def notch_specifications(self: Self) -> "List[_1290.NotchSpecification]":
    ...
    @property
    def u_shape_layers(self: Self) -> "List[_1312.UShapedLayerSpecification]":
    ...
    def v_shape_magnet_layers(
        self: Self,
    ) -> "List[_1313.VShapedMagnetLayerSpecification]":
