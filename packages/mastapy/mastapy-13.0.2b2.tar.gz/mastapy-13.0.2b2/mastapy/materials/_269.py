...
if TYPE_CHECKING:
    ...
    from mastapy.bolts import _1468, _1472
...
class Material(_1831.NamedDatabaseItem):
    ...
    class _Cast_Material:
        ...
        @property
        def magnet_material(self: "Material._Cast_Material") -> "_1285.MagnetMaterial":
        ...
        @property
        def spline_material(self: "Material._Cast_Material") -> "_1418.SplineMaterial":
            from mastapy.detailed_rigid_connectors.splines import _1418
        ...
        @property
        def bolt_material(self: "Material._Cast_Material") -> "_1472.BoltMaterial":
