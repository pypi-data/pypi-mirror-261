...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1311, _1262
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electro_magnetic_analysis(
        self: Self,
    ) -> "_1311.TwoDimensionalFEModelForAnalysis[_1266.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: Self) -> "_1262.Eccentricity":
