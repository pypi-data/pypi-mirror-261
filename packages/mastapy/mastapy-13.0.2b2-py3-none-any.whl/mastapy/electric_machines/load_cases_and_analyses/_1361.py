...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def basic_dynamic_force_load_case(
            ...
            return self._parent._cast(_1348.BasicDynamicForceLoadCase)
        ...
        def dynamic_force_load_case(
            ...
            return self._parent._cast(_1350.DynamicForceLoadCase)
        ...
        def efficiency_map_load_case(
            ...
            return self._parent._cast(_1353.EfficiencyMapLoadCase)
        ...
        def electric_machine_load_case(
            ...
            return self._parent._cast(_1360.ElectricMachineLoadCase)
        ...
        def electric_machine_mechanical_load_case(
            ...
            return self._parent._cast(_1363.ElectricMachineMechanicalLoadCase)
        ...
        def speed_torque_curve_load_case(
            ...
            return self._parent._cast(_1377.SpeedTorqueCurveLoadCase)
        ...
        def speed_torque_load_case(
            ...
            return self._parent._cast(_1378.SpeedTorqueLoadCase)
    ...
    @property
    def temperatures(self: Self) -> "_1379.Temperatures":
    ...
    @property
    def analyses(self: Self) -> "List[_1354.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: Self, another_group: "_1362.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: Self, electric_machine_analysis: "_1354.ElectricMachineAnalysis"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_analysis_for(self: Self, setup: "_1268.ElectricMachineSetup"):
        """Method does not return.
