...
class SpeedTorqueCurveAnalysis(_1354.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1377.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: Self) -> "List[_1343.MaximumTorqueResultsPoints]":
