...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1348, _1358
...
class DynamicForceAnalysis(
    _1354.ElectricMachineAnalysis, _1341.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1348.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: Self) -> "_1323.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: Self,
    ) -> "List[_1358.ElectricMachineFEAnalysis]":
