...
class ElectricMachineMeshingOptions(_1267.ElectricMachineMeshingOptionsBase):
    """ElectricMachineMeshingOptions
    ...
    class _Cast_ElectricMachineMeshingOptions:
        ...
        def electric_machine_meshing_options_base(
            ...
            return self._parent._cast(_1267.ElectricMachineMeshingOptionsBase)
    ...
    @property
    def air_gap_partition(self: Self) -> "_1246.AirGapPartition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1246", "AirGapPartition"
        )(value)

    @air_gap_partition.setter
    @enforce_parameter_types
    def air_gap_partition(self: Self, value: "_1246.AirGapPartition"):
