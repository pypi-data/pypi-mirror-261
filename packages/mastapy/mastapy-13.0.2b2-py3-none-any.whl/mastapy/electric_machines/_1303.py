...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1278, _1259
...
class StatorRotorMaterial(_269.Material):
    ...
    def coefficient_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1278", "IronLossCoefficientSpecificationMethod"
        )(value)

    @coefficient_specification_method.setter
    @enforce_parameter_types
    def coefficient_specification_method(
        self: Self, value: "_1278.IronLossCoefficientSpecificationMethod"
    ):
    ...
    @property
    def core_loss_coefficients(self: Self) -> "_1259.CoreLossCoefficients":
