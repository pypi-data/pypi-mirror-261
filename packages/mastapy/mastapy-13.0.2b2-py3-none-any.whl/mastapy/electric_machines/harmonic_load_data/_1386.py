...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.harmonic_load_data import _1387, _1388
...
class StatorToothInterpolator(_0.APIBase):
    ...
    class _Cast_StatorToothInterpolator:
        ...
        def stator_tooth_load_interpolator(
            ...
            return self._parent._cast(_1387.StatorToothLoadInterpolator)
        ...
        def stator_tooth_moment_interpolator(
            ...
            return self._parent._cast(_1388.StatorToothMomentInterpolator)
