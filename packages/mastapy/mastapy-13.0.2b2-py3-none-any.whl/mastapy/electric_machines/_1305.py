...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1306, _1263
...
class SurfacePermanentMagnetMachine(_1288.NonCADElectricMachineDetail):
    """SurfacePermanentMagnetMachine
    ...
    @property
    def rotor(self: Self) -> "_1306.SurfacePermanentMagnetRotor":
