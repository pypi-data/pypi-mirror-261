...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines import _1251, _1252
...
class CADElectricMachineDetail(_1263.ElectricMachineDetail):
    """CADElectricMachineDetail
    ...
    @property
    def rotor(self: Self) -> "_1251.CADRotor":
    ...
    @property
    def stator(self: Self) -> "_1252.CADStator":
