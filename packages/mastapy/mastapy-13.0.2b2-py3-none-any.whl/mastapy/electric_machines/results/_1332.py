...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1346, _1347
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def on_load_results(self: Self) -> "_1346.OnLoadElectricMachineResults":
    ...
    @property
    def open_circuit_results(self: Self) -> "_1347.OpenCircuitElectricMachineResults":
    ...
    @property
    def all_on_load_results(self: Self) -> "List[_1346.OnLoadElectricMachineResults]":
    ...
    def all_open_circuit_results(
        self: Self,
    ) -> "List[_1347.OpenCircuitElectricMachineResults]":
    ...
    def on_load_results_for_slices(
        self: Self,
    ) -> "List[_1346.OnLoadElectricMachineResults]":
        """List[mastapy.electric_machines.results.OnLoadElectricMachineResults]
