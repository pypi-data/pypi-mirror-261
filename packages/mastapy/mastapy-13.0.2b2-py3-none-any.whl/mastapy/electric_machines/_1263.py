...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1344, _1345
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def cad_electric_machine_detail(
            ...
            return self._parent._cast(_1248.CADElectricMachineDetail)
        ...
        def non_cad_electric_machine_detail(
            ...
            return self._parent._cast(_1288.NonCADElectricMachineDetail)
    ...
    def core_loss_build_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1258", "CoreLossBuildFactorSpecificationMethod"
        )(value)

    @core_loss_build_factor_specification_method.setter
    @enforce_parameter_types
    def core_loss_build_factor_specification_method(
        self: Self, value: "_1258.CoreLossBuildFactorSpecificationMethod"
    ):
    ...
    @property
    def electric_machine_type(self: Self) -> "_1269.ElectricMachineType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1269", "ElectricMachineType"
        )(value)
    ...
    @select_setup.setter
    @enforce_parameter_types
    def select_setup(self: Self, value: "_1268.ElectricMachineSetup"):
        wrapper_type = (
    ...
    @property
    def non_linear_dq_model(self: Self) -> "_1344.NonLinearDQModel":
    ...
    @property
    def rotor(self: Self) -> "_1295.Rotor":
    ...
    @property
    def selected_setup(self: Self) -> "_1268.ElectricMachineSetup":
    ...
    @property
    def stator(self: Self) -> "_1244.AbstractStator":
    ...
    @property
    def results_locations(self: Self) -> "List[_1524.Named2DLocation]":
    ...
    @property
    def setups(self: Self) -> "List[_1268.ElectricMachineSetup]":
    ...
    def add_setup(self: Self) -> "_1268.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup"""
    ...
    @enforce_parameter_types
    def duplicate_setup(
        self: Self, setup: "_1268.ElectricMachineSetup"
    ...
    @enforce_parameter_types
    def remove_setup(self: Self, setup: "_1268.ElectricMachineSetup"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def setup_named(self: Self, name: "str") -> "_1268.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup
