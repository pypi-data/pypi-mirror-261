...
if TYPE_CHECKING:
    ...
    from mastapy.bolts import _1471, _1473, _1478
    ...
    from mastapy.gears.gear_designs import _941, _943, _946, _952
    from mastapy.gears.gear_designs.cylindrical import _1012, _1016, _1017, _1022, _1033
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def bolt_geometry_database(self: Self) -> "_1471.BoltGeometryDatabase":
    ...
    @property
    def bolt_material_database(self: Self) -> "_1473.BoltMaterialDatabase":
    ...
    @property
    def ring_pins_material_database(self: Self) -> "_1466.RingPinsMaterialDatabase":
    ...
    @property
    def magnet_material_database(self: Self) -> "_1286.MagnetMaterialDatabase":
    ...
    @property
    def winding_material_database(self: Self) -> "_1317.WindingMaterialDatabase":
    ...
    @property
    def cylindrical_gear_defaults(self: Self) -> "_1012.CylindricalGearDefaults":
