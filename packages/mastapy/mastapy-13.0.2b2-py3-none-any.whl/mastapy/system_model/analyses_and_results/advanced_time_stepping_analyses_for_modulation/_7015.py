...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6815, _6898
...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    def advanced_time_stepping_analysis_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6815",
    ...
    def advanced_time_stepping_analysis_method(
        self: Self, value: "_6815.AdvancedTimeSteppingAnalysisForModulationType"
    ):
    ...
    @property
    def time_options(self: Self) -> "_2686.TimeOptions":
