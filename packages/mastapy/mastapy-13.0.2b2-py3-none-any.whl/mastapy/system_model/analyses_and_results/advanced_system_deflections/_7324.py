...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1019, _1013
...
class CylindricalGearMeshAdvancedSystemDeflection(
    ...
    @property
    def gear_mesh_design(self: Self) -> "_1019.CylindricalGearMeshDesign":
    ...
    @property
    def points_with_worst_results(self: Self) -> "_1215.PointsWithWorstResults":
    ...
    @property
    def gear_designs(self: Self) -> "List[_1013.CylindricalGearDesign]":
