...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1151, _1161
...
class ConicalGearMeshAdvancedSystemDeflection(_7336.GearMeshAdvancedSystemDeflection):
    ...
    @property
    def active_flank(self: Self) -> "_1151.ActiveConicalFlank":
    ...
    @property
    def inactive_flank(self: Self) -> "_1151.ActiveConicalFlank":
        """mastapy.gears.gear_designs.conical.ActiveConicalFlank
