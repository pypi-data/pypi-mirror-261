...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self: Self) -> "_1491.Range":
    ...
    @enforce_parameter_types
    def filtering_frequency_range(self: Self, value: "_1491.Range"):
    ...
    @property
    def frequency_range(self: Self) -> "_1491.Range":
        """mastapy.math_utility.Range"""
    ...
    @enforce_parameter_types
    def frequency_range(self: Self, value: "_1491.Range"):
