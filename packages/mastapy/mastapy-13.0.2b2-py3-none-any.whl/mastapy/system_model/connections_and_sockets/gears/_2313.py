...
class FaceGearMesh(_2315.GearMesh):
    ...
    class _Cast_FaceGearMesh:
        ...
        @property
        def gear_mesh(self: "FaceGearMesh._Cast_FaceGearMesh") -> "_2315.GearMesh":
        ...
        @property
        def connection(self: "FaceGearMesh._Cast_FaceGearMesh") -> "_2274.Connection":
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_992.FaceGearMeshDesign":
    ...
    @property
    def face_gear_mesh_design(self: Self) -> "_992.FaceGearMeshDesign":
        """mastapy.gears.gear_designs.face.FaceGearMeshDesign
