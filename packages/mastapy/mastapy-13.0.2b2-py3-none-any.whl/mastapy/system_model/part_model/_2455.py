...
class FEPart(_2438.AbstractShaftOrHousing):
    ...
    class _Cast_FEPart:
        ...
        @property
        def component(self: "FEPart._Cast_FEPart") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "FEPart._Cast_FEPart") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "FEPart._Cast_FEPart") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
