...
class CycloidalAssembly(_2478.SpecialisedAssembly):
    ...
    class _Cast_CycloidalAssembly:
        ...
        @property
        def part(self: "CycloidalAssembly._Cast_CycloidalAssembly") -> "_2470.Part":
    ...
    @property
    def cycloidal_assembly_design(self: Self) -> "_1455.CycloidalAssemblyDesign":
    ...
    @property
    def known_designs(self: Self) -> "List[_1455.CycloidalAssemblyDesign]":
    ...
    def design_named(self: Self, name: "str") -> "_1455.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: Self, cycloidal_assembly_design: "_1455.CycloidalAssemblyDesign"
    ):
        """Method does not return.
    ...
    def try_remove_design(
        self: Self, design: "_1455.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool
