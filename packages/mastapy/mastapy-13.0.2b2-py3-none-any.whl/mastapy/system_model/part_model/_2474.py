...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2451, _2483, _2466, _2446, _2470
...
class PowerLoad(_2481.VirtualComponent):
    ...
    class _Cast_PowerLoad:
        ...
        @property
        def component(self: "PowerLoad._Cast_PowerLoad") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "PowerLoad._Cast_PowerLoad") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "PowerLoad._Cast_PowerLoad") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: Self, value: "_1263.ElectricMachineDetail"
    ):
        wrapper_type = (
