...
class WormGearSet(_2534.GearSet):
    ...
    class _Cast_WormGearSet:
        ...
        @property
        def gear_set(self: "WormGearSet._Cast_WormGearSet") -> "_2534.GearSet":
        ...
        @property
        def part(self: "WormGearSet._Cast_WormGearSet") -> "_2470.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_960.WormGearSetDesign":
    ...
    @property
    def worm_gear_set_design(self: Self) -> "_960.WormGearSetDesign":
        """mastapy.gears.gear_designs.worm.WormGearSetDesign
