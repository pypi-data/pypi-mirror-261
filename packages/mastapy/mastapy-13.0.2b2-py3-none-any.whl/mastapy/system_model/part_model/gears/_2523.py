...
class ConceptGear(_2532.Gear):
    ...
    class _Cast_ConceptGear:
        ...
        @property
        def gear(self: "ConceptGear._Cast_ConceptGear") -> "_2532.Gear":
        ...
        @property
        def component(self: "ConceptGear._Cast_ConceptGear") -> "_2446.Component":
            from mastapy.system_model.part_model import _2446

            return self._parent._cast(_2446.Component)

        @property
        def part(self: "ConceptGear._Cast_ConceptGear") -> "_2470.Part":
    ...
    @property
    def active_gear_design(self: Self) -> "_1177.ConceptGearDesign":
    ...
    @property
    def concept_gear_design(self: Self) -> "_1177.ConceptGearDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearDesign
