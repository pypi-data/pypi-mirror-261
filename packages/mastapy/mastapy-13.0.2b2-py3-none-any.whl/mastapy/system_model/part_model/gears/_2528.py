...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2527, _2544
...
class CylindricalGearSet(_2534.GearSet):
    ...
    class _Cast_CylindricalGearSet:
        ...
        @property
        def part(self: "CylindricalGearSet._Cast_CylindricalGearSet") -> "_2470.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_1029.CylindricalGearSetDesign":
    ...
    @property
    def gear_set_designs(self: Self) -> "List[_1029.CylindricalGearSetDesign]":
