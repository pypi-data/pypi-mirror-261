...
class ConceptGearSet(_2534.GearSet):
    ...
    class _Cast_ConceptGearSet:
        ...
        @property
        def gear_set(self: "ConceptGearSet._Cast_ConceptGearSet") -> "_2534.GearSet":
        ...
        @property
        def part(self: "ConceptGearSet._Cast_ConceptGearSet") -> "_2470.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_1179.ConceptGearSetDesign":
    ...
    @property
    def concept_gear_set_design(self: Self) -> "_1179.ConceptGearSetDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearSetDesign
