...
class CVT(_2578.BeltDrive):
    ...
    class _Cast_CVT:
        ...
        @property
        def belt_drive(self: "CVT._Cast_CVT") -> "_2578.BeltDrive":
            return self._parent._cast(_2578.BeltDrive)

        @property
        def specialised_assembly(self: "CVT._Cast_CVT") -> "_2478.SpecialisedAssembly":
            from mastapy.system_model.part_model import _2478

            return self._parent._cast(_2478.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "CVT._Cast_CVT") -> "_2436.AbstractAssembly":
            from mastapy.system_model.part_model import _2436

            return self._parent._cast(_2436.AbstractAssembly)

        @property
        def part(self: "CVT._Cast_CVT") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "CVT._Cast_CVT") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
