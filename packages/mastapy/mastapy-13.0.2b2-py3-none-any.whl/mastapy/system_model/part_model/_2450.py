...
class Datum(_2446.Component):
    ...
    class _Cast_Datum:
        ...
        @property
        def component(self: "Datum._Cast_Datum") -> "_2446.Component":
            return self._parent._cast(_2446.Component)

        @property
        def part(self: "Datum._Cast_Datum") -> "_2470.Part":
            from mastapy.system_model.part_model import _2470

            return self._parent._cast(_2470.Part)

        @property
        def design_entity(self: "Datum._Cast_Datum") -> "_2205.DesignEntity":
            from mastapy.system_model import _2205
