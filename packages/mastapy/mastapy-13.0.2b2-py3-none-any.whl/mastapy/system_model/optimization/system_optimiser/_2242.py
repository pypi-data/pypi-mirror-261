...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.load_case_groups import _5672, _5671
...
class SystemOptimiserDetails(_0.APIBase):
    ...
    def criteria_for_selecting_configurations_to_keep(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.load_case_groups._5672",
    ...
    @enforce_parameter_types
    def criteria_for_selecting_configurations_to_keep(
        self: Self, value: "_5672.SystemOptimiserTargets"
    ):
    ...
    @property
    def gear_set_optimisation(self: Self) -> "_5671.SystemOptimiserGearSetOptimisation":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.load_case_groups._5671",
    ...
    def gear_set_optimisation(
        self: Self, value: "_5671.SystemOptimiserGearSetOptimisation"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.LoadCaseGroups.SystemOptimiserGearSetOptimisation",
    ...
    @property
    def planet_gear_options(self: Self) -> "List[_2240.PlanetGearOptions]":
