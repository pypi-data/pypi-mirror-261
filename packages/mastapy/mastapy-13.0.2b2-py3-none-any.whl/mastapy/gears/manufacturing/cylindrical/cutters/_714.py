...
class CylindricalGearShaper(_718.InvoluteCutterDesign):
    ...
    @property
    def shaper_edge_type(self: Self) -> "_1075.ShaperEdgeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1075", "ShaperEdgeTypes"
        )(value)

    @shaper_edge_type.setter
    @enforce_parameter_types
    def shaper_edge_type(self: Self, value: "_1075.ShaperEdgeTypes"):
