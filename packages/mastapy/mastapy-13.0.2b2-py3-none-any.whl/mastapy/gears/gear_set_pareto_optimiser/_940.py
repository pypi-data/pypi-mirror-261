...
class StraightBevelGearSetParetoOptimiser(_912.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_964.StraightBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_964.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_964.StraightBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]
