...
class SpiralBevelGearSetParetoOptimiser(_912.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_972.SpiralBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_972.SpiralBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_972.SpiralBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearSetDesign]
