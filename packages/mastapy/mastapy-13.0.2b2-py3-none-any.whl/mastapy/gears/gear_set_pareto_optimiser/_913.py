...
class HypoidGearSetParetoOptimiser(_912.GearSetParetoOptimiser):
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_988.HypoidGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_988.HypoidGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_988.HypoidGearSetDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearSetDesign]
