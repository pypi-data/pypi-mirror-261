...
if TYPE_CHECKING:
    ...
    from mastapy.gears.cylindrical import _1212, _1211, _1210, _1209
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self: Self) -> "List[_1210.CylindricalGearLTCAContactCharts]":
    ...
    def contact_charts_as_text_files(
        self: Self,
    ) -> "List[_1209.CylindricalGearLTCAContactChartDataAsTextFile]":
