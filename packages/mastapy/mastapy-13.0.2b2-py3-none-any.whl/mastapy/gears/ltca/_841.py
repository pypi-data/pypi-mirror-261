...
class GearMeshLoadDistributionAnalysis(_1224.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self: Self) -> "_1515.FourierSeries":
    ...
    @property
    def transmission_error_fourier_series(self: Self) -> "_1515.FourierSeries":
        """mastapy.math_utility.FourierSeries
