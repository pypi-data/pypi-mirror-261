...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1152, _1157
    from mastapy.math_utility import _1521
    from mastapy.gears.gear_designs.bevel import _1192, _1190
...
class BevelGearSetDesign(_1196.AGMAGleasonConicalGearSetDesign):
    """BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self: Self) -> "_1152.BacklashDistributionRule":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1152", "BacklashDistributionRule"
        )(value)

    @backlash_distribution_rule.setter
    @enforce_parameter_types
    def backlash_distribution_rule(self: Self, value: "_1152.BacklashDistributionRule"):
    ...
    @property
    def backlash_used_for_tooth_thickness_calculation(self: Self) -> "_1521.MaxMinMean":
        ...
        return constructor.new_from_mastapy("mastapy.math_utility._1521", "MaxMinMean")(
            value
        )
    ...
    def backlash_used_for_tooth_thickness_calculation(
        self: Self, value: "_1521.MaxMinMean"
    ):
    ...
    @enforce_parameter_types
    def round_cutter_specifications(
        self: Self, value: "_1192.WheelFinishCutterPointWidthRestrictionMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Bevel.WheelFinishCutterPointWidthRestrictionMethod",
    ...
    def tooth_proportions_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1190", "ToothProportionsInputMethod"
        )(value)

    @tooth_proportions_input_method.setter
    @enforce_parameter_types
    def tooth_proportions_input_method(
        self: Self, value: "_1190.ToothProportionsInputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def tooth_thickness_specification_method(
        self: Self, value: "_1191.ToothThicknessSpecificationMethod"
    ):
