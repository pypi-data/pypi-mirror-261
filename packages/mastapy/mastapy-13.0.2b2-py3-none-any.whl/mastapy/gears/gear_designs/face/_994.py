...
class FaceGearMicroGeometry(_1222.GearImplementationDetail):
    """FaceGearMicroGeometry
    ...
    @property
    def face_gear(self: Self) -> "_990.FaceGearDesign":
    ...
    @property
    def micro_geometry(self: Self) -> "_1102.CylindricalGearMicroGeometryBase":
