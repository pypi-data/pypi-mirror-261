...
class CylindricalGearDesign(_948.GearDesign):
    """CylindricalGearDesign
    ...
    @property
    def agma_accuracy_grade(self: Self) -> "_1135.AGMA20151AccuracyGrades":
    ...
    @property
    def case_hardening_properties(self: Self) -> "_1002.CaseHardeningProperties":
    ...
    @property
    def finish_stock_specification(self: Self) -> "_1090.FinishStockSpecification":
    ...
    @property
    def iso6336_geometry(self: Self) -> "_1056.ISO6336GeometryBase":
    ...
    @property
    def iso_accuracy_grade(self: Self) -> "_1145.ISO1328AccuracyGrades":
    ...
    @property
    def left_flank(self: Self) -> "_1018.CylindricalGearFlankDesign":
    ...
    @property
    def right_flank(self: Self) -> "_1018.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    @property
    def system_of_gear_fits(self: Self) -> "_1141.DIN3967SystemOfGearFits":
    ...
    @property
    def tiff_analysis_settings(self: Self) -> "_1081.TiffAnalysisSettings":
    ...
    @property
    def flanks(self: Self) -> "List[_1018.CylindricalGearFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1018.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1102.CylindricalGearMicroGeometryBase]":
