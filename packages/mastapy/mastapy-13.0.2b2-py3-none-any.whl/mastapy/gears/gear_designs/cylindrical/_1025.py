...
class CylindricalGearPinionTypeCutterFlank(_1008.CylindricalGearAbstractRackFlank):
    """CylindricalGearPinionTypeCutterFlank
    ...
    class _Cast_CylindricalGearPinionTypeCutterFlank:
        ...
        def cylindrical_gear_abstract_rack_flank(
            ...
            return self._parent._cast(_1008.CylindricalGearAbstractRackFlank)
    ...
    @property
    def cutter(self: Self) -> "_1024.CylindricalGearPinionTypeCutter":
