...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1013, _1008, _1009, _1024, _1077
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRack:
        ...
        def cylindrical_gear_basic_rack(
            ...
            return self._parent._cast(_1009.CylindricalGearBasicRack)
        ...
        def cylindrical_gear_pinion_type_cutter(
            ...
            return self._parent._cast(_1024.CylindricalGearPinionTypeCutter)
        ...
        def standard_rack(
            ...
            return self._parent._cast(_1077.StandardRack)
    ...
    @property
    def gear(self: Self) -> "_1013.CylindricalGearDesign":
    ...
    @property
    def left_flank(self: Self) -> "_1008.CylindricalGearAbstractRackFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1008.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    @property
    def flanks(self: Self) -> "List[_1008.CylindricalGearAbstractRackFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1008.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
