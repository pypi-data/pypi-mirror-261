...
class CylindricalGearMeshDesign(_950.GearMeshDesign):
    """CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self: Self) -> "_1028.CylindricalGearProfileModifications":
    ...
    def profile_modification(
        self: Self, value: "_1028.CylindricalGearProfileModifications"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileModifications",
    ...
    @property
    def type_of_mechanism_housing(self: Self) -> "_1088.TypeOfMechanismHousing":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1088", "TypeOfMechanismHousing"
        )(value)

    @type_of_mechanism_housing.setter
    @enforce_parameter_types
    def type_of_mechanism_housing(self: Self, value: "_1088.TypeOfMechanismHousing"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def valid_normal_module_range(self: Self) -> "_1491.Range":
    ...
    @property
    def backlash_specification(self: Self) -> "_1000.BacklashSpecification":
    ...
    @property
    def cylindrical_gear_set(self: Self) -> "_1029.CylindricalGearSetDesign":
    ...
    @property
    def left_flank(self: Self) -> "_1020.CylindricalGearMeshFlankDesign":
    ...
    @property
    def right_flank(self: Self) -> "_1020.CylindricalGearMeshFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def cylindrical_meshed_gear(self: Self) -> "List[_1039.CylindricalMeshedGear]":
    ...
    @property
    def flanks(self: Self) -> "List[_1020.CylindricalGearMeshFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1020.CylindricalGearMeshFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def gear_a(self: Self) -> "_1013.CylindricalGearDesign":
    ...
    @property
    def gear_b(self: Self) -> "_1013.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign
