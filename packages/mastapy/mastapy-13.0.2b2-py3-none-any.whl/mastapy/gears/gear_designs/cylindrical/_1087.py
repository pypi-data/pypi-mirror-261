...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1037, _1047, _1067, _1086
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    class _Cast_ToothThicknessSpecificationBase:
        ...
        def finish_tooth_thickness_design_specification(
            ...
            return self._parent._cast(_1047.FinishToothThicknessDesignSpecification)
        ...
        def readonly_tooth_thickness_specification(
            ...
            return self._parent._cast(_1067.ReadonlyToothThicknessSpecification)
        ...
        def tooth_thickness_specification(
            ...
            return self._parent._cast(_1086.ToothThicknessSpecification)
    ...
    def chordal_span(
        self: Self,
    ) -> "_1037.CylindricalGearToothThicknessSpecification[_1669.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: Self,
    ) -> "_1037.CylindricalGearToothThicknessSpecification[_1690.Number]":
    ...
    def tooth_thickness(
        self: Self,
    ) -> "List[_1037.CylindricalGearToothThicknessSpecification[_1669.LengthShort]]":
