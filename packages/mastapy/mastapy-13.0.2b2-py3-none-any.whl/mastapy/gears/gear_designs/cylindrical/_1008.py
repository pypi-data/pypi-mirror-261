...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1007, _1013, _1010, _1025, _1078
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRackFlank:
        ...
        def cylindrical_gear_basic_rack_flank(
            ...
            return self._parent._cast(_1010.CylindricalGearBasicRackFlank)
        ...
        def cylindrical_gear_pinion_type_cutter_flank(
            ...
            return self._parent._cast(_1025.CylindricalGearPinionTypeCutterFlank)
        ...
        def standard_rack_flank(
            ...
            return self._parent._cast(_1078.StandardRackFlank)
    ...
    @property
    def cutter(self: Self) -> "_1007.CylindricalGearAbstractRack":
