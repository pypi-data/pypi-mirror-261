...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1005, _1006
...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    class _Cast_CrossedAxisCylindricalGearPair:
        ...
        def crossed_axis_cylindrical_gear_pair_line_contact(
            ...
            return self._parent._cast(_1005.CrossedAxisCylindricalGearPairLineContact)
        ...
        def crossed_axis_cylindrical_gear_pair_point_contact(
            ...
            return self._parent._cast(_1006.CrossedAxisCylindricalGearPairPointContact)
