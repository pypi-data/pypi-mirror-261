...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1026, _1013
...
class CylindricalGearFlankMicroGeometry(_570.FlankMicroGeometry):
    ...
    @property
    def bias(self: Self) -> "_1094.CylindricalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1097.CylindricalGearLeadModification":
    ...
    @property
    def micro_geometry_map(self: Self) -> "_1104.CylindricalGearMicroGeometryMap":
    ...
    @property
    def profile_control_point(self: Self) -> "_1026.CylindricalGearProfileMeasurement":
    ...
    @property
    def profile_relief(self: Self) -> "_1106.CylindricalGearProfileModification":
    ...
    def lead_form_deviation_points(
        self: Self,
    ) -> "List[_1115.LeadFormReliefWithDeviation]":
    ...
    def lead_slope_deviation_points(
        self: Self,
    ) -> "List[_1117.LeadSlopeReliefWithDeviation]":
    ...
    def profile_form_deviation_points(
        self: Self,
    ) -> "List[_1126.ProfileFormReliefWithDeviation]":
    ...
    def profile_slope_deviation_at_10_percent_face_width(
        self: Self,
    ) -> "List[_1128.ProfileSlopeReliefWithDeviation]":
    ...
    def total_lead_relief_points(
        self: Self,
    ) -> "List[_1131.TotalLeadReliefWithDeviation]":
    ...
    def total_profile_relief_points(
        self: Self,
    ) -> "List[_1132.TotalProfileReliefWithDeviation]":
    ...
    @property
    def gear_design(self: Self) -> "_1013.CylindricalGearDesign":
