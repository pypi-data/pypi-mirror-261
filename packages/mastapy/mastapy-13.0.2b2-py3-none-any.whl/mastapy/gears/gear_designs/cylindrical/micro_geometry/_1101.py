...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1096, _1122
...
class CylindricalGearMicroGeometry(_1102.CylindricalGearMicroGeometryBase):
    """CylindricalGearMicroGeometry
    ...
    @property
    def left_flank(self: Self) -> "_1096.CylindricalGearFlankMicroGeometry":
    ...
    @property
    def right_flank(self: Self) -> "_1096.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
    ...
    @property
    def flanks(self: Self) -> "List[_1096.CylindricalGearFlankMicroGeometry]":
    ...
    @property
    def meshed_gears(self: Self) -> "List[_1122.MeshedCylindricalGearMicroGeometry]":
    ...
    @property
    def both_flanks(self: Self) -> "_1096.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
