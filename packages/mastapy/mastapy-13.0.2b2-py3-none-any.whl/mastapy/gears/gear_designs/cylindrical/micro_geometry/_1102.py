...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1013, _1026
...
class CylindricalGearMicroGeometryBase(_1222.GearImplementationDetail):
    """CylindricalGearMicroGeometryBase
    ...
    @property
    def cylindrical_gear(self: Self) -> "_1013.CylindricalGearDesign":
    ...
    def common_micro_geometries_of_flanks(
        self: Self,
    ) -> "List[_1095.CylindricalGearCommonFlankMicroGeometry]":
    ...
    def tooth_micro_geometries(
        self: Self,
    ) -> "List[_1110.CylindricalGearToothMicroGeometry]":
