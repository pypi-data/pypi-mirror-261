...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1027, _1019
...
class CylindricalGearMeshMicroGeometry(_1226.GearMeshImplementationDetail):
    """CylindricalGearMeshMicroGeometry
    ...
    @property
    def cylindrical_mesh(self: Self) -> "_1019.CylindricalGearMeshDesign":
    ...
    def cylindrical_gear_micro_geometries_specified_per_tooth(
        self: Self,
    ) -> "List[_1105.CylindricalGearMicroGeometryPerTooth]":
    ...
    @property
    def gear_a(self: Self) -> "_1102.CylindricalGearMicroGeometryBase":
    ...
    @property
    def gear_b(self: Self) -> "_1102.CylindricalGearMicroGeometryBase":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMicroGeometryBase
