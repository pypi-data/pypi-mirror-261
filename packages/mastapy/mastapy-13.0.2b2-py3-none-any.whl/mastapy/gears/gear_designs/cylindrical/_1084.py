...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1038, _1041
...
class TolerancedValueSpecification(_1068.RelativeMeasurementViewModel[T]):
    """TolerancedValueSpecification
    ...
    class _Cast_TolerancedValueSpecification:
        ...
        def relative_measurement_view_model(
            ...
            return self._parent._cast(_1068.RelativeMeasurementViewModel)
        ...
        def cylindrical_mesh_angular_backlash(
            ...
            return self._parent._cast(_1038.CylindricalMeshAngularBacklash)
        ...
        def cylindrical_mesh_linear_backlash_specification(
            ...
            return self._parent._cast(_1041.CylindricalMeshLinearBacklashSpecification)
        ...
        def nominal_value_specification(
            ...
            return self._parent._cast(_1092.NominalValueSpecification)
        ...
        def no_value_specification(
            ...
            return self._parent._cast(_1093.NoValueSpecification)
