...
class CylindricalGearPinionTypeCutter(_1007.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self: Self) -> "_1025.CylindricalGearPinionTypeCutterFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1025.CylindricalGearPinionTypeCutterFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearPinionTypeCutterFlank
