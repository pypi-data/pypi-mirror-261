...
class AGMAGleasonConicalGearSetDesign(_1157.ConicalGearSetDesign):
    """AGMAGleasonConicalGearSetDesign
    ...
    def design_method(self: Self, value: "_1180.AGMAGleasonConicalGearGeometryMethods"):
    ...
    def reliability_requirement_gleason(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1166", "GleasonSafetyRequirements"
        )(value)

    @reliability_requirement_gleason.setter
    @enforce_parameter_types
    def reliability_requirement_gleason(
        self: Self, value: "_1166.GleasonSafetyRequirements"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def conical_meshes(self: Self) -> "List[_1195.AGMAGleasonConicalGearMeshDesign]":
    ...
    @property
    def meshes(self: Self) -> "List[_1195.AGMAGleasonConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.agma_gleason_conical.AGMAGleasonConicalGearMeshDesign]
