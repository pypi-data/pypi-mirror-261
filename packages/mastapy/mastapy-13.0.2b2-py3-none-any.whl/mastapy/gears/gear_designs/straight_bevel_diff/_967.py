...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel_diff import _968, _966, _969
...
class StraightBevelDiffGearMeshDesign(_1182.BevelGearMeshDesign):
    """StraightBevelDiffGearMeshDesign
    ...
    def straight_bevel_diff_meshed_gears(
        self: Self,
    ) -> "List[_969.StraightBevelDiffMeshedGearDesign]":
