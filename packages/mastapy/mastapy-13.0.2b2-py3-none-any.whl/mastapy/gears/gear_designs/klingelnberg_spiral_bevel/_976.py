...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _974, _975
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(
    ...
    @property
    def gears(self: Self) -> "List[_974.KlingelnbergCycloPalloidSpiralBevelGearDesign]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(
        self: Self,
    ) -> "List[_974.KlingelnbergCycloPalloidSpiralBevelGearDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_spiral_bevel.KlingelnbergCycloPalloidSpiralBevelGearDesign]
    ...
    def klingelnberg_conical_meshes(
        self: Self,
    ) -> "List[_975.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]":
