...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.concept import _1177, _1178
...
class ConceptGearSetDesign(_951.GearSetDesign):
    """ConceptGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_1177.ConceptGearDesign]":
    ...
    @property
    def concept_gears(self: Self) -> "List[_1177.ConceptGearDesign]":
        """List[mastapy.gears.gear_designs.concept.ConceptGearDesign]
    ...
    @property
    def concept_meshes(self: Self) -> "List[_1178.ConceptGearMeshDesign]":
