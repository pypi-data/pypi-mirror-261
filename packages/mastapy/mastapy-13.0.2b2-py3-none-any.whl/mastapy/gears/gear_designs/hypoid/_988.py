...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _986, _987
...
class HypoidGearSetDesign(_1196.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_986.HypoidGearDesign]":
    ...
    @property
    def meshes(self: Self) -> "List[_987.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: Self) -> "List[_987.HypoidGearMeshDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign]
