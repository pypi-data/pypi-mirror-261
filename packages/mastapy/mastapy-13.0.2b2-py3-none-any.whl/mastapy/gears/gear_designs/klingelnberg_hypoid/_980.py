...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.klingelnberg_hypoid import _978, _979
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(
    ...
    @property
    def gears(self: Self) -> "List[_978.KlingelnbergCycloPalloidHypoidGearDesign]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears(
        self: Self,
    ) -> "List[_978.KlingelnbergCycloPalloidHypoidGearDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_hypoid.KlingelnbergCycloPalloidHypoidGearDesign]
    ...
    def klingelnberg_conical_meshes(
        self: Self,
    ) -> "List[_979.KlingelnbergCycloPalloidHypoidGearMeshDesign]":
