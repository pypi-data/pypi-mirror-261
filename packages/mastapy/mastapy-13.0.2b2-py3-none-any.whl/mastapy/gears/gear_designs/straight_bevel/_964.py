...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel import _962, _963
...
class StraightBevelGearSetDesign(_1183.BevelGearSetDesign):
    """StraightBevelGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_962.StraightBevelGearDesign]":
    ...
    @property
    def straight_bevel_meshes(self: Self) -> "List[_963.StraightBevelGearMeshDesign]":
