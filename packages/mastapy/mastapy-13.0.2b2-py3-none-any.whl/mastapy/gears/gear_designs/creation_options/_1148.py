...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.creation_options import _1147, _1149, _1150
...
T = TypeVar("T", bound="_951.GearSetDesign")
...
class GearSetCreationOptions(_0.APIBase, Generic[T]):
    ...
    class _Cast_GearSetCreationOptions:
        ...
        def cylindrical_gear_pair_creation_options(
            ...
            return self._parent._cast(_1147.CylindricalGearPairCreationOptions)
        ...
        def hypoid_gear_set_creation_options(
            ...
            return self._parent._cast(_1149.HypoidGearSetCreationOptions)

        @property
        def spiral_bevel_gear_set_creation_options(
            self: "GearSetCreationOptions._Cast_GearSetCreationOptions",
        ) -> "_1150.SpiralBevelGearSetCreationOptions":
            from mastapy.gears.gear_designs.creation_options import _1150

            return self._parent._cast(_1150.SpiralBevelGearSetCreationOptions)
