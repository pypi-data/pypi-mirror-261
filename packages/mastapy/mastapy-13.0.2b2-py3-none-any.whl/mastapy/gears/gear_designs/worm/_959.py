...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.worm import _961, _957, _960, _958
...
class WormGearMeshDesign(_950.GearMeshDesign):
    """WormGearMeshDesign
    ...
    @property
    def wheel(self: Self) -> "_961.WormWheelDesign":
    ...
    @property
    def worm(self: Self) -> "_957.WormDesign":
    ...
    @property
    def worm_gear_set(self: Self) -> "_960.WormGearSetDesign":
    ...
    @property
    def worm_gears(self: Self) -> "List[_958.WormGearDesign]":
