...
if TYPE_CHECKING:
    from mastapy.utility.report import _1746, _1789
...
class CustomRow(_1775.CustomReportPropertyItem):
    ...
    class _Cast_CustomRow:
        ...
        @property
        def blank_row(self: "CustomRow._Cast_CustomRow") -> "_1746.BlankRow":
            from mastapy.utility.report import _1746

            return self._parent._cast(_1746.BlankRow)

        @property
        def user_text_row(self: "CustomRow._Cast_CustomRow") -> "_1789.UserTextRow":
