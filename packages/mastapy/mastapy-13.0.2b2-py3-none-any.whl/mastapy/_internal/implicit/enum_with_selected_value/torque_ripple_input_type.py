...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6979.TorqueRippleInputType":
        ...
        return _6979.TorqueRippleInputType

    @classmethod
    def implicit_type(cls) -> "_6979.TorqueRippleInputType.type_()":
        ...
        return _6979.TorqueRippleInputType.type_()

    @property
    def selected_value(self: Self) -> "_6979.TorqueRippleInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_6979.TorqueRippleInputType]":
