...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1420.SplineToleranceClassTypes":
        ...
        return _1420.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1420.SplineToleranceClassTypes.type_()":
        ...
        return _1420.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1420.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1420.SplineToleranceClassTypes]":
