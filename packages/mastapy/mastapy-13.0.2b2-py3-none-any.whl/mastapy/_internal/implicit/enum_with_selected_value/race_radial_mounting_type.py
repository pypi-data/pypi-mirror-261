...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1966.RaceRadialMountingType":
        ...
        return _1966.RaceRadialMountingType

    @classmethod
    def implicit_type(cls) -> "_1966.RaceRadialMountingType.type_()":
        ...
        return _1966.RaceRadialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1966.RaceRadialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1966.RaceRadialMountingType]":
