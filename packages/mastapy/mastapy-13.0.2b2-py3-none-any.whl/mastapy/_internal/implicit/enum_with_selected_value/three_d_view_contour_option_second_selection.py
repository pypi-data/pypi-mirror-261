...
from mastapy.utility.enums import _1825
...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1825.ThreeDViewContourOptionSecondSelection":
        ...
        return _1825.ThreeDViewContourOptionSecondSelection

    @classmethod
    def implicit_type(cls) -> "_1825.ThreeDViewContourOptionSecondSelection.type_()":
        ...
        return _1825.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: Self) -> "_1825.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1825.ThreeDViewContourOptionSecondSelection]":
