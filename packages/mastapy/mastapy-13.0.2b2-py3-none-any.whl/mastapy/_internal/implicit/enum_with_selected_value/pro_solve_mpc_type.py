...
class EnumWithSelectedValue_ProSolveMpcType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1240.ProSolveMpcType":
        ...
        return _1240.ProSolveMpcType

    @classmethod
    def implicit_type(cls) -> "_1240.ProSolveMpcType.type_()":
        ...
        return _1240.ProSolveMpcType.type_()

    @property
    def selected_value(self: Self) -> "_1240.ProSolveMpcType":
    ...
    @property
    def available_values(self: Self) -> "List[_1240.ProSolveMpcType]":
