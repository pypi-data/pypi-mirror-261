...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1051.GeometrySpecificationType":
        ...
        return _1051.GeometrySpecificationType

    @classmethod
    def implicit_type(cls) -> "_1051.GeometrySpecificationType.type_()":
        ...
        return _1051.GeometrySpecificationType.type_()

    @property
    def selected_value(self: Self) -> "_1051.GeometrySpecificationType":
    ...
    @property
    def available_values(self: Self) -> "List[_1051.GeometrySpecificationType]":
