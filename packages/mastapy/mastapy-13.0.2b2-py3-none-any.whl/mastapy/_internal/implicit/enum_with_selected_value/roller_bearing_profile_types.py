...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1893.RollerBearingProfileTypes":
        ...
        return _1893.RollerBearingProfileTypes

    @classmethod
    def implicit_type(cls) -> "_1893.RollerBearingProfileTypes.type_()":
        ...
        return _1893.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: Self) -> "_1893.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1893.RollerBearingProfileTypes]":
