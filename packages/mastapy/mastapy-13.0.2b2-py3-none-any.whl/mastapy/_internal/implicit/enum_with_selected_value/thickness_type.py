...
class EnumWithSelectedValue_ThicknessType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1080.ThicknessType":
        ...
        return _1080.ThicknessType

    @classmethod
    def implicit_type(cls) -> "_1080.ThicknessType.type_()":
        ...
        return _1080.ThicknessType.type_()

    @property
    def selected_value(self: Self) -> "_1080.ThicknessType":
    ...
    @property
    def available_values(self: Self) -> "List[_1080.ThicknessType]":
