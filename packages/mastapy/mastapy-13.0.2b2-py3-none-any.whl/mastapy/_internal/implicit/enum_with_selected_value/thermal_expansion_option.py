...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2413.ThermalExpansionOption":
        ...
        return _2413.ThermalExpansionOption

    @classmethod
    def implicit_type(cls) -> "_2413.ThermalExpansionOption.type_()":
        ...
        return _2413.ThermalExpansionOption.type_()

    @property
    def selected_value(self: Self) -> "_2413.ThermalExpansionOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2413.ThermalExpansionOption]":
