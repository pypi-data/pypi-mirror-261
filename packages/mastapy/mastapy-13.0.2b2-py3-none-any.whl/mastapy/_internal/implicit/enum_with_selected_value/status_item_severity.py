...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1797.StatusItemSeverity":
        ...
        return _1797.StatusItemSeverity

    @classmethod
    def implicit_type(cls) -> "_1797.StatusItemSeverity.type_()":
        ...
        return _1797.StatusItemSeverity.type_()

    @property
    def selected_value(self: Self) -> "_1797.StatusItemSeverity":
    ...
    @property
    def available_values(self: Self) -> "List[_1797.StatusItemSeverity]":
