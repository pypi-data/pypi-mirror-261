...
class EnumWithSelectedValue_RotationalDirections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1899.RotationalDirections":
        ...
        return _1899.RotationalDirections

    @classmethod
    def implicit_type(cls) -> "_1899.RotationalDirections.type_()":
        ...
        return _1899.RotationalDirections.type_()

    @property
    def selected_value(self: Self) -> "_1899.RotationalDirections":
    ...
    @property
    def available_values(self: Self) -> "List[_1899.RotationalDirections]":
