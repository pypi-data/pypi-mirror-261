...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6900.HarmonicExcitationType":
        ...
        return _6900.HarmonicExcitationType

    @classmethod
    def implicit_type(cls) -> "_6900.HarmonicExcitationType.type_()":
        ...
        return _6900.HarmonicExcitationType.type_()

    @property
    def selected_value(self: Self) -> "_6900.HarmonicExcitationType":
    ...
    @property
    def available_values(self: Self) -> "List[_6900.HarmonicExcitationType]":
