...
class EnumWithSelectedValue_BearingModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1879.BearingModel":
        ...
        return _1879.BearingModel

    @classmethod
    def implicit_type(cls) -> "_1879.BearingModel.type_()":
        ...
        return _1879.BearingModel.type_()

    @property
    def selected_value(self: Self) -> "_1879.BearingModel":
    ...
    @property
    def available_values(self: Self) -> "List[_1879.BearingModel]":
