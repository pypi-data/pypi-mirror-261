...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1396.DudleyEffectiveLengthApproximationOption":
        ...
        return _1396.DudleyEffectiveLengthApproximationOption

    @classmethod
    def implicit_type(cls) -> "_1396.DudleyEffectiveLengthApproximationOption.type_()":
        ...
        return _1396.DudleyEffectiveLengthApproximationOption.type_()

    @property
    def selected_value(self: Self) -> "_1396.DudleyEffectiveLengthApproximationOption":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1396.DudleyEffectiveLengthApproximationOption]":
