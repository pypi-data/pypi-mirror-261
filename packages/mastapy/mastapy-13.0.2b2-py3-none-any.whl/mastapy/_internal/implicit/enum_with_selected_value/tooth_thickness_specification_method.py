...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1191.ToothThicknessSpecificationMethod":
        ...
        return _1191.ToothThicknessSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_1191.ToothThicknessSpecificationMethod.type_()":
        ...
        return _1191.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1191.ToothThicknessSpecificationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1191.ToothThicknessSpecificationMethod]":
