...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1419.SplineRatingTypes":
        ...
        return _1419.SplineRatingTypes

    @classmethod
    def implicit_type(cls) -> "_1419.SplineRatingTypes.type_()":
        ...
        return _1419.SplineRatingTypes.type_()

    @property
    def selected_value(self: Self) -> "_1419.SplineRatingTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1419.SplineRatingTypes]":
