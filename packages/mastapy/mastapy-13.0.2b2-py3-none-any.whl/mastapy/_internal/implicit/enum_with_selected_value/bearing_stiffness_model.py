...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5388.BearingStiffnessModel":
        ...
        return _5388.BearingStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5388.BearingStiffnessModel.type_()":
        ...
        return _5388.BearingStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5388.BearingStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5388.BearingStiffnessModel]":
