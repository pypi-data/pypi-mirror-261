...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1965.RaceAxialMountingType":
        ...
        return _1965.RaceAxialMountingType

    @classmethod
    def implicit_type(cls) -> "_1965.RaceAxialMountingType.type_()":
        ...
        return _1965.RaceAxialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1965.RaceAxialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1965.RaceAxialMountingType]":
