...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1072.ScuffingCoefficientOfFrictionMethods":
        ...
        return _1072.ScuffingCoefficientOfFrictionMethods

    @classmethod
    def implicit_type(cls) -> "_1072.ScuffingCoefficientOfFrictionMethods.type_()":
        ...
        return _1072.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: Self) -> "_1072.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1072.ScuffingCoefficientOfFrictionMethods]":
