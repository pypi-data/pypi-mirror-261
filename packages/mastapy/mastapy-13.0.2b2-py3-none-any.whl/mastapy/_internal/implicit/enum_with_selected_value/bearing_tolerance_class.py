...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1905.BearingToleranceClass":
        ...
        return _1905.BearingToleranceClass

    @classmethod
    def implicit_type(cls) -> "_1905.BearingToleranceClass.type_()":
        ...
        return _1905.BearingToleranceClass.type_()

    @property
    def selected_value(self: Self) -> "_1905.BearingToleranceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1905.BearingToleranceClass]":
