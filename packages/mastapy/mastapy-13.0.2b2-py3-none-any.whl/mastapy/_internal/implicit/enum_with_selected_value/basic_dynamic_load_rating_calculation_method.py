...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1872.BasicDynamicLoadRatingCalculationMethod":
        ...
        return _1872.BasicDynamicLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1872.BasicDynamicLoadRatingCalculationMethod.type_()":
        ...
        return _1872.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1872.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1872.BasicDynamicLoadRatingCalculationMethod]":
