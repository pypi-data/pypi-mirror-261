...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2365.BearingNodeOption":
        ...
        return _2365.BearingNodeOption

    @classmethod
    def implicit_type(cls) -> "_2365.BearingNodeOption.type_()":
        ...
        return _2365.BearingNodeOption.type_()

    @property
    def selected_value(self: Self) -> "_2365.BearingNodeOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2365.BearingNodeOption]":
