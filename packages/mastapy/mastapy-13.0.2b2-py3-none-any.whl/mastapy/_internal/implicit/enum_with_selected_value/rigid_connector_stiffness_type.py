...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2593.RigidConnectorStiffnessType":
        ...
        return _2593.RigidConnectorStiffnessType

    @classmethod
    def implicit_type(cls) -> "_2593.RigidConnectorStiffnessType.type_()":
        ...
        return _2593.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: Self) -> "_2593.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: Self) -> "List[_2593.RigidConnectorStiffnessType]":
