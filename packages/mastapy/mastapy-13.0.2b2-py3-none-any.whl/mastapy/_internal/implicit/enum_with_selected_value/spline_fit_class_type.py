...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1414.SplineFitClassType":
        ...
        return _1414.SplineFitClassType

    @classmethod
    def implicit_type(cls) -> "_1414.SplineFitClassType.type_()":
        ...
        return _1414.SplineFitClassType.type_()

    @property
    def selected_value(self: Self) -> "_1414.SplineFitClassType":
    ...
    @property
    def available_values(self: Self) -> "List[_1414.SplineFitClassType]":
