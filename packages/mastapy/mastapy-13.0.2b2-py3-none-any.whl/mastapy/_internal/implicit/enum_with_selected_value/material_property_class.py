...
from mastapy.fe_tools.enums import _1243
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1243.MaterialPropertyClass":
        ...
        return _1243.MaterialPropertyClass

    @classmethod
    def implicit_type(cls) -> "_1243.MaterialPropertyClass.type_()":
        ...
        return _1243.MaterialPropertyClass.type_()

    @property
    def selected_value(self: Self) -> "_1243.MaterialPropertyClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1243.MaterialPropertyClass]":
