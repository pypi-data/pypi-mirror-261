...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1159.ConicalManufactureMethods":
        ...
        return _1159.ConicalManufactureMethods

    @classmethod
    def implicit_type(cls) -> "_1159.ConicalManufactureMethods.type_()":
        ...
        return _1159.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: Self) -> "_1159.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1159.ConicalManufactureMethods]":
