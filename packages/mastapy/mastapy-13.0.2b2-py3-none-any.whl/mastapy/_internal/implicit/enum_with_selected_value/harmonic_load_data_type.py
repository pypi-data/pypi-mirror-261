...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1384.HarmonicLoadDataType":
        ...
        return _1384.HarmonicLoadDataType

    @classmethod
    def implicit_type(cls) -> "_1384.HarmonicLoadDataType.type_()":
        ...
        return _1384.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: Self) -> "_1384.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: Self) -> "List[_1384.HarmonicLoadDataType]":
