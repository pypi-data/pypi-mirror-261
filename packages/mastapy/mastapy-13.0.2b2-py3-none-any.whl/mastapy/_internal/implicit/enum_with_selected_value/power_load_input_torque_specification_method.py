...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2219.PowerLoadInputTorqueSpecificationMethod":
        ...
        return _2219.PowerLoadInputTorqueSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_2219.PowerLoadInputTorqueSpecificationMethod.type_()":
        ...
        return _2219.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2219.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2219.PowerLoadInputTorqueSpecificationMethod]":
