...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5486.ShaftAndHousingFlexibilityOption":
        ...
        return _5486.ShaftAndHousingFlexibilityOption

    @classmethod
    def implicit_type(cls) -> "_5486.ShaftAndHousingFlexibilityOption.type_()":
        ...
        return _5486.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: Self) -> "_5486.ShaftAndHousingFlexibilityOption":
    ...
    @property
    def available_values(self: Self) -> "List[_5486.ShaftAndHousingFlexibilityOption]":
