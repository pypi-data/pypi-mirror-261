...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1968.BallBearingAnalysisMethod":
        ...
        return _1968.BallBearingAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_1968.BallBearingAnalysisMethod.type_()":
        ...
        return _1968.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: Self) -> "_1968.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1968.BallBearingAnalysisMethod]":
