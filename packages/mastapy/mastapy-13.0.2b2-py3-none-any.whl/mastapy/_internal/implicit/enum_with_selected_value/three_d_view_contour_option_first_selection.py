...
from mastapy.utility.enums import _1824
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1824.ThreeDViewContourOptionFirstSelection":
        ...
        return _1824.ThreeDViewContourOptionFirstSelection

    @classmethod
    def implicit_type(cls) -> "_1824.ThreeDViewContourOptionFirstSelection.type_()":
        ...
        return _1824.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: Self) -> "_1824.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1824.ThreeDViewContourOptionFirstSelection]":
