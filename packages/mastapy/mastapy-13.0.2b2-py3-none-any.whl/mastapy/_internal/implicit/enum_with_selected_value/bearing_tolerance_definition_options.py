...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1906.BearingToleranceDefinitionOptions":
        ...
        return _1906.BearingToleranceDefinitionOptions

    @classmethod
    def implicit_type(cls) -> "_1906.BearingToleranceDefinitionOptions.type_()":
        ...
        return _1906.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: Self) -> "_1906.BearingToleranceDefinitionOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1906.BearingToleranceDefinitionOptions]":
