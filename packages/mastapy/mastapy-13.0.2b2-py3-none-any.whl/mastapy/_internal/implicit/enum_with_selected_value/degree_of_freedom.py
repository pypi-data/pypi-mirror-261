...
class EnumWithSelectedValue_DegreeOfFreedom(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1506.DegreeOfFreedom":
        ...
        return _1506.DegreeOfFreedom

    @classmethod
    def implicit_type(cls) -> "_1506.DegreeOfFreedom.type_()":
        ...
        return _1506.DegreeOfFreedom.type_()

    @property
    def selected_value(self: Self) -> "_1506.DegreeOfFreedom":
    ...
    @property
    def available_values(self: Self) -> "List[_1506.DegreeOfFreedom]":
