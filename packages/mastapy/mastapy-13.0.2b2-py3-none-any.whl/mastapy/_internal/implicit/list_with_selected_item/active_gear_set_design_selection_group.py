...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2514.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2514.ActiveGearSetDesignSelectionGroup.TYPE":
        ...
        return _2514.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2514.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2514.ActiveGearSetDesignSelectionGroup]":
