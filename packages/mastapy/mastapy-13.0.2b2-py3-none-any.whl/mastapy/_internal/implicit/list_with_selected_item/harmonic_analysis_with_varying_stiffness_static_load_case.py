...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def implicit_type(
        cls,
    ) -> "_5772.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE":
        ...
        return _5772.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE
    ...
    def available_values(
        self: Self,
    ) -> "List[_5772.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]":
