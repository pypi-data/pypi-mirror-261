...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2747.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2747.CylindricalGearSystemDeflection.TYPE":
        ...
        return _2747.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2747.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2747.CylindricalGearSystemDeflection]":
