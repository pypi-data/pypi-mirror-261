...
class ListWithSelectedItem_DutyCycle(_5666.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5666.DutyCycle.TYPE":
        ...
        return _5666.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5666.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5666.DutyCycle]":
