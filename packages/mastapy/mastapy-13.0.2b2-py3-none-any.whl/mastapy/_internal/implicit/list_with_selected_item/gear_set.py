...
class ListWithSelectedItem_GearSet(_2534.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2534.GearSet.TYPE":
        ...
        return _2534.GearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2534.GearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2534.GearSet]":
