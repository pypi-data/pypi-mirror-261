...
class ListWithSelectedItem_GearSetDesign(
    _951.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_951.GearSetDesign.TYPE":
        ...
        return _951.GearSetDesign.TYPE

    @property
    def selected_value(self: Self) -> "_951.GearSetDesign":
    ...
    @property
    def available_values(self: Self) -> "List[_951.GearSetDesign]":
