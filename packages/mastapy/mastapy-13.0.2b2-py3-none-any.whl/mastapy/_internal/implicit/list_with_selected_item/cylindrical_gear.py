...
class ListWithSelectedItem_CylindricalGear(
    _2527.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2527.CylindricalGear.TYPE":
        ...
        return _2527.CylindricalGear.TYPE

    @property
    def selected_value(self: Self) -> "_2527.CylindricalGear":
    ...
    @property
    def available_values(self: Self) -> "List[_2527.CylindricalGear]":
