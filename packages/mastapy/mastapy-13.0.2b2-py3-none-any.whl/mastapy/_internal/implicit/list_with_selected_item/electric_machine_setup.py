...
class ListWithSelectedItem_ElectricMachineSetup(
    _1268.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1268.ElectricMachineSetup.TYPE":
        ...
        return _1268.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1268.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1268.ElectricMachineSetup]":
