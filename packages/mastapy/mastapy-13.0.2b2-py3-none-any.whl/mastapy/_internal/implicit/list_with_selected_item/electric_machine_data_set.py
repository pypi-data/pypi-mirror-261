...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2375.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2375.ElectricMachineDataSet.TYPE":
        ...
        return _2375.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2375.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2375.ElectricMachineDataSet]":
