...
class ListWithSelectedItem_CylindricalGearSet(
    _2528.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2528.CylindricalGearSet.TYPE":
        ...
        return _2528.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2528.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2528.CylindricalGearSet]":
