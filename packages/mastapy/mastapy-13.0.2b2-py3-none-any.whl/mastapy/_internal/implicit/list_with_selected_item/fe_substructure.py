...
class ListWithSelectedItem_FESubstructure(
    _2385.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2385.FESubstructure.TYPE":
        ...
        return _2385.FESubstructure.TYPE

    @property
    def selected_value(self: Self) -> "_2385.FESubstructure":
    ...
    @property
    def available_values(self: Self) -> "List[_2385.FESubstructure]":
