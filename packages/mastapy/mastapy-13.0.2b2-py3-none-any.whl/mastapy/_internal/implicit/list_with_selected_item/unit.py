...
class ListWithSelectedItem_Unit(_1612.Unit, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_1612.Unit.TYPE":
        ...
        return _1612.Unit.TYPE

    @property
    def selected_value(self: Self) -> "_1612.Unit":
    ...
    @property
    def available_values(self: Self) -> "List[_1612.Unit]":
