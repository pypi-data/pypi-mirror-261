...
class ListWithSelectedItem_PowerLoad(_2474.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2474.PowerLoad.TYPE":
        ...
        return _2474.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2474.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2474.PowerLoad]":
