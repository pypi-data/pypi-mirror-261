...
class ListWithSelectedItem_FEPart(_2455.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2455.FEPart.TYPE":
        ...
        return _2455.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2455.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2455.FEPart]":
