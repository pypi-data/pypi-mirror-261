...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2761.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2761.GearMeshSystemDeflection.TYPE":
        ...
        return _2761.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2761.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2761.GearMeshSystemDeflection]":
