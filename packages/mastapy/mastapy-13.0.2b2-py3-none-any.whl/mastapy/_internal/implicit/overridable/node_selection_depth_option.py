...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2404.NodeSelectionDepthOption":
        ...
        return _2404.NodeSelectionDepthOption

    @classmethod
    def implicit_type(cls) -> "_2404.NodeSelectionDepthOption.type_()":
        ...
        return _2404.NodeSelectionDepthOption.type_()

    @property
    def value(self: Self) -> "_2404.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: Self) -> "_2404.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: Self) -> "_2404.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
