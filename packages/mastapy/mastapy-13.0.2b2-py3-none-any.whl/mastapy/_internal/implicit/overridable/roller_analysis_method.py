...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2071.RollerAnalysisMethod":
        ...
        return _2071.RollerAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_2071.RollerAnalysisMethod.type_()":
        ...
        return _2071.RollerAnalysisMethod.type_()

    @property
    def value(self: Self) -> "_2071.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: Self) -> "_2071.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: Self) -> "_2071.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
