...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1900.SealLocation":
        ...
        return _1900.SealLocation

    @classmethod
    def implicit_type(cls) -> "_1900.SealLocation.type_()":
        ...
        return _1900.SealLocation.type_()

    @property
    def value(self: Self) -> "_1900.SealLocation":
    ...
    @property
    def override_value(self: Self) -> "_1900.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: Self) -> "_1900.SealLocation":
        """mastapy.bearings.SealLocation
