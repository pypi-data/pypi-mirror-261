...
class BoltMaterial(_1468.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self: Self) -> "_1487.StrengthGrades":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1487", "StrengthGrades")(
            value
        )

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: Self, value: "_1487.StrengthGrades"):
