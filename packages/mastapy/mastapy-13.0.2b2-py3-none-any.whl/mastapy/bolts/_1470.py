...
if TYPE_CHECKING:
    from mastapy.bolts import _1474, _1475, _1486, _1476, _1481, _1488
...
class BoltGeometry(_1831.NamedDatabaseItem):
    ...
    @property
    def bolt_sections(self: Self) -> "List[_1474.BoltSection]":
    ...
    @enforce_parameter_types
    def bolt_sections(self: Self, value: "List[_1474.BoltSection]"):
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self: Self) -> "_1475.BoltShankType":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1475", "BoltShankType")(
            value
        )

    @bolt_shank_type.setter
    @enforce_parameter_types
    def bolt_shank_type(self: Self, value: "_1475.BoltShankType"):
    ...
    @property
    def standard_size(self: Self) -> "_1486.StandardSizes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1486", "StandardSizes")(
            value
        )

    @standard_size.setter
    @enforce_parameter_types
    def standard_size(self: Self, value: "_1486.StandardSizes"):
    ...
    @property
    def type_of_bolted_joint(self: Self) -> "_1476.BoltTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1476", "BoltTypes")(value)

    @type_of_bolted_joint.setter
    @enforce_parameter_types
    def type_of_bolted_joint(self: Self, value: "_1476.BoltTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.BoltTypes")
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self: Self) -> "_1481.HeadCapTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1481", "HeadCapTypes")(
            value
        )

    @type_of_head_cap.setter
    @enforce_parameter_types
    def type_of_head_cap(self: Self, value: "_1481.HeadCapTypes"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Bolts.HeadCapTypes")
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self: Self) -> "_1488.ThreadTypes":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1488", "ThreadTypes")(value)

    @type_of_thread.setter
    @enforce_parameter_types
    def type_of_thread(self: Self, value: "_1488.ThreadTypes"):
