...
if TYPE_CHECKING:
    from mastapy.math_utility import _1511, _1526, _1528, _1533, _1538
...
class RealMatrix(_1516.GenericMatrix[float, "RealMatrix"]):
    """RealMatrix
    ...
    class _Cast_RealMatrix:
        ...
        @property
        def quaternion(self: "RealMatrix._Cast_RealMatrix") -> "_1526.Quaternion":
            from mastapy.math_utility import _1526

            return self._parent._cast(_1526.Quaternion)

        @property
        def real_vector(self: "RealMatrix._Cast_RealMatrix") -> "_1528.RealVector":
            from mastapy.math_utility import _1528

            return self._parent._cast(_1528.RealVector)

        @property
        def square_matrix(self: "RealMatrix._Cast_RealMatrix") -> "_1533.SquareMatrix":
            from mastapy.math_utility import _1533

            return self._parent._cast(_1533.SquareMatrix)

        @property
        def vector_6d(self: "RealMatrix._Cast_RealMatrix") -> "_1538.Vector6D":
