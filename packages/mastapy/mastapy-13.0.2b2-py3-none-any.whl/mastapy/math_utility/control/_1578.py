...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self: Self) -> "_1525.PIDControlUpdateMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1525", "PIDControlUpdateMethod"
        )(value)

    @update_method.setter
    @enforce_parameter_types
    def update_method(self: Self, value: "_1525.PIDControlUpdateMethod"):
