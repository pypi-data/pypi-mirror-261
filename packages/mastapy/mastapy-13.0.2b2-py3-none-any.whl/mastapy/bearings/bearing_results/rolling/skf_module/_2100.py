...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: Self) -> "_2078.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: Self) -> "_2080.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: Self) -> "_2081.BearingRatingLife":
    ...
    @property
    def frequencies(self: Self) -> "_2083.Frequencies":
    ...
    @property
    def friction(self: Self) -> "_2085.Friction":
    ...
    @property
    def minimum_load(self: Self) -> "_2093.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: Self) -> "_2101.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: Self) -> "_2102.Viscosities":
