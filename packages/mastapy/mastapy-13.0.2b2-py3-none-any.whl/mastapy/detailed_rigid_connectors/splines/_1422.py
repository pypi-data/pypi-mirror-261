...
from mastapy.detailed_rigid_connectors.splines import _1405, _1406, _1417
...
class StandardSplineJointDesign(_1417.SplineJointDesign):
    """StandardSplineJointDesign
    ...
    class _Cast_StandardSplineJointDesign:
        ...
        def spline_joint_design(
            ...
            return self._parent._cast(_1417.SplineJointDesign)
    ...
    @enforce_parameter_types
    def module_preferred(self: Self, value: "_1405.Modules"):
    ...
    @enforce_parameter_types
    def pressure_angle_preferred(self: Self, value: "_1406.PressureAngleTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
