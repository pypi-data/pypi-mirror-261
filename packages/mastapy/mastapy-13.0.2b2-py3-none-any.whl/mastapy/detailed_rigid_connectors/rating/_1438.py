...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1444
    from mastapy.detailed_rigid_connectors.interference_fits.rating import _1451
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    class _Cast_ShaftHubConnectionRating:
        ...
        def agma6123_spline_joint_rating(
            ...
            return self._parent._cast(_1426.AGMA6123SplineJointRating)
        ...
        def din5466_spline_rating(
            ...
            return self._parent._cast(_1428.DIN5466SplineRating)
        ...
        def gbt17855_spline_joint_rating(
            ...
            return self._parent._cast(_1430.GBT17855SplineJointRating)
        ...
        def sae_spline_joint_rating(
            ...
            return self._parent._cast(_1432.SAESplineJointRating)
        ...
        def spline_joint_rating(
            ...
            return self._parent._cast(_1434.SplineJointRating)
        ...
        def keyway_rating(
            ...
            return self._parent._cast(_1444.KeywayRating)

        @property
        def interference_fit_rating(
            self: "ShaftHubConnectionRating._Cast_ShaftHubConnectionRating",
        ) -> "_1451.InterferenceFitRating":
            from mastapy.detailed_rigid_connectors.interference_fits.rating import _1451

            return self._parent._cast(_1451.InterferenceFitRating)
    ...
    @property
    def joint_design(self: Self) -> "_1389.DetailedRigidConnectorDesign":
