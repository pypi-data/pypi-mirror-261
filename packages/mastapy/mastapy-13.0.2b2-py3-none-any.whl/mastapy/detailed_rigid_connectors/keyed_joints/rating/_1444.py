...
class KeywayRating(_1451.InterferenceFitRating):
    """KeywayRating
    ...
    class _Cast_KeywayRating:
        ...
        def shaft_hub_connection_rating(
            self: "KeywayRating._Cast_KeywayRating",
        ) -> "_1438.ShaftHubConnectionRating":
            from mastapy.detailed_rigid_connectors.rating import _1438

            return self._parent._cast(_1438.ShaftHubConnectionRating)
    ...
    @property
    def keyed_joint_design(self: Self) -> "_1439.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: Self) -> "List[_1443.KeywayHalfRating]":
