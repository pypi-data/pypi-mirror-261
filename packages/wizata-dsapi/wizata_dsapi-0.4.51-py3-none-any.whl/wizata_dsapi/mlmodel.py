...
class MLModelConfig(ApiDto):
    ...
    def from_json(self, obj):
        ...
        if "features_mapping" in obj:
            self.features_mapping = obj["features_mapping"]
    ...
    def to_json(self, target: str = None):
        ...
        if self.features_mapping is not None and isinstance(self.features_mapping, dict):
            obj["features_mapping"] = self.features_mapping
