...
class Provider(BaseProvider):
    ...
    def user_agent(self) -> str:
        """Generate a random web web user agent string."""
    ...
    def chrome(
        ...
        """Generate a Chrome web web user agent string."""
    ...
    def firefox(self) -> str:
        """Generate a Mozilla Firefox web web user agent string."""
        ver: ElementsType = (
            (
    ...
    def safari(self) -> str:
        """Generate a Safari web web user agent string."""
        saf: str = (
    ...
    def opera(self) -> str:
        """Generate an Opera web web user agent string."""
        token: str = (
    ...
    def internet_explorer(self) -> str:
        """Generate an IE web web user agent string."""
        return (
