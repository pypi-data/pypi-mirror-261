...
def create_issue(title: str, content: str, to='san.zhang', env='pre', epc_id='APP-23662'):
    """
    :param title: bug标题
    :param content: bug详细描述
    :param to: 指派给人员的姓名，如san.zhang
    :param env: 问题环境，如nts、test、pre、prd
    :param epc_id: epic页面链接最后的id，如APP-23662
    :return: {
        'title': 'bug标题',
        'issue_url': 'https://jira.xxx.com/browse/APP-38532'
    }
    """

    jira = JIRA(server='http://jira.xxx.com', auth=('username', 'password'))
    # print(jira.projects())
    ...
    issue_info = {
        'title': title,
        'issue_url': f"https://jira.xxx.com/browse/{new_issue.raw.get('key')}"
    }
    print(issue_info)
    return issue_info
