...
class Provider(BaseProvider):
    ...
    image_mime_types: ElementsType = (
        ...
        # initiated before global web support for progressive JPEGs (Microsoft and Firefox).
    ...
    text_mime_types: ElementsType = (
        ...
        # application/javascript, has cross-web support. The "type" attribute of the <script> tag in HTML5 is
