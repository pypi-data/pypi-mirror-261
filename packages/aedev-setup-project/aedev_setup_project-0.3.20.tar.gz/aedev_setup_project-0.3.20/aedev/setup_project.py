...
STK_CLASSIFIERS = [
            ...
            f"Programming Language :: Python :: {MINIMUM_PYTHON_VERSION.split('.')[0]}",
...
def find_package_data(package_path: str) -> PackageDataType:
    ...
    :return:                    setuptools package_data dict, where the key is an empty string (to be included for all
                                ...
                                (like e.g. the docs `_build`, the :data:`~ae.base.PY_CACHE_FOLDER`|`__pycache__` and the
                                `__enamlcache__` folders) get excluded.
