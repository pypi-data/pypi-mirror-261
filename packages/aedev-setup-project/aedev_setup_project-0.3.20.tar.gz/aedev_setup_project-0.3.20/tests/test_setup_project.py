...
from aedev.setup_project import (
    APP_PRJ, DJANGO_PRJ, MINIMUM_PYTHON_VERSION, MODULE_PRJ, NO_PRJ, PACKAGE_PRJ, PARENT_PRJ, ROOT_PRJ,
    PYPI_PROJECT_ROOT, REPO_CODE_DOMAIN, REPO_GROUP_SUFFIX, REQ_FILE_NAME, REQ_DEV_FILE_NAME, PARENT_FOLDERS,
    code_file_title, code_file_version, find_package_data, namespace_guess, pev_str, pev_val, project_env_vars)
...
class TestHelpers:
    ...
    def test_find_package_data_build_file(self):
        package_name = 'tst_app_with_build_file'
    ...
    def test_find_package_data_img(self):
        package_name = 'tst_pkg_with_resources'
        pkg_path = os.path.join(TESTS_FOLDER, package_name)
    ...
    def test_find_package_data_portion_snd(self):
        ...
        prj_path = os.path.join(TESTS_FOLDER, package_name)
    ...
    def test_find_package_data_templates(self):
        package_name = 'tst_prj_with_templates'
        pkg_path = os.path.join(TESTS_FOLDER, package_name)
    ...
    def test_find_package_data_updater(self):
        package_name = 'tst_app_with_updater_or_bootstrap'
        pkg_path = os.path.join(TESTS_FOLDER, package_name)
...
class TestProjectEnvVars:
    ...
    def test_setup_py_pev_patched_defaults(self):
        ...
        package_name_folder = "tst_pkg"
        project_path = os.path.join(parent_dir, package_name_folder)
...
class TestProjectTypeAndResources:
    ...
    def test_namespace_root_project_module(self):
        ...
        package_name = namespace + "_" + namespace
        parent_dir = os.path.join(TESTS_FOLDER, PARENT_FOLDERS[0])
        project_path = os.path.join(parent_dir, package_name)
    ...
    def test_namespace_root_project_package(self):
        ...
        try:
            ...
            write_file(os.path.join(nss_dir, PY_INIT), "__version__ = '1.2.3'")
