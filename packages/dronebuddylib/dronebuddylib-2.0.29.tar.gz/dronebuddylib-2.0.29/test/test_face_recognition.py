...
class TestFaceRecognition(unittest.TestCase):
    ...
    def test_face_rec_knn_add_face(self):
        ...
        result = engine.remember_face(None, "malsha")
        print(result)
    ...
    def test_face_rec_knn_recognize_face(self):
        image = cv2.imread(r'C:\Users\Public\projects\drone-buddy-library\dronebuddylib\atoms\facerecognition\resources\test_data\validation_data\malsha\malsha_14.jpg')
