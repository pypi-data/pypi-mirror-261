...
class AtomicEngineConfigurations(enum.Enum):
    ...
    FACE_RECOGNITION_TRAINING_DATA_SET_SIZE = "FACE_RECOGNITION_TRAINING_DATA_SET_SIZE"
    FACE_RECOGNITION_TESTING_DATA_SET_SIZE = "FACE_RECOGNITION_TESTING_DATA_SET_SIZE"
    FACE_RECOGNITION_VALIDATION_DATA_SET_SIZE = "FACE_RECOGNITION_VALIDATION_DATA_SET_SIZE"
    FACE_RECOGNITION_ALGORITHM_NAME = "FACE_RECOGNITION_ALGORITHM_NAME"
    FACE_RECOGNITION_ALGORITHM_NEIGHBORS = "FACE_RECOGNITION_ALGORITHM_NEIGHBORS"
    FACE_RECOGNITION_MODEL_SAVING_PATH = "FACE_RECOGNITION_MODEL_SAVING_PATH"
    FACE_RECOGNITION_MODEL_THRESHOLD = "FACE_RECOGNITION_MODEL_THRESHOLD"
