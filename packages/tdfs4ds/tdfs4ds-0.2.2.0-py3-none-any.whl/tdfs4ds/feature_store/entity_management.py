...
def register_entity(entity_id):
    ...
    feature_store_table_name_varchar_unicode = feature_store_table_creation(entity_id, feature_type='VARCHAR_UNICODE')
    feature_store_table_name_varchar_latin   = feature_store_table_creation(entity_id, feature_type='VARCHAR_LATIN')
