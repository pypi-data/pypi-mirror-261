...
class VaultsController(BaseController):
    ...
    def get_vaults(self, id=None, name=None, include_marked_for_removal=None, tenant_ids=None):
        ...
        Args:
            ...
            tenant_ids (list of string): Specifies a list of tenant ids. Only
                vaults assigned to these tenants will be returned.
