...
def _submit_log(log: OperationLog):
    try:
...
async def _async_log(log: OperationLog):
    ...
    logging.info(f'openapi链路日志上报:{log.json(by_alias=True)}')
...
__all__ = ['operation_log', 'OperationLog']
