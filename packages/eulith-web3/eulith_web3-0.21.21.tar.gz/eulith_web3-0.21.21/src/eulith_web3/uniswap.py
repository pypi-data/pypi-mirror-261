...
from eulith_web3.websocket import SubscribeRequest, SubscriptionHandle, EulithWebsocketRequestHandler
...
class EulithUniswapV3Pool(IUniswapV3Pool):
    ...
    def subscribe_prices(self, handler: EulithWebsocketRequestHandler) -> SubscriptionHandle:
