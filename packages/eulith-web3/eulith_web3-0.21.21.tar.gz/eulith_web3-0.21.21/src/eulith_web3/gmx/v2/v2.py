...
from eulith_web3.gmx.v2.rpc import GmxV2CreateOrderRequest, GmxV2CreateOrderResponse, GmxV2GetPositionsRequest, \
    GmxV2GetPositionsResponse

from eulith_web3.gmx.v2.rpc import GmxV2GetMarketPoolDataResponse, GmxV2GetMarketPoolDataRequest, \
...
class GmxV2Client:
    ...
    def get_market_pool_data(self, req: GmxV2GetMarketPoolDataRequest) -> GmxV2GetMarketPoolDataResponse:
        return self.eulith_service.gmx_v2_get_market_pool_data(req)

    def create_deposit(self, req: GmxV2CreateDepositRequest) -> GmxV2CreateDepositResponse:
