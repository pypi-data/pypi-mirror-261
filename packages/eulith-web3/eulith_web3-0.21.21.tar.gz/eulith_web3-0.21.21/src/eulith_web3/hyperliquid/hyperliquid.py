...
from eulith_web3.hyperliquid.rpc import HyperliquidGetDataRequest, HyperliquidTimeInForce
from eulith_web3.exceptions import EulithNoSignerException
from eulith_web3.hyperliquid._eip712 import (HyperliquidCreateOrderHashInput, get_hyper_liquid_create_order_hash,
                                             HyperliquidCancelOrderHashInput, get_hyper_liquid_create_order_typed_data,
...
class HyperliquidClient:
    ...
    def create_order(self, coin: str, is_buy: bool, size: Union[float, str], limit_price: Union[float, str],
                     time_in_force: HyperliquidTimeInForce, reduce_only: bool, ace_address: str) -> Dict:
        try:
        ...
        return self.ew3.eulith_service.hyperliquid_create_order(hash_input, signature_string, ace_address)
    ...
    def cancel_order(self, coin: str, oid: int, ace_address: str) -> Dict:
        ...
        return self.ew3.eulith_service.hyperliquid_cancel_order(hash_input, signature_string, ace_address)
