...
from eulith_web3.gmx.v2.rpc import GmxV2CreateOrderRequest, GmxV2CreateOrderResponse, \
    GmxV2GetPositionsRequest, GmxV2GetPositionsResponse

from eulith_web3.gmx.v2.rpc import GmxV2GetMarketPoolDataRequest, GmxV2GetMarketPoolDataResponse, \
    GmxV2CreateDepositRequest, GmxV2CreateDepositResponse
...
class EulithService:
    ...
    def __init__(self, eulith_url: str, eulith_token: str, private: bool = False,
                 auth_address: Optional[str] = None) -> None:
        """
    ...
    def request_gmx_mint_glp(self, pay_token: EulithERC20, pay_amount: float, slippage: Optional[float]) -> (
            bool, dict):
        """
    ...
    def create_draft_client_whitelist_v2(self,
                                         request: whitelists_v2.rpc.CreateRequest) -> whitelists_v2.rpc.CreateResponse:
    ...
    def append_to_draft_client_whitelist_v2(self,
                                            request: whitelists_v2.rpc.AppendRequest) -> whitelists_v2.rpc.AppendResponse:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_append_to_draft_client_whitelist_v2"),
                                                     [request])
        raise_if_error(json_rpc)
    ...
    def start_activate_whitelist(self,
                                 request: whitelists_v2.rpc.StartActivateRequest) -> whitelists_v2.rpc.StartActivateResponse:
    ...
    def submit_activate_whitelist_signature(self,
                                            request: whitelists_v2.rpc.SubmitActivateSignatureRequest) -> whitelists_v2.rpc.SubmitActivateSignatureResponse:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_submit_activate_whitelist_signature"),
                                                     [request])
        raise_if_error(json_rpc)
    ...
    def delete_draft_client_whitelist_v2(self,
                                         request: whitelists_v2.rpc.DeleteRequest) -> whitelists_v2.rpc.DeleteResponse:
    ...
    def get_light_simulation_proposal_hash(self, proposal_id: int) -> (dict, dict):
        try:
            ...
            response = self.eulith_provider.make_request(RPCEndpoint("eulith_get_light_simulation_proposal_hash"),
                                                         [params])
            raise_if_error(response)
            return response["result"], {}
        except EulithRpcException as e:
    ...
    def submit_light_simulation_signature(self, proposal_id: int, owner_address: str, signature: str,
                                          signed_hash: str) -> (dict, dict):
        try:
            params = dict(proposal_id=proposal_id, owner_address=owner_address, signature=signature,
                          signed_hash=signed_hash)
            response = self.eulith_provider.make_request(
                RPCEndpoint("eulith_submit_light_simulation_proposal_signature"), [params])
            raise_if_error(response)
            return response["result"], {}
        except EulithRpcException as e:
            return None, RPCResponse(error=str(e))
    ...
    def delete_light_simulation_proposal(self, proposal_id: int) -> (dict, dict):
        try:
            params = dict(proposal_id=proposal_id)
            response = self.eulith_provider.make_request(RPCEndpoint("eulith_delete_light_simulation_proposal"),
                                                         [params])
            raise_if_error(response)
            return response["result"], {}
        except EulithRpcException as e:
    ...
    def dydx_v3_get_ace_managed_accounts(self, ace_address: str) -> (List[DydxV3AceManagedAccount], dict):
        try:
            ...
            response = self.eulith_provider.make_request(RPCEndpoint("eulith_dydx_v3_get_ace_managed_accounts"),
                                                         [params])
            raise_if_error(response)
            return response["result"], {}
        except EulithRpcException as e:
    ...
    def gmx_v2_get_positions(self, request: GmxV2GetPositionsRequest) -> GmxV2GetPositionsResponse:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_gmx_v2_get_positions"), [request])
        raise_if_error(json_rpc)
        return cast(GmxV2GetPositionsResponse, json_rpc["result"])

    def gmx_v2_create_order(self, request: GmxV2CreateOrderRequest) -> GmxV2CreateOrderResponse:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_gmx_v2_create_order"), [request])
        raise_if_error(json_rpc)
        return cast(GmxV2CreateOrderResponse, json_rpc["result"])

    def gmx_v2_get_market_pool_data(self, request: GmxV2GetMarketPoolDataRequest) -> GmxV2GetMarketPoolDataResponse:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_gmx_v2_get_market_pool_data"), [request])
        raise_if_error(json_rpc)
        return cast(GmxV2GetMarketPoolDataResponse, json_rpc["result"])

    def gmx_v2_create_deposit(self, request: GmxV2CreateDepositRequest) -> GmxV2CreateDepositResponse:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_gmx_v2_create_deposit"), [request])
        raise_if_error(json_rpc)
    ...
    def hyperliquid_get_data(self, request: HyperliquidGetDataRequest) -> Dict:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_hyperliquid_get_data"), [request])
        raise_if_error(json_rpc)
        return cast(Dict, json_rpc["result"])

    def hyperliquid_create_order(self, order_params: HyperliquidCreateOrderHashInput, signature: str, ace_address: str):
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_hyperliquid_create_order"), [{
    ...
    def hyperliquid_cancel_order(self, order_params: HyperliquidCreateOrderHashInput, signature: str, ace_address: str):
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_hyperliquid_cancel_order"), [{
    ...
    def tx_bundle(self, request: BundleRequest) -> TxParams:
        json_rpc = self.eulith_provider.make_request(RPCEndpoint("eulith_tx_bundle"), [request])
        raise_if_error(json_rpc)
    ...
    def subscribe(self, subscription_request: SubscribeRequest,
                  handler: EulithWebsocketRequestHandler) -> SubscriptionHandle:
