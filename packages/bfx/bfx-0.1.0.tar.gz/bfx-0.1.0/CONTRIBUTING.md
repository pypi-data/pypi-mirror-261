...
Welcome to `bfx` contributor's guide.
...
If you experience bugs or general issues with `bfx`, please have a look
...
You can help improve `bfx` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`bfx` documentation uses [Sphinx] as its main documentation compiler for the Markdown files.
...
:::{tip}
      ...
      propose changes in `bfx`'s files. While this mechanism can
...
```
conda create -n bfx python=3 six virtualenv pytest pytest-cov
conda activate bfx
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/bfx.git
   cd bfx
   ```
...
5. Install [pre-commit]:
   ...
   `bfx` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/not-a-feature/bfx
[issue tracker]: https://github.com/not-a-feature/bfx/issues
