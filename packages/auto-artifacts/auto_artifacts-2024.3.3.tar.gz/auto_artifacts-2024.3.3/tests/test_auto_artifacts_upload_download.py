...
class TestFileOperations(unittest.TestCase):
    ...
    def test_upload_files(self):
        success = upload_files("http://127.0.0.1:8000", ["./resources/files_to_upload/file_3.txt"], "files_uploaded", "sample_pw")
        self.assertTrue(success)
        pass

    def test_download_file(self):
        success = download_file("http://127.0.0.1:8000", "file_3.txt", "files_uploaded", "sample_pw")
        self.assertTrue(success)
        pass
