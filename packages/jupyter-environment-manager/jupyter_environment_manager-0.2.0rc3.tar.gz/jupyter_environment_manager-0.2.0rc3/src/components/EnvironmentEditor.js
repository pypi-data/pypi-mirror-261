...
export default class EnvironmentEditor extends Component {
  ...
  componentDidMount() {
    ...
    console.log('packageLoading', this.props.packageLoading);
            ...
            <FormControlLabel
              ...
              control={
                <Switch
                  ...
                  sx={{
                    cursor: !hasQuantumJobs && 'not-allowed'
                  }}
                />
              }
              label={
        ...
        {!hasQuantumJobs && !this.state.quantumJobsAdditionSuccess && (
          ...
          >
            <IconButton
              ...
              disabled={this.props.installing || this.props.env.isPreInstalled}
        ...
        >
          {this.state.tags.map((tag, index) => (
            <Chip
              ...
              variant="filled"
              onDelete={
                this.state.editOpen ? () => this.handleRemoveTags(index) : ''
              }
            />
          ))}
              ...
              <Grid container>
                <Grid item xs={12}>
                  <p className="env-pane-prompt">
                    ...
                    To create a shareable custom environment, click{' '}
            ...
            <Table size="small">
              ...
              <TableBody>
                {pkgCount > 0 && !this.state.addPackageDialogOpen && (
                  <TableRow>
                    <TableCell colSpan={this.state.canModify ? 3 : 3}>
                ...
                {(this.props.packageLoading || this.state.packageListLoading) &&
  ...
  renderDeletePane = () => {
    return (
      <div className="env-editor-pane-new" style={{ minHeight: 75 }}>
        <div className="env-pane-content">
          <p
      ...
      >
        ...
        <DialogContent id="alert-dialog-content">
          <DialogContentText id="alert-dialog-description">
            ...
            <b>{this.props.env.displayName}</b>. The action cannot be undone!
          </DialogContentText>
        </DialogContent>
        <DialogActions id="alert-dialog-actions">
          <Button
