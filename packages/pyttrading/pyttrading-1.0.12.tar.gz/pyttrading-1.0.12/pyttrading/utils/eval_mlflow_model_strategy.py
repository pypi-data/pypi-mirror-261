...
def eval_strategy_latest(parameters=None):
...
def eval_mlflow_model_strategy(symbol :str, stage :str, tag: str, mlflow_connection=None):
    ...
    if model_selected:
        ...
        action = eval_strategy_latest(parameters)
