    ...
    async def do_upload_file(self, upload_url, upload_fields, file_path):
        ...
        with open(file_path, 'rb') as f:
            ...
            if old_way:
                ...
                err_message = f"Error uploading file upload_url: {upload_url}, upload_fields: {upload_fields}, file_path: {file_path}"
                response = await self._checked_get_or_post(upload_url, the_request=None, is_post=True, requests_kwargs={'data':upload_fields, 'files':files}, good_message=None, bad_message=err_message, raise_errors=True)
                return full_url
