...
class RandomNumber(LeafSystem):
    ...
    def __init__(
        ...
        **distribution_parameters,
        ...
        key = random.PRNGKey(seed or np.random.randint(0, 2**32))
...
class WhiteNoise(LeafSystem):
    ...
    def _output(self, time, state, *_inputs, **_parameters):
        ...
        w = (time - t_last) / self.dt - self.shift
