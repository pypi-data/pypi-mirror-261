...
def process_report():
    if args.report:
        ...
        pdf.page(the_page).text(10,1,"report")
        
        i=5
        the_page += 1
        
        for png in REPORT['viewports_out']:
            jpg = "%s.jpg" % png
            ...
            #pdf.page(the_page).text(i,1,"%s %dx%d" % (jpg, jpg_width, jpg_height))
