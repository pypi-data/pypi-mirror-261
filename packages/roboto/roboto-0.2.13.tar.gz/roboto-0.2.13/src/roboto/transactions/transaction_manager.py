...
class TransactionManager(TransactionManagerABC):
    ...
    def begin_manifest_transaction(
        ...
        url = f"{self.__roboto_service_base_url}/v3/transactions/begin"
    ...
    def on_manifest_item_complete(
        ...
        **kwargs,
        ...
        manifest_item_identifier = files.File.construct_s3_obj_uri(bucket, dest_path)
        with self.__manifest_items_lock:
            ...
            if self.__unreported_manifest_items_batch_ready_to_report(transaction_id):
                self.flush_manifest_item_completions(
                    transaction_id,
                    list(self.__transaction_completed_unreported_items[transaction_id]),
                )
                self.__transaction_completed_unreported_items[transaction_id] = set()
                return True
    ...
    def flush_manifest_item_completions(
        ...
        url = f"{self.__roboto_service_base_url}/v3/transactions/{transaction_id}/progress"
    ...
    def complete_manifest_transaction(
        ...
        """
        url = f"{self.__roboto_service_base_url}/v3/transactions/{transaction_id}/complete"
    ...
    def create_single_file_upload(
        ...
        request_body = datasets.BeginSingleFileUploadRequest(
            origination=origination,
        ...
        parsed_response = datasets.BeginSingleFileUploadResponse.model_validate(
            response.from_json(json_path=["data"])
        )
