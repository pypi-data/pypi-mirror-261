...
class TestDeployBasic:
    ...
    def test_custom_image(
        ...
        sdk, fake_client = sdk_with_fake_client
        fake_client.set_image_uri_mapping("my-custom-image", "bld_123")
        ...
        with pytest.raises(
            ValueError, match="The image_uri 'does-not-exist' does not exist."
        ):
            sdk.deploy(config.options(image_uri="does-not-exist"))
        ...
        expected_status=_expected_status(
            ...
            primary_version=ServiceVersionStatus(
                ...
                config=ServiceConfig(
                    ...
                    image_uri=TEST_CLUSTER_ENV_NAME,
