...
class OrganizationSummary(object):
    ...
    attribute_map = {
        'name': 'name',
        'id': 'id',
        'public_identifer': 'public_identifer',
        'creator_email': 'creator_email',
        'total_users': 'total_users'
    }

    def __init__(self, name=None, id=None, public_identifer=None, creator_email=None, total_users=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.name = name
        self.id = id
        self.public_identifer = public_identifer
    ...
    @property
    def public_identifer(self):
        """Gets the public_identifer of this OrganizationSummary.  # noqa: E501


        :return: The public_identifer of this OrganizationSummary.  # noqa: E501
        :rtype: str
        """
        return self._public_identifer

    @public_identifer.setter
    def public_identifer(self, public_identifer):
        """Sets the public_identifer of this OrganizationSummary.


        :param public_identifer: The public_identifer of this OrganizationSummary.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and public_identifer is None:  # noqa: E501
            raise ValueError("Invalid value for `public_identifer`, must not be `None`")  # noqa: E501

        self._public_identifer = public_identifer
