...
1. [x] write a minimal description of the project goals and possible use cases (README.rst)
2. [x] define a first version of the data models needed to support such logic (models/*.py)
3. [x] define the first use cases related to model consistency (docs/use_cases.md)
4. [x] define the common helpers that will be necessary for these use cases
    4.1 [x] random synthetic data that will feed pytest cases and FastAPI examples
    4.2 [x] write down some test cases (tests/test__xxx.py) for verifying pydantic models
            allowing use of `make ptw` from this stage.

5. [x] define the use cases related to business logic (docs/use_cases.md)
    5.1. [x] extend use cases based on (1)
