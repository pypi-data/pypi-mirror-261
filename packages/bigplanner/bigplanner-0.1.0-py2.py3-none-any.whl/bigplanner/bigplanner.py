...
from bigplanner.loaders import ModuleLoader
...
for port in ACTIVE_PORTS:
    prefix= "/".join(["", "bigplanner", port.__name__.split('.')[-1]])
...
if __name__ == "__main__":
    """
    $ uvicorn bigplanner.bigplanner:app --reload --reload-delay 1 --reload-dir ~/your/code/bigplanner --reload-exclude 'venv' --loop uvloop
    """
