...
def get_system_parameters(name: Optional[str] = None,
...
@_utilities.lift_output_func(get_system_parameters)
def get_system_parameters_output(name: Optional[pulumi.Input[Optional[str]]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSystemParametersResult]:
    """
    ## Example Usage
