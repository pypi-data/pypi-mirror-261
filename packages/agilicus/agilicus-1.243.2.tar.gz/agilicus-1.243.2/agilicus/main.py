...
@cli.command()
@click.pass_context
def create_session_challenge(ctx, **kwargs):
    result = tokens.create_session_challenge(ctx)
    output_entry(ctx, result.to_dict())


@cli.command()
@click.pass_context
def update_session_challenge(ctx, **kwargs):
    result = tokens.update_session_challenge(ctx)
    output_entry(ctx, result.to_dict())
