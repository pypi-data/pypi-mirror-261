...
def range_or_node_to_start_line(range_or_node: RangeGQL | ast.AST) -> int:
    if isinstance(range_or_node, RangeGQL):
        i = range_or_node.start.line
    else:
        i = range_or_node.lineno
    return i - 1


def range_or_node_to_end_line(range_or_node: RangeGQL | ast.AST) -> int:
    if isinstance(range_or_node, RangeGQL):
        i = range_or_node.end.line
    else:
        i = range_or_node.end_lineno
    return i - 1


def range_or_node_to_start_char(range_or_node: RangeGQL | ast.AST) -> int:
    if isinstance(range_or_node, RangeGQL):
        i = range_or_node.start.character
    else:
        i = range_or_node.col_offset
    return i


def range_or_node_to_end_char(range_or_node: RangeGQL | ast.AST) -> int:
    if isinstance(range_or_node, RangeGQL):
        i = range_or_node.end.character
    else:
        i = range_or_node.end_col_offset
    return max(i - 1, 0)
