...
class DatasetRevisionImpl(DatasetRevision):
    ...
    def get_data_as_polars(
        self, output_id: bool = False, output_ts: bool = False, ignore_errors: bool = False
    ) -> pl.LazyFrame:
    ...
    def to_polars(self, output_id: bool = False, output_ts: bool = False, ignore_errors: bool = False) -> pl.DataFrame:
        return self.get_data_as_polars(output_id=output_id, output_ts=output_ts, ignore_errors=ignore_errors).collect()

    def to_polars_lazyframe(
        self, output_id: bool = False, output_ts: bool = False, ignore_errors: bool = False
    ) -> pl.LazyFrame:
        return self.get_data_as_polars(output_id=output_id, output_ts=output_ts, ignore_errors=ignore_errors)
    ...
    def to_pandas(
        ...
        return self.get_data_as_pandas(output_id=output_id, output_ts=output_ts, ignore_errors=ignore_errors)
    ...
    def download_uris(self, output_id: bool = False, output_ts: bool = False, ignore_errors: bool = False) -> list[str]:
        current_frame = inspect.currentframe()
        caller_name = None if current_frame is None else current_frame.f_code.co_name
        self._hydrate(caller_method=caller_name)
        return self._client.await_offline_query_job(
...
class DatasetImpl(Dataset):
    ...
    def get_data_as_polars(
        ...
        return self.revisions[-1].get_data_as_polars(
            output_id=output_id, output_ts=output_ts, ignore_errors=ignore_errors
        )
    ...
    def to_pandas(self, output_id: bool = False, output_ts: bool = False, ignore_errors: bool = False) -> pd.DataFrame:
        return self.get_data_as_pandas(output_id=output_id, output_ts=output_ts, ignore_errors=ignore_errors)
