#!/Users/jjung15/miniconda3/bin/python
...
#    arg=arg_str.split()
    ...
    f_sw="SW_cond.txt"
#    test=open(f_sw,"w")
#    test.write("1967 1 0 00 2 -2 -5 -400 0 0 10 2 10 6\n")
...
if __name__ == "__main__":
    import sys
    # If A.py is executed directly, call main_function with command-line arguments
    main(*sys.argv[1:])