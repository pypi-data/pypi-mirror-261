...
class Publish(ConfigChapter):
    ...
    def from_yaml(cls, input_dict):
        ...
        if not publisher.tls_pkcs12 and (not publisher.tls_key or not publisher.tls_certificate):
