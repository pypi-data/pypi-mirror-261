...
class OsIndicateControl(IntEnumMember):
...
class IndicateRequest(IRequest):
    """OS Indicate request class."""

    __slots__ = ('_control',)

    def __init__(self, nadr: int, control: OsIndicateControl, hwpid: int = dpa_constants.HWPID_MAX,
                 dpa_rsp_time: Optional[float] = None, dev_process_time: Optional[float] = None,
                 msgid: Optional[str] = None):
        """Indicate request constructor.

        Args:
            nadr (int): Device address.
            control (IndicateControl): Indicate control param.
        ...
        super().__init__(
            ...
            pcmd=OSRequestCommands.INDICATE,
    ...
    @property
    def control(self) -> OsIndicateControl:
        """:obj:`IndicateControl`: OS Indicate control parameter.
    ...
    @control.setter
    def control(self, value: OsIndicateControl):
        self._control = value
    ...
    def to_dpa(self, mutable: bool = False) -> Union[bytes, bytearray]:
        ...
        """
        self._pdata = [self._control.value]
    ...
    def to_json(self) -> dict:
        ...
        """
        self._params = {'control': self._control.value}
