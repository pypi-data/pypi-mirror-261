...
def hide_show(
    ...
    :type action: typing.Optional[typing.Any]
    :param area: Visibility Area, Which vertices to hide or show * ``OUTSIDE`` Outside -- Hide or show vertices outside the selection. * ``Inside`` Inside -- Hide or show vertices inside the selection.
