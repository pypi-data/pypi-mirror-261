...
from lxdbapi.types import javaTypetoNative, nativeToParamType, LXARRAY, typed_value_2_native, native_2_typed_value
            ...
            if value.scalar_value.null:
                ...
                if data_type[1] is not None:
                    ...
                    if isinstance(val, datetime.datetime):
                        val = val.astimezone(self._connection.tzinfo)
