class qStatistics:
    ...
    def sigma_mean(self,n):
        return self.Ts.sigma_mean(n,self.P)

    def sigmaij_mean(self,n):
        return self.sigmaij_mean(n,self.P)

    def RMSE(self,vect1, vect2,n):
        return self.np.sqrt(sum((vect1-vect2)**2))/n