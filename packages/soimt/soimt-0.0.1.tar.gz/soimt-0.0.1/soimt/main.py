...
'''
def optic_img_test(testcalss, datapath, model, datatransform):
    if testcalss == 'cloud':
        from adversarial_attack_for_optical import adversarial_cloud_attack
        adversarial_cloud_attack.load_data_cloud(datapath, model, datatransform)

    if testcalss == 'blur':
        from adversarial_attack_for_optical import adversarial_blur_attack
        adversarial_blur_attack.load_data_blur(datapath, model, datatransform)

def SAR_img_test(testcalss, datapath, model):
    if testcalss == 'onescatter':
        from adversarial_attack_for_SAR.point_attack import yym_seg_1_point_20231004
        print("----------generating disturbed dataset----------")
        yym_seg_1_point_20231004.one_point(datapath, saved_path, segment_path, model)
        print("----------generating disturbed dataset complete----------")
        yym_seg_1_point_20231004.start_attack(model)
    if testcalss == 'threescatter':
        from adversarial_attack_for_SAR.point_attack import yym_seg_3_point_20231004
        print("----------generating disturbed dataset----------")
        yym_seg_3_point_20231004.one_point(datapath, saved_path, segment_path, model)
        print("----------generating disturbed dataset complete----------")
        yym_seg_3_point_20231004.start_attack(model)
    if testcalss == 'fivescatter':
        from adversarial_attack_for_SAR.point_attack import yym_seg_5_point_20231004
        print("----------generating disturbed dataset----------")
        yym_seg_5_point_20231004.one_point(datapath, saved_path, segment_path, model)
        print("----------generating disturbed dataset complete----------")
        yym_seg_5_point_20231004.start_attack(model)

    if testcalss == 'patch':
        from adversarial_attack_for_SAR.sticker_attack import yym_attack_five_models_20230919
        print("----------generating disturbed dataset----------")
        yym_attack_five_models_20230919.attack_model(datapath, model)
