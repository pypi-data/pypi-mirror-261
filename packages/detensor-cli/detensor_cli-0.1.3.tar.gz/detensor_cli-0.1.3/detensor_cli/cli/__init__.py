...
from detensor_cli import _, __version__
from detensor_cli.handlers import draw_logo
...
async def cli(ctx: click.Context):
    ...
    # {ref}`CLIMainGroup.get_command <detensor_cli.cli.customize.CLIMainGroup.get_command>`
    ...
    click.echo("\n\b")
    click.secho(_("Welcome to DeTensor CLI!"), fg="green", bold=True)
...
from .commands import test_execution, self, create_dev, driver,create_pro

cli.add_command(create_dev)
cli.add_command(create_pro)
