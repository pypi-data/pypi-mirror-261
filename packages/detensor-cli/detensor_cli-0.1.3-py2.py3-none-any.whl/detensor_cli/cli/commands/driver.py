...
from detensor_cli.cli.utils import find_exact_package
from detensor_cli.cli import CLI_DEFAULT_STYLE, ClickAliasedGroup, run_sync, run_async
...
async def uninstall(
    ...
    if package := driver.project_link:
        if package.startswith("mpcc[") and package.endswith("]"):
            package = package[9:-1]
