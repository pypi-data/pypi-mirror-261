    ...
    def submit(self) -> Tuple[bool, str]:
        ...
        for service, service_submission in self.serviceowner_submission.items():
            ...
            if service_submission.get("readme"):
                ...
                response = requests.post(SUBMIT_SERVICEOWNER_DOCS_PATH, files=files, headers={"Authorization": auth})
                if response.status_code == 201:
                ...
                if response.status_code == 200:
                    ...
                    print(f"Failed to submit README with status code: `{response.status_code}`.")
