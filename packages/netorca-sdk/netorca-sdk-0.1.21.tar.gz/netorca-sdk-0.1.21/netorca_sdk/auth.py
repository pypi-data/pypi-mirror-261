...
from netorca_sdk.exceptions import NetorcaException, NetorcaAPIError, NetorcaNotFoundError, NetorcaAuthenticationError, \
    NetorcaGatewayError, NetorcaServerUnavailableError
...
class NetorcaAuth(AbstractNetorcaAuth):
    ...
    def get_teams_info(self) -> list:
        ...
        if response.status_code == 200:
            ...
            raise NetorcaAPIError(f"Access denied.")
