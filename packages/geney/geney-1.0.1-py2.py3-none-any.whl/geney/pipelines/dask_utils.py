...
from geney.utils import contains
import warnings
import gc
import pandas as pd
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--results_directory', '-r', required=True, help='result directory')
    parser.add_argument('--num_workers', '-n', required=False, help='number of dask workers to recruit', default=10)
    parser.add_argument('--worker_size', '-m', required=False, help='dask worker memory allocation', default="3GB")
