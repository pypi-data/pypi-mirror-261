...
class StockInfo:
    def __init__(self, data, ticker):
        ...
        self.dividendDate = data.get('dividendDate')
        self.dividendAmount = float(data.get('dividendAmount'))
        ...
        self.mid = float(data.get('mid'))
        self.bidSize = float(data.get('bidSize'))
        self.askSize = float(data.get('askSize'))
        self.optVol = float(data.get('optVol'))
        self.stockVol = float(data.get('stockVol'))
        self.ivx7 = float(data.get('ivx7'))
        self.ivx14 = float(data.get('ivx14'))
        self.ivx21 = float(data.get('ivx21'))
        self.ivx30 = float(data.get('ivx30'))
        self.ivx60 = float(data.get('ivx60'))
        self.ivx90 = float(data.get('ivx90'))
        self.ivx120 = float(data.get('ivx120'))
        self.ivx150 = float(data.get('ivx150'))
        self.ivx180 = float(data.get('ivx180'))
        self.ivx270 = float(data.get('ivx270'))
        self.ivx360 = float(data.get('ivx360'))
        self.ivx720 = float(data.get('ivx720'))
        self.ivx1080 = float(data.get('ivx1080'))
        self.ivx7Chg = float(data.get('ivx7Chg'))
        self.ivx14Chg = float(data.get('ivx14Chg'))
        self.ivx21Chg = float(data.get('ivx21Chg'))
        self.ivx30Chg = float(data.get('ivx30Chg'))
        ...
        self.corr90D = float(data.get('corr90D'))
        self.corr120D = float(data.get('corr120D'))
        self.corr150D = float(data.get('corr150D'))
        self.corr180D = float(data.get('corr180D'))
        self.outstandingShares = float(data.get('outstandingShares'))
        self.marketCap = float(data.get('marketCap'))
        self.updateDate = data.get('updateDate')
        self.atClose = data.get('atClose')
        self.currency = data.get('currency')
        self.lastDate = data.get('lastDate')
        self.eps = data.get('eps')
        self.pe = data.get('pe')
        self.industry = data.get('industry')
        self.ivp30 = data.get('ivp30')
        self.ivp60 = data.get('ivp60')
        self.ivp90 = data.get('ivp90')
        self.sentiment = data.get('sentiment')
        self.volatileRank = data.get('volatileRank')
        self.ivr30 = data.get('ivr30')
        self.ivr60 = data.get('ivr60')
        self.ivr90 = data.get('ivr90')
        self.ivr120 = data.get('ivr120')
        self.ivr150 = data.get('ivr150')
        self.ivr180 = data.get('ivr180')
        self.avgOptVol1MO = data.get('avgOptVol1MO')
        self.avgOptOI1MO = data.get('avgOptOI1MO')
