...
class Gsm:                                                                       # Gsm
    ...
    def sendRaw(self, data:bytes): # only the wait loop, no extra filtering      # Gsm
...
Mode 1 and 2 are relatively straightforward and airtight. Mode 3 is a little buggy in stdout and stderr.
