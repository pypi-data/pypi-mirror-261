...
__all__ = ["toNdArray", "toTensor", "toRange", "toList",
           ...
           "toAscii", "toHash", "toCsv", "toYaml", "toAudio", "toUnix", "toIso", "toYMD", "toLinks",
           "toMovingAvg", "toCm", "toPdf", "toDist", "toAngle", "idxsToNdArray", "toFileType"]
...
try: import pandas as pd; hasPandas = True
except: hasPandas = False
class toNdArray(BaseCli):                                                        # toNdArray
    blurb="Converts several data types to np.ndarray"                            # toNdArray
