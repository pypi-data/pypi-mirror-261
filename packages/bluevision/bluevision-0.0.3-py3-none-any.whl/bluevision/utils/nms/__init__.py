...
def non_maximum_suppression(prediction, conf_threshold=0.001, iou_threshold=0.3):
    ...
    outputs = torch.zeros((0, 6), device=prediction.device)
    x = prediction[0].transpose(0, -1)[xc[0]]  # confidence
