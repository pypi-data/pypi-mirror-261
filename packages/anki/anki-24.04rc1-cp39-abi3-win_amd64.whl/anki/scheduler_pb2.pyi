...
class FsrsBenchmarkRequest(google.protobuf.message.Message):
    ...
    @property
    def test_set(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FsrsItem]: ...
    def __init__(
        self,
        *,
        train_set: collections.abc.Iterable[global___FsrsItem] | None = ...,
        test_set: collections.abc.Iterable[global___FsrsItem] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["test_set", b"test_set", "train_set", b"train_set"]) -> None: ...
