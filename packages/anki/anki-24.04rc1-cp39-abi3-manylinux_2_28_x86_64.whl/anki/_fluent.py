...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 66, {"count": count})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 80, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 106, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        ...
        return self._translate(11, 108, {"reviews": reviews, "pct": pct})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 125, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 164, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 165, {"decks": decks})
...
Warning: This will require a one-way sync, and may mark existing notes as modified. '''
    ...
    def importing_notes_found_in_file2(self, notes: int) -> str:
        ...
        return self._translate(20, 78, {"notes": notes})
    ...
    def importing_notes_updated(self, count: int) -> str:
        ...
        return self._translate(20, 82, {"count": count})
...
mapping tool. '''
    ...
    def importing_processed_notes(self, count: int) -> str:
        ...
        return self._translate(20, 92, {"count": count})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 93, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 111, {"filename": filename})
...
After all devices are in sync, future reviews and added cards can be merged automatically. '''
    ...
    def sync_media_added_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Added: {$up}↑ {$down}↓ '''
        return self._translate(34, 20, {"up": up, "down": down})


    def sync_media_checked_count(self, count: int) -> str:
        r''' Checked: {$count} '''
        return self._translate(34, 21, {"count": count})
    ...
    def sync_media_removed_count(self, up: FluentVariable, down: FluentVariable) -> str:
        r''' Removed: {$up}↑ {$down}↓ '''
        return self._translate(34, 27, {"up": up, "down": down})
...
then using Check Database to shrink the file size down. ({$details}) '''
        return self._translate(34, 36, {"details": details})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 54)
    ...
    DECK_CONFIG_IGNORE_BEFORE = (11, 60)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 61)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 62)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 63)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 64)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 65)
    DECK_CONFIG_ITERATIONS = (11, 66)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 67)
    DECK_CONFIG_LEARNING_STEPS = (11, 68)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 69)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 70)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 71)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 72)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 73)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 74)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 75)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 76)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 77)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 78)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 79)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 80)
    DECK_CONFIG_NAME_PROMPT = (11, 81)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 82)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 83)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 84)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 85)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 86)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 87)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 88)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 89)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 90)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 91)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 92)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 93)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 94)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 95)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 96)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 97)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 98)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 99)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 100)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 101)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 102)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 103)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 104)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 105)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 106)
    DECK_CONFIG_ORDERING_TITLE = (11, 107)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 108)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 109)
    DECK_CONFIG_RELEARNING_STEPS = (11, 110)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 111)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 112)
    DECK_CONFIG_REMOVE_GROUP = (11, 113)
    DECK_CONFIG_RENAME_GROUP = (11, 114)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 115)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 116)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 117)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 118)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 119)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 120)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 121)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 122)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 123)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 124)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 125)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 126)
    DECK_CONFIG_SAVE_BUTTON = (11, 127)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 128)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 129)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 130)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 131)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 132)
    DECK_CONFIG_SHARED_PRESET = (11, 133)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 134)
    DECK_CONFIG_SHOW_REMINDER = (11, 135)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 136)
    DECK_CONFIG_SM2_RETENTION = (11, 137)
    DECK_CONFIG_SM2_RETENTION_TOOLTIP = (11, 138)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 139)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 140)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 141)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 142)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 143)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 144)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 145)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 146)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 147)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 148)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 149)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 150)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 151)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 152)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 153)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 154)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 155)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 156)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 157)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 158)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 159)
    DECK_CONFIG_TIMER_TITLE = (11, 160)
    DECK_CONFIG_TITLE = (11, 161)
    DECK_CONFIG_TODAY_ONLY = (11, 162)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 163)
    DECK_CONFIG_UPDATING_CARDS = (11, 164)
    DECK_CONFIG_USED_BY_DECKS = (11, 165)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 166)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 167)
    DECK_CONFIG_WEIGHTS = (11, 168)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 169)
    DECK_CONFIG_WHICH_DECK = (11, 170)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 171)
    ...
    IMPORTING_NOTE_UNCHANGED = (20, 72)
    IMPORTING_NOTE_UPDATED = (20, 73)
    IMPORTING_NOTE_UPDATED_AS_FILE_HAD_NEWER = (20, 74)
    IMPORTING_NOTES_ADDED = (20, 75)
    IMPORTING_NOTES_ADDED_FROM_FILE = (20, 76)
    IMPORTING_NOTES_FOUND_IN_FILE = (20, 77)
    IMPORTING_NOTES_FOUND_IN_FILE2 = (20, 78)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (20, 79)
    IMPORTING_NOTES_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 80)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (20, 81)
    IMPORTING_NOTES_UPDATED = (20, 82)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (20, 83)
    IMPORTING_NOTETYPE_AND_DECK = (20, 84)
    IMPORTING_NOTETYPE_HELP = (20, 85)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (20, 86)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (20, 87)
    IMPORTING_PIPE = (20, 88)
    IMPORTING_PRESERVE = (20, 89)
    IMPORTING_PROCESSED_CARDS = (20, 90)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 91)
    IMPORTING_PROCESSED_NOTES = (20, 92)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 93)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 94)
    IMPORTING_SEMICOLON = (20, 95)
    IMPORTING_SHOW = (20, 96)
    IMPORTING_SKIPPED = (20, 97)
    IMPORTING_STATUS = (20, 98)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 99)
    IMPORTING_TAB = (20, 100)
    IMPORTING_TAG_ALL_NOTES = (20, 101)
    IMPORTING_TAG_ALL_NOTES_HELP = (20, 102)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 103)
    IMPORTING_TAG_UPDATED_NOTES = (20, 104)
    IMPORTING_TAG_UPDATED_NOTES_HELP = (20, 105)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 106)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 107)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 108)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 109)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 110)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 111)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 112)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 113)
    IMPORTING_UPDATE = (20, 114)
    IMPORTING_UPDATE_ALWAYS = (20, 115)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 116)
    IMPORTING_UPDATE_IF_NEWER = (20, 117)
    IMPORTING_UPDATE_NEVER = (20, 118)
    IMPORTING_UPDATE_NOTES = (20, 119)
    IMPORTING_UPDATE_NOTES_HELP = (20, 120)
    IMPORTING_UPDATE_NOTETYPES = (20, 121)
    IMPORTING_UPDATE_NOTETYPES_HELP = (20, 122)
    IMPORTING_UPDATED = (20, 123)
    IMPORTING_UPDATES = (20, 124)
    IMPORTING_WITH_DECK_CONFIGS = (20, 125)
    IMPORTING_WITH_DECK_CONFIGS_HELP = (20, 126)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
    ...
    PREFERENCES_LOGIN_SUCCESSFUL_SYNC_NOW = (26, 30)
    PREFERENCES_MEDIA = (26, 31)
    PREFERENCES_MEDIA_IS_NOT_BACKED_UP = (26, 32)
    PREFERENCES_MINIMALIST_MODE = (26, 33)
    PREFERENCES_MINS = (26, 34)
    PREFERENCES_MINUTES_BETWEEN_BACKUPS = (26, 35)
    PREFERENCES_MONTHLY_BACKUPS = (26, 36)
    PREFERENCES_NETWORK = (26, 37)
    PREFERENCES_NETWORK_TIMEOUT = (26, 38)
    PREFERENCES_NEXT_DAY_STARTS_AT = (26, 39)
    PREFERENCES_NOT_LOGGED_IN = (26, 40)
    PREFERENCES_NOTE = (26, 41)
    PREFERENCES_ON_NEXT_SYNC_FORCE_CHANGES_IN = (26, 42)
    PREFERENCES_PASTE_CLIPBOARD_IMAGES_AS_PNG = (26, 43)
    PREFERENCES_PASTE_WITHOUT_SHIFT_KEY_STRIPS_FORMATTING = (26, 44)
    PREFERENCES_PERIODICALLY_SYNC_MEDIA = (26, 45)
    PREFERENCES_PLEASE_RESTART_ANKI_TO_COMPLETE_LANGUAGE = (26, 46)
    PREFERENCES_PREFERENCES = (26, 47)
    PREFERENCES_REDUCE_MOTION = (26, 48)
    PREFERENCES_REDUCE_MOTION_TOOLTIP = (26, 49)
    PREFERENCES_RESET_WINDOW_SIZES = (26, 50)
    PREFERENCES_RESET_WINDOW_SIZES_COMPLETE = (26, 51)
    PREFERENCES_REVIEW = (26, 52)
    PREFERENCES_REVIEWER = (26, 53)
    PREFERENCES_SCHEDULER = (26, 54)
    PREFERENCES_SCHEDULING = (26, 55)
    PREFERENCES_SHORTCUT_PLACEHOLDER = (26, 56)
    PREFERENCES_SHOW_LEARNING_CARDS_WITH_LARGER_STEPS = (26, 57)
    PREFERENCES_SHOW_NEXT_REVIEW_TIME_ABOVE_ANSWER = (26, 58)
    PREFERENCES_SHOW_PLAY_BUTTONS_ON_CARDS_WITH = (26, 59)
    PREFERENCES_SHOW_REMAINING_CARD_COUNT = (26, 60)
    PREFERENCES_SOME_SETTINGS_WILL_TAKE_EFFECT_AFTER = (26, 61)
    PREFERENCES_SPACEBAR_RATES_CARD = (26, 62)
    PREFERENCES_STYLE = (26, 63)
    ...
    SYNC_LOG_IN_BUTTON = (34, 16)
    SYNC_LOG_OUT_BUTTON = (34, 17)
    SYNC_MEDIA_ABORTED = (34, 18)
    SYNC_MEDIA_ABORTING = (34, 19)
    SYNC_MEDIA_ADDED_COUNT = (34, 20)
    SYNC_MEDIA_CHECKED_COUNT = (34, 21)
    SYNC_MEDIA_COMPLETE = (34, 22)
    SYNC_MEDIA_DISABLED = (34, 23)
    SYNC_MEDIA_FAILED = (34, 24)
    SYNC_MEDIA_LOG_BUTTON = (34, 25)
    SYNC_MEDIA_LOG_TITLE = (34, 26)
    SYNC_MEDIA_REMOVED_COUNT = (34, 27)
    SYNC_MEDIA_STARTING = (34, 28)
    SYNC_MUST_WAIT_FOR_END = (34, 29)
    SYNC_PASSWORD_LABEL = (34, 30)
    SYNC_RESYNC_REQUIRED = (34, 31)
    SYNC_SANITY_CHECK_FAILED = (34, 32)
    SYNC_SERVER_ERROR = (34, 33)
    SYNC_SYNCING = (34, 34)
    SYNC_UPLOAD_TO_ANKIWEB = (34, 35)
    SYNC_UPLOAD_TOO_LARGE = (34, 36)
    SYNC_UPLOADING_TO_ANKIWEB = (34, 37)
    SYNC_WRONG_PASS = (34, 38)
