...
class RustBackendGenerated:
 ...
 if the backup encountered an error."""
    ...
    def fsrs_benchmark(self, *, train_set: Iterable[anki.scheduler_pb2.FsrsItem], test_set: Iterable[anki.scheduler_pb2.FsrsItem]) -> Sequence[float]:
        """Generates parameters used for FSRS's scheduler benchmarks."""
        message = anki.scheduler_pb2.FsrsBenchmarkRequest(train_set=train_set, test_set=test_set)
