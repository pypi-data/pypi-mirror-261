...
class Sys:
    _hx_class_name = "Sys"
    __slots__ = ()
    _hx_statics = ["args", "environment", "getCwd", "setCwd", "systemName"]
...
class com_sdtk_api_API:
    ...
    def mappingValueToType(self,value):
        try:
            return python_lib_Json.loads(value,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
        except BaseException as _g:
            None
            return value
...
class com_sdtk_api_ACMAPI(com_sdtk_api_API):
    ...
    def events(callback,start):
        ...
        _this = _this1.split("-")
        def _hx_local_0(r):
            o = python_lib_Json.loads(r,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
            callback(o)
...
class com_sdtk_api_BTCAPI(com_sdtk_api_API):
    ...
    def transactions(callback,block,address,page):
        ...
        if (page is None):
            ...
            progress = None
            def _hx_local_1(r):
                r = python_lib_Json.loads(r,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
                arr.append(r)
...
class com_sdtk_api_BTCAPITransactions(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        callback(data,com_sdtk_table_ArrayOfObjectsReader.readWholeArray(Reflect.field(Reflect.field(python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"data"),"list")))
    _instance = None
        ...
        if (limit <= com_sdtk_api_BitTorrentAPI._maxLimit):
            def _hx_local_1(r):
                ...
                if (Reflect.field(Reflect.field(o,"data"),"length") == limit):
                    ...
                    def _hx_local_0(r):
                        o2 = python_lib_Json.loads(r,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
            ...
            while (i < limit):
                def _hx_local_5(k):
                    def _hx_local_2(r):
                        ...
                        loaded = (loaded + 1)
                        if (loaded == cnt):
                            r = python_lib_Json.loads((arr[0] if 0 < len(arr) else None),**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
                            r.data = []
                            _g = 0
                            while (_g < len(arr)):
                                s = (arr[_g] if _g >= 0 and _g < len(arr) else None)
                                _g = (_g + 1)
                                o = python_lib_Json.loads(s,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
...
class com_sdtk_api_BitTorrentAPITransactions(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        callback(data,com_sdtk_table_ArrayOfObjectsReader.readWholeArray(Reflect.field(python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"data")))
    _instance = None
...
class com_sdtk_api_BitTorrentAPITransfers(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        callback(data,com_sdtk_table_ArrayOfObjectsReader.readWholeArray(Reflect.field(python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"token_transfers")))
    _instance = None
...
class com_sdtk_api_CustomWebAPI(com_sdtk_api_API):
    ...
    def singleFromJSON(json):
        return com_sdtk_api_CustomWebAPI.fromMap(python_lib_Json.loads(json,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))))

    @staticmethod
    def multipleFromJSON(json):
        return com_sdtk_api_CustomWebAPI.fromMaps(python_lib_Json.loads(json,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))))
...
class com_sdtk_api_EtherscanAPITransactions(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        callback(data,com_sdtk_table_ArrayOfObjectsReader.readWholeArray(Reflect.field(python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"result")))
    _instance = None
...
class com_sdtk_api_ExecutorAPI(com_sdtk_api_API):
    ...
    def execute(self,script,mapping,callback):
        callback(None)
...
class com_sdtk_api_GitAPIFiles(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        callback(data,com_sdtk_table_ArrayOfObjectsReader.readWholeArray(Reflect.field(python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"tree")))
...
class com_sdtk_api_GitAPIRepos(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        callback(data,com_sdtk_table_ArrayOfObjectsReader.readWholeArray(python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))))
    _instance = None
...
class com_sdtk_api_GitAPIBranches(com_sdtk_api_InputAPI):
    ...
    def parseData(self,data,mapping,callback):
        arr = python_lib_Json.loads(data,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
        _g = 0
        while (_g < len(arr)):
            o = (arr[_g] if _g >= 0 and _g < len(arr) else None)
            _g = (_g + 1)
...
class com_sdtk_api_GitAPIRetrieveAll(com_sdtk_api_InputAPI):
    ...
    def retrieveData(self,mapping,callback):
        mapping = self.normalizeMapping(mapping)
        def _hx_local_3(r):
            arr = Reflect.field(python_lib_Json.loads(r,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"tree")
...
class com_sdtk_api_TableauAPI(com_sdtk_api_API):
    ...
    def login(callback,user,password,site):
        ...
        if (((user == instance._user) and ((site == instance._site))) and ((instance._token is not None))):
            ...
            def _hx_local_0(response):
                instance._token = Reflect.field(Reflect.field(python_lib_Json.loads(response,**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon}))),"credentials"),"token")
                instance._user = user
                instance._site = site
                callback(response)
...
class com_sdtk_std_Normalize:
    ...
    def nativeToHaxe(mapping):
        if Std.isOfType(mapping,haxe_ds_StringMap):
            return mapping
    ...
    def readAll(self,rReader,aMaps,aNames):
        ...
        if Std.isOfType(dData,list):
            ...
            while (_g < len(aValues)):
                ...
                _g = (_g + 1)
                x = com_sdtk_table_JSONHandler.buildMap(value)
                aMaps.append(x)
                x1 = (len(aMaps) - 1)
                aNames.append(x1)
        else:
...
com_sdtk_std_Version._code = "0.2.2"
