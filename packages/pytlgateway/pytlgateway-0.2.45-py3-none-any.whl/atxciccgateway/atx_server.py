...
class atxServer(MongoClientTradeGateway):
    ...
    def req_order_insert(self, obj, isBuy=True):
        ...
        if algo_type == 105:
            ...
            if price == 0:
                trade_param += f':maxpercentageF={participate}:pricepercentageF={price_percentage}'
            else:
                trade_param += f':maxpercentageF={participate}:pricepercentageF={price_percentage}:priceF={price}'
