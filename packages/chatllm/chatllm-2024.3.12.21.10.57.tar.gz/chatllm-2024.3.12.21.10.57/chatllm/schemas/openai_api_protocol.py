...
class ChatCompletionRequest(BaseModel):
    ...
    def __init__(__pydantic_self__, **data):
        ...
        if file_ids := __pydantic_self__.file_ids or __pydantic_self__.refs:
            __pydantic_self__.file_ids = file_ids
            __pydantic_self__.refs = file_ids

        if use_search := __pydantic_self__.use_search or __pydantic_self__.search:
            __pydantic_self__.search = use_search
            __pydantic_self__.use_search = use_search
