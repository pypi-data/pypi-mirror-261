...
class Scribe: 
    def __init__(self, _report_path):
        ...
        self.page_template = self.f_read(_filename=self.path+"/templates/page_template.html")
        self.scribble_template = self.f_read(_filename=self.path+"/templates/scribble_template.html")
        self.scribe_count = 0
