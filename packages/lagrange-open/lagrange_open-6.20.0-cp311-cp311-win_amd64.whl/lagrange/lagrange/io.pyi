...
def load_scene(*args, **kwargs):
    """
    load_scene(filename: os.PathLike, options: lagrange.io.LoadOptions = <lagrange.io.LoadOptions object at 0x000001E70FCD7810>) -> lagrange.scene.Scene
...
def save_scene(*args, **kwargs):
    """
    save_scene(filename: os.PathLike, scene: lagrange.scene.Scene, options: lagrange.io.SaveOptions = <lagrange.io.SaveOptions object at 0x000001E70FCD7870>) -> None
