...
'''
#Code Running Warning Start
print('---------Leon Random Plus Warning---------')
print('This code is not this use for!')
print('You should use this code on your code!')
print('To use it,code "import leonranp"')
print('------------------------------------------')
#Code Running Warning End
from random import *
#Start Code#
...
def randcode(hmuch):
    ...
    return randcode
#randbool:if you want to print on,code "print(randbool())"
