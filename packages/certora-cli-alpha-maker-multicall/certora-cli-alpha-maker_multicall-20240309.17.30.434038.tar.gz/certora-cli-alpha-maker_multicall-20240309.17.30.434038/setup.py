...
setuptools.setup(
    name="certora-cli-alpha-maker_multicall",
    version="20240309.17.30.434038",
    author="Certora",
    author_email="support@certora.com",
    description="Runner for the Certora Prover",
    long_description="Commit 86a2051.                    Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
    long_description_content_type="text/markdown",
    url="https://pypi.org/project/certora-cli-alpha-maker_multicall",
