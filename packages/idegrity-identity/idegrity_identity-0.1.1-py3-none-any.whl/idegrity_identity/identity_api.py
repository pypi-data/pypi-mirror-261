...
class IdentityAPI:
    ...
    def __init__(
        ...
        key: str,
        key_secret: str,
        endpoint_url: str = "http://api.idegrity.com/verify",
        ...
        Parameters:
            ...
            key (str): The API key for authentication.
            key_secret (str): The API key secret for authentication.
            endpoint_url (str): The URL of the verification endpoint. Defaults to "http://dev.mbti.io:8000/verify".
    ...
    def verify_images(
        ...
        try:
            response = requests.post(
                self.endpoint_url, files=files, headers=headers, timeout=self.timeout
            )
