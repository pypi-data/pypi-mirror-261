...
class DockerImage(collections.namedtuple('DockerImage', 'registry team artifact tag')):
    ...
    def is_zcr_registry(self) -> bool:
        ...
        """
        return (
            self.registry == "container-registry.zalando.net"
            or self.registry == "container-registry-test.zalando.net"
            or self.registry.endswith(".container-registry.zalando.net")
            or self.registry.endswith(".container-registry-test.zalando.net")
        )
