...
VariableValue = Optional[Union[str, VariableValueDict]]
"""
...
VariableFact = TypedDict("VariableFact", {"name": str, "args": Sequence[VariableValue]})
"""
Variable facts allow for wildcards -- expressed by ommitting ID and/or type arguments
...
OutputValue = TypedDict("OutputValue", {"type": str, "id": str}, total=True)
OutputFact = TypedDict("OutputFact", {"name": str, "args": Sequence[OutputValue]})
"""
