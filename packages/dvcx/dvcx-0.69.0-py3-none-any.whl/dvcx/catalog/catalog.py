...
class Catalog:
    ...
    def create_dataset(
        ...
        version = version or dataset.next_version
        if not dataset.is_valid_next_version(version):
    ...
    def register_shadow_dataset(
        ...
        if registered_dataset:
            ...
            registered_dataset = self.metastore.create_dataset_version(
                ...
                error_stack=dataset.error_stack,
                script_output=dataset.script_output,
    ...
    def merge_datasets(
        ...
        If destination dataset is registered, it will create new version
        ...
        if dst.shadow or dst.has_version(dst_version):  # type: ignore[arg-type]
