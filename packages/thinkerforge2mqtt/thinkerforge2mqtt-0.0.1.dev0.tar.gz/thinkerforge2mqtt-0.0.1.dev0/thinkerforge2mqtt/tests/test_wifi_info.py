...
from thinkerforge2mqtt.wifi_info import (
    WifiInfo,
    WifiInfoValue,
...
class WifiInfoTestCase(TestCase):
    def test_get_iwconfig_values(self):
        ...
        with (
            patch('thinkerforge2mqtt.wifi_info.verbose_check_output', return_value=mocked_output),
            self.assertLogs('thinkerforge2mqtt', level=logging.DEBUG),
        ):
    ...
    def test_get_wifi_info(self):
        ...
        with (
            patch('thinkerforge2mqtt.wifi_info.verbose_check_output', return_value=mocked_output),
            self.assertLogs('thinkerforge2mqtt'),
        ):
    ...
    def test_get_wifi_info_ha_values(self):
        ...
        with patch('thinkerforge2mqtt.wifi_info.get_wifi_infos', return_value=mocked_wifi_info):
