...
def install():
    """
    Run pip-sync and install 'thinkerforge2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(
        module=thinkerforge2mqtt,
        package_path=PACKAGE_ROOT,
        distribution_name='thinkerforge2mqtt',
    )
...
def fix_code_style(color: bool, verbosity: int):
    """
    Fix code style of all thinkerforge2mqtt source code files via darker
    """
