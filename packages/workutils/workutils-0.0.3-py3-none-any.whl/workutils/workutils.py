...
def main():
    ...
    parser.add_argument("-k", "--keywords", type=str,
                        help="Count Keywords in all files, such as keyword1,keyword2,keyword3")
        ...
        try:
            with open(result_file, "w") as f:
                for file in files:
                    f.write(file + "\n")
                if list_keywords:
                    f.write("\nKeyword             File Name           Keyword Matches\n")
                    f.write("-" * 50)
                    f.write("\n")
                    for file_path, counts in keyword_results:
                        ...
                        for keyword, matches in counts.items():
                            if matches > 0:
                                f.write(f"{keyword:<20}{file_name:<20}{matches}\n")
                    f.write("-" * 50)
