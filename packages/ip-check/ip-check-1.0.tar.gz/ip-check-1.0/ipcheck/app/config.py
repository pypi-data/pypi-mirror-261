...
class Config(CommonConfig):
    ...
    def __init__(self, config_path):
        ...
        # 可用性检测域名
        self.vt_host_name = 'unknown'
        # 可用性检测路径, 固定的，取决于cloudflare
        self.vt_path = '/unknown'
        # 可用性测试多线程数量
        ...
        # 测试下载文件的域名
        self.st_host_name = 'unknown'
        # 测试下载文件的路径
        self.st_file_path = '/unknown.bin'
        # 下载测试时网络请求的重试次数
        self.st_max_retry = 2
    ...
    def get_valid_test_config(self):
        return ValidTestConfig(self)

    def get_rtt_test_config(self):
        return RttTestConfig(self)

    def get_speed_test_config(self):
