...
class ExtractPipelineExecutionOverview(object):
    ...
    def __init__(self, pipeline_run_id=None, pipeline_execution_date=None, pipeline_execution_status=None, execution_details=None, pending_entities=None, run_start=None, run_end=None, run_duration_seconds=None, error_details=None):  # noqa: E501
