...
class Issue:
    ...
    def synch.summary_from_miror(self):
        self.summary = self.miror.summary
        # Il faut juste qu'il update summary et non pas description aussi et tout !
        self.update()

    def synch.summary_to_miror(self):
        self.miror.summary = self.summary
        self.update()

    def synch.description_from_miror(self):
        self.description = self.miror.description
        self.update()

    def synch.description_to_miror(self):
