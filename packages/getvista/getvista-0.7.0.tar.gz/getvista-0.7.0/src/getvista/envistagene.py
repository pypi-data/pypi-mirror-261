...
def pipmaker(genes, genomic_coordinates, apply_reverse_complement, nocut, all_transcripts):
    ...
    coordinates_content1 = remove_surrounded_empty_lines(coordinates_content)
    coordinates_content2 = remove_empty_lines(coordinates_content1)

    return coordinates_content2, sequence_length
...
def useflanks(species, genes, genomic_coordinates, flank):
    ...
    while True:      
        ...
        if gene_name_input2.lower() in gene_end_positions_lower:
            ...
            end_coordinate = gene_end_positions[original_gene_name2]
            if flank == "in":
