...
class UserUpdate(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_active": IsActive.from_dict(obj["is_active"]) if obj.get("is_active") is not None else None,
            "is_superuser": IsSuperuser.from_dict(obj["is_superuser"]) if obj.get("is_superuser") is not None else None,
            "full_name": FullName.from_dict(obj["full_name"]) if obj.get("full_name") is not None else None,
