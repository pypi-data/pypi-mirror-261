...
class datapull:
    ...
    print("Hello this will be our data pull for macro, seasonal and weather varibles") 
    
class datavalidation:

    print("Hello this will be our data validation, here we are hoping to take the dataset and convert it into a data validation HTML file that can be sent to clients") 
