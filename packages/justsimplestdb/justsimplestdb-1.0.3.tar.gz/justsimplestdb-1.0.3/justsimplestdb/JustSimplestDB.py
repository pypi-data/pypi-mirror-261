...
class Instance:
    def __init__(self, file_to_read: owntypes.FileName, do_save_txt_as_db: bool = False) -> None:
        """
    ...
    def read_it_like_db(self) -> owntypes.StructurisedListLikeDBObject:
        ...
        DO NOT edit provided file with IDE, because TABs in them are interpreted as several spaces instead as TAB.
        """
        #end
