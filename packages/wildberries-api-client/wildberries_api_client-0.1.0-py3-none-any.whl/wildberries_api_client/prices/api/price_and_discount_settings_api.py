...
class PriceAndDiscountSettingsApi(object):
    ...
    def api_v2_upload_task_post(self, body, **kwargs):  # noqa: E501
        """Set price and discounts  # noqa: E501

        Sets product prices and discounts   # noqa: E501
    ...
    def api_v2_upload_task_size_post(self, body, **kwargs):  # noqa: E501
        """Sets size prices  # noqa: E501

        Set different prices for different sizes. Only for products from categories where size price setting is available. For these products `editableSizePrice: true` in [Get product sizes](./#tag/Product-lists/paths/~1api~1v2~1list~1goods~1size~1nm/get) response.       # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
