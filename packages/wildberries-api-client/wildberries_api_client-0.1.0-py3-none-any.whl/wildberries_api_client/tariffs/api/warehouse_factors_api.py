...
class WarehouseFactorsApi(object):
    ...
    def api_v1_tariffs_box_get(self, _date, **kwargs):  # noqa: E501
        """Box tariffs  # noqa: E501

        <p>Returns the cost:</p> <ul>   <li>of delivery from Wildberries warehouse or sorting center to the buyer,</li>   <li>of delivery from the buyer to the sorting center,</li>   <li>of storage on Wildberries warehouse.</li> </ul> <p>For products that you supply in boxes.</p> <p>Maximum 60 requests per minute.</p>   # noqa: E501
        ...
        :param str _date: Date, YYYY-MM-DD (required)
    ...
    def api_v1_tariffs_pallet_get(self, _date, **kwargs):  # noqa: E501
        """Pallet tariffs  # noqa: E501

        <p>Returns the cost:</p> <ul>   <li>of delivery from Wildberries warehouse to the buyer,</li>   <li>of delivery from the buyer to Wildberries warehouse,</li>   <li>of storage on Wildberries warehouse.</li> </ul> <p>For products that you supply on pallets.</p> <p>Maximum 60 requests per minute.</p>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
