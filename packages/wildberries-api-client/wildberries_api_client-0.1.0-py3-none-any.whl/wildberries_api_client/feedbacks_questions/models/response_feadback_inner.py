...
class ResponseFeadbackInner(object):
    ...
    def __init__(self, id=None, text=None, user_name=None, matching_size=None, product_valuation=None, created_date=None, state=None, answer=None, product_details=None, photo_links=None, video=None, was_viewed=None):  # noqa: E501
