...
class ResponseInfoAdvert(object):
    ...
    def type(self):
        ...
        <dl> <dt>Type of campaign:</dt> <dd><code>4</code> - campaign in catalogue</dd> <dd><code>5</code> - campaign in content</dd> <dd><code>6</code> - campaign in search</dd> <dd><code>7</code> - campaign on main page recommendations</dd> </dl>               # noqa: E501
    ...
    def daily_budget(self):
        ...
        Daily budget; 0 if not set  # noqa: E501
    ...
    def search_pluse_state(self):
        ...
        Fixed Phrase Activity  (campaign in search)  <br> (<code>true</code> - active or <code>false</code> - inactive)   # noqa: E501
