...
class SeacatSaveadBody(object):
    ...
    def nms(self):
        ...
        Nomenclature for this campaign. You can available nomenclatures with [Nomenclatures for campaigns](./#tag/Dictionaries/paths/~1adv~1v2~1supplier~1nms/post) method. Maximum 50 products (`nm`)   # noqa: E501
