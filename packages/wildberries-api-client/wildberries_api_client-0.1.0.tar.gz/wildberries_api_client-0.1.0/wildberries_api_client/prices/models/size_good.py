...
class SizeGood(object):
    ...
    def size_id(self):
        ...
        Size ID. You can get this ID with [Get products](./#tag/Product-lists/paths/~1api~1v2~1list~1goods~1filter/get) method, field `sizeID`. In content methods this is `chrtID` field  # noqa: E501
    ...
    def currency_iso_code4217(self):
        ...
        Currency, according to ISO 4217  # noqa: E501
    ...
    def editable_size_price(self):
        ...
        Setting of size prices: `true` — available, `false` — unavailable. Depends on product category   # noqa: E501
