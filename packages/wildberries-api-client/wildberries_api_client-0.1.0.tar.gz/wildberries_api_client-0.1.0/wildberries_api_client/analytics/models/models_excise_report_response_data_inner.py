...
class ModelsExciseReportResponseDataInner(object):
    ...
    def operation_type_id(self):
        ...
        Operation type, if exists:    * `1` — withdraw from circulation   * `2` — return to sale   # noqa: E501
    ...
    def fiscal_doc_number(self):
        ...
        Receipt number, if exists   # noqa: E501
    ...
    def fiscal_dt(self):
        ...
        Date in the receipt, if exists, YYYY-MM-DD  # noqa: E501
    ...
    def fiscal_drive_number(self):
        ...
        Fiscal storage number, if exists   # noqa: E501
