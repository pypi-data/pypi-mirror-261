...
class NmReportGroupedResponseDataPeriodComparisonConversions(object):
    ...
    def __init__(self, add_to_cart_percent=None, cart_to_order_percent=None, buyouts_percent=None):  # noqa: E501
        """NmReportGroupedResponseDataPeriodComparisonConversions - a model defined in Swagger"""  # noqa: E501
    ...
    def add_to_cart_percent(self):
        """Gets the add_to_cart_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501

        Conversion to cart, % (What percentage of visitors, who opened the product card, added the product to the cart)  # noqa: E501

        :return: The add_to_cart_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        :rtype: int
        """
    ...
    def add_to_cart_percent(self, add_to_cart_percent):
        """Sets the add_to_cart_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.

        Conversion to cart, % (What percentage of visitors, who opened the product card, added the product to the cart)  # noqa: E501

        :param add_to_cart_percent: The add_to_cart_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        :type: int
        """
    ...
    def cart_to_order_percent(self):
        """Gets the cart_to_order_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501

        Conversion to order, % (What percentage of visitors, who added the product to the cart, placed an order)  # noqa: E501

        :return: The cart_to_order_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        :rtype: int
        """
    ...
    def cart_to_order_percent(self, cart_to_order_percent):
        """Sets the cart_to_order_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.

        Conversion to order, % (What percentage of visitors, who added the product to the cart, placed an order)  # noqa: E501

        :param cart_to_order_percent: The cart_to_order_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        :type: int
        """
    ...
    def buyouts_percent(self):
        """Gets the buyouts_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        ...
        :return: The buyouts_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        :rtype: int
        """
    ...
    def buyouts_percent(self, buyouts_percent):
        """Sets the buyouts_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.

        Buyout percentage, % (What percentage of visitors, who ordered the product, actually purchased it. Excluding products still being delivered to the buyer)  # noqa: E501

        :param buyouts_percent: The buyouts_percent of this NmReportGroupedResponseDataPeriodComparisonConversions.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NmReportGroupedResponseDataPeriodComparisonConversions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NmReportGroupedResponseDataPeriodComparisonConversions):
            return False
