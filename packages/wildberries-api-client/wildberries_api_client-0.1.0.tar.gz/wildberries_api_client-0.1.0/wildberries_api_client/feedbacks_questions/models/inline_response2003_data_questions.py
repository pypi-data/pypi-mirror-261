...
class InlineResponse2003DataQuestions(object):
    ...
    def created_date(self):
        ...
        Date and time the question was created  # noqa: E501
    ...
    def state(self):
        ...
        <dt>Question status:</dt> <dd>`none` - question rejected by seller (this question doesn't appear on the buyer portal)</dd> <dd>`wbRu` - answer provided, the question is displayed on the buyers site</dd> <dd>`suppliersPortalSynch` - new question</dd>   # noqa: E501
    ...
    def was_viewed(self):
        ...
        Check that question was viewed  # noqa: E501
