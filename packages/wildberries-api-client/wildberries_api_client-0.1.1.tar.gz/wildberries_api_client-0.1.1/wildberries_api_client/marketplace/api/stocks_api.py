...
class StocksApi(object):
    ...
    def api_v3_stocks_warehouse_id_delete(self, body, warehouse_id, **kwargs):  # noqa: E501
        """Delete stocks  # noqa: E501

        Deletes the supplier's stocks. **Caution! This action is irreversible**. Deleted stock will require re-uploading to continue sales.  # noqa: E501
        ...
        :param int warehouse_id: The supplier's warehouse ID (required)
        :return: None
    ...
    def api_v3_stocks_warehouse_id_post(self, body, warehouse_id, **kwargs):  # noqa: E501
        """Get stocks  # noqa: E501

        Returns the supplier's stocks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def api_v3_stocks_warehouse_id_put(self, warehouse_id, **kwargs):  # noqa: E501
        """Update stocks  # noqa: E501

        Updates the supplier's stocks.<br> `Important!` The names of the query parameters are not validated. If invalid names are sent, the response will be successful(204), but the remaining amounts will not be updated.<br> Check the data carefully before submitting it.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
