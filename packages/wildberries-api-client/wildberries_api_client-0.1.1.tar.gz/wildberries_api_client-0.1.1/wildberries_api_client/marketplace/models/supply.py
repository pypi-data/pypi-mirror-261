...
class Supply(object):
    ...
    def done(self):
        ...
        An indication that the supply is closed  # noqa: E501
    ...
    def created_at(self):
        ...
        Supply creation date (RFC3339)  # noqa: E501
    ...
    def closed_at(self):
        ...
        Supply close date (RFC3339)  # noqa: E501
    ...
    def scan_dt(self):
        ...
        Supply scan date (RFC3339)  # noqa: E501
    ...
    def cargo_type(self):
        ...
        <dl> <dt>Type of cargo in the supply:</dt> <dd>0 - not defined</dd> <dd>1 - normal</dd> <dd>2 - ODC</dd> <dd>3 - CD. Not currently in use.</dd> </dl>   # noqa: E501
