...
def load_ccat():
    ...
    if 'Linux' in platform.system():
        ...
        # 如果是arm64架构，使用libcatclient.dylib
        if 'arm64' in platform.machine():
            return ffi.dlopen(os.path.join(path, "lib/darwin/libcatclient_arm64.dylib"))
        # 如果是x86_64架构，使用libcatclient_x86_64.dylib
        else:
...
class catSdk(object):
    ...
    def cat_client_destroy(self):
        ccat.catClientDestroy()
