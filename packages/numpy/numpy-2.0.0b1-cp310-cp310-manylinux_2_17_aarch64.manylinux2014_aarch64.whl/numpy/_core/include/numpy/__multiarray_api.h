...
NPY_NO_EXPORT  void NpyString_acquire_allocators \
       (size_t, PyArray_Descr *descrs[], npy_string_allocator *allocators[]);
...
#define NpyString_acquire_allocator \
        (*(npy_string_allocator * (*)(PyArray_StringDTypeObject *)) \
    PyArray_API[316])
#endif

#if NPY_FEATURE_VERSION >= NPY_2_0_API_VERSION
#define NpyString_acquire_allocators \
        (*(void (*)(size_t, PyArray_Descr *descrs[], npy_string_allocator *allocators[])) \
    PyArray_API[317])
#endif
...
#define _PyDataType_GetArrFuncs \
        (*(PyArray_ArrFuncs * (*)(PyArray_Descr *)) \
    PyArray_API[365])
