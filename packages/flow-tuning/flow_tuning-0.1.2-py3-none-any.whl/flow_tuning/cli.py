...
@app.command(short_help='Function Tuning')
def function(
    config_path: Annotated[
        str, typer.Option("--config", "-c", help="Config file to use")],
    dump_dispatch_to: Annotated[
        Optional[str],
        typer.Option(
            "--dump-dispatch-to", "-d", help="Dump dispatched results to file"
        )] = None,
    load_dispatch_from: Annotated[Optional[str],
                                  typer.Option(
                                      "--load-dispatch-from",
                                      "-l",
                                      help="Load dispatched results from file"
                                  )] = None
):
...
@app.command(short_help='Workflow Tuning')
def workflow(
    config_path: Annotated[
        str, typer.Option("--config", "-c", help="Config file to use")],
    dump_dispatch_to: Annotated[
