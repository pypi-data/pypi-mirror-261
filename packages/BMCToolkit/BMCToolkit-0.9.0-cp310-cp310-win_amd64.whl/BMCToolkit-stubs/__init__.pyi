...
import numpy
import typing
__all__ = ['ClusterSortingMethod', 'KL_divergence_rate_difference_between_models', 'OrderOfBMC', 'PreferredHardware', 'SingularValueCalculationMethod', 'SingularValueThresholdingMethod', 'SpectralClusteringMethod', 'compute_bmcs_parameters', 'compute_cluster_difference', 'compute_cluster_improvement', 'compute_clusters_from_trajectory', 'compute_equilibrium_distribution_lift', 'compute_frequency_matrix_lift', 'compute_k_means', 'compute_neighborhoods', 'compute_spectral_clustering', 'compute_spectral_norm', 'compute_transition_matrix_lift', 'estimate_num_clusters', 'generate_random_probability_vector', 'generate_random_transition_matrix', 'generate_sample_path_of_BMC', 'generate_sample_path_of_MC', 'generate_sample_path_of_perturbed_BMC', 'generate_trimmed_matrix', 'get_equilibrium_distribution_proj', 'get_frequency_matrix_proj', 'get_limiting_singular_value_distribution_of_count_matrix', 'get_transition_matrix_proj', 'label_clusters', 'label_clusters_by_decr_equilibrium_distribution', 'label_clusters_by_decr_size', 'label_clusters_by_incr_equilibrium_distribution', 'label_clusters_by_incr_size', 'order_selection_by_minimizing_information_criteria', 'project_sample_path', 'trim_count_matrix']
...
def compute_k_means(matrix: numpy.ndarray[numpy.float64[m, n]], num_clusters: int, seed: int = 1987, max_trials: int = 10000, max_iterations: int = 1000, preferred_hardware: PreferredHardware) -> numpy.ndarray[numpy.uint32[m, 1]]:
    ...
    """
def compute_neighborhoods(matrix: numpy.ndarray[numpy.float64[m, n]], radius: float, size_of_random_subset: int) -> dict[int, set[int]]:
    """
    Given a matrix this computes for every row a neighborhood.
    """
def compute_spectral_clustering(matrix: numpy.ndarray[numpy.float64[m, n]], num_clusters: int, seed: int = 1987, max_trials: int = 10000, max_iterations: int = 1000, num_largest_singular_values_to_ignore: int = 0, num_extra_singular_values_to_use: int = 0) -> numpy.ndarray[numpy.uint32[m, 1]]:
    """
...
def compute_transition_matrix_lift(transition_matrix: numpy.ndarray[numpy.float64[m, n]], rel_cluster_sizes: numpy.ndarray[numpy.float64[m, 1]], abs_size: int) -> numpy.ndarray[numpy.float64[m, n]]:
    ...
    """
def estimate_num_clusters(trimmed_matrix: numpy.ndarray[numpy.float64[m, n]], radius: float, singular_value_threshold: float, set_size_threshold: float, num_indices: int) -> int:
    """
...
def generate_random_transition_matrix(dimension: int, seed: int) -> numpy.ndarray[numpy.float64[m, n]]:
    ...
def generate_sample_path_of_BMC(transition_matrix: numpy.ndarray[numpy.float64[m, n]], rel_cluster_sizes: numpy.ndarray[numpy.float64[m, 1]], abs_size: int, trajectory_length: int, seed: int) -> numpy.ndarray[numpy.uint32[1, n]]:
    """
    Generate a random sample path of a Block Markov Chain.
    """
def generate_sample_path_of_MC(transition_matrix: numpy.ndarray[numpy.float64[m, n]], trajectory_length: int, seed: int) -> numpy.ndarray[numpy.uint32[1, n]]:
    """
    Generate a random sample path of a Markov Chain.
    """
def generate_sample_path_of_perturbed_BMC(transition_matrix_of_BMC: numpy.ndarray[numpy.float64[m, n]], rel_cluster_sizes: numpy.ndarray[numpy.float64[m, 1]], abs_size: int, probability_of_perturbation: float, transition_matrix_of_MC: numpy.ndarray[numpy.float64[m, n]], trajectory_length: int, seed: int) -> numpy.ndarray[numpy.uint32[1, n]]:
    """
