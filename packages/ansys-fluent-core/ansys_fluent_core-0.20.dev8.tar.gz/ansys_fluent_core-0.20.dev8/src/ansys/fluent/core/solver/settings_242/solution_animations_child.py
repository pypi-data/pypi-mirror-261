...
from .appended_time_freq_of import appended_time_freq_of as appended_time_freq_of_cls
...
from .name_append_time import name_append_time as name_append_time_cls
from .appended_time_decimal_precision import appended_time_decimal_precision as appended_time_decimal_precision_cls
...
class solution_animations_child(Group):
    ...
    child_names = \
        ['name', 'animate_on', 'frequency', 'flow_time_frequency',
         'frequency_of', 'appended_time_freq_of', 'storage_type',
         'storage_dir', 'window_id', 'view', 'use_raytracing',
         'name_append_time', 'appended_time_decimal_precision']
    ...
    _child_classes = dict(
        ...
        appended_time_freq_of=appended_time_freq_of_cls,
        storage_type=storage_type_cls,
        storage_dir=storage_dir_cls,
        window_id=window_id_cls,
        view=view_cls,
        use_raytracing=use_raytracing_cls,
        name_append_time=name_append_time_cls,
        appended_time_decimal_precision=appended_time_decimal_precision_cls,
        display=display_cls,
    )
