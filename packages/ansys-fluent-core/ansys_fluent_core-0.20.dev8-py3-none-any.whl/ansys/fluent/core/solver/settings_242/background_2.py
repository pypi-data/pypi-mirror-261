...
from .env_light_radius import env_light_radius as env_light_radius_cls
...
class background(Group):
    ...
    child_names = \
        ['hide_environment_keep_effects', 'environment_image', 'vertical',
         ...
         'activate_env_ground_shadow', 'env_light_radius',
         'env_light_ground_height']
    ...
    _child_classes = dict(
        ...
        env_light_radius=env_light_radius_cls,
