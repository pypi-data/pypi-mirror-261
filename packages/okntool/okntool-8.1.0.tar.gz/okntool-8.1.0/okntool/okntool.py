...
def overlay_pupil_detection(recording_dir_input,
    ...
    csv_dir = os.path.abspath(os.path.join(summary_csv_input, os.pardir))
    summary_csv_name = os.path.basename(summary_csv_input)

    folder_name_array = get_folder_name_from_dir(csv_dir, "trial_id", "disk_condition", summary_csv_name)
...
def main():
    ...
    parser.add_argument('--version', action='version', version='8.1.0'),
