...
__all__ = ['issig', 'isspec', 'isparam', 'isp', 'iskwonly', 'isvarpos', 'isvarg', 'isvarkwd', 'isvkws', 'isvpos', 'isvarpok',
           'isvpok', 'isvarkwo', 'isvkwo', 'ispkwonly', 'isself', 'isclsarg', 'ispself', 'ispcls', 'isparamempty',
           'isempty', 'isemptyparam', 'ispempty', 'isfunc', 'islambda']

# %% ../nbs/30_insp.ipynb 4
from inspect import Parameter, Signature, isfunction, FullArgSpec, _empty
