...
class SolveMathOptModelRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["model", b"model", "model_parameters", b"model_parameters", "parameters", b"parameters"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["model", b"model", "model_parameters", b"model_parameters", "parameters", b"parameters", "solver_type", b"solver_type"]) -> None: ...
