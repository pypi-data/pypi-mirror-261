...
class SolutionHintProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["dual_values", b"dual_values", "variable_values", b"variable_values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dual_values", b"dual_values", "variable_values", b"variable_values"]) -> None: ...
...
class ObjectiveParametersProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_objective_degradation_absolute_tolerance", b"_objective_degradation_absolute_tolerance", "_objective_degradation_relative_tolerance", b"_objective_degradation_relative_tolerance", "objective_degradation_absolute_tolerance", b"objective_degradation_absolute_tolerance", "objective_degradation_relative_tolerance", b"objective_degradation_relative_tolerance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_objective_degradation_absolute_tolerance", b"_objective_degradation_absolute_tolerance", "_objective_degradation_relative_tolerance", b"_objective_degradation_relative_tolerance", "objective_degradation_absolute_tolerance", b"objective_degradation_absolute_tolerance", "objective_degradation_relative_tolerance", b"objective_degradation_relative_tolerance"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_objective_degradation_absolute_tolerance", b"_objective_degradation_absolute_tolerance"]) -> typing_extensions.Literal["objective_degradation_absolute_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_objective_degradation_relative_tolerance", b"_objective_degradation_relative_tolerance"]) -> typing_extensions.Literal["objective_degradation_relative_tolerance"] | None: ...
