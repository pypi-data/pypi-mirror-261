...
class VariableUpdatesProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["integers", b"integers", "lower_bounds", b"lower_bounds", "upper_bounds", b"upper_bounds"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["integers", b"integers", "lower_bounds", b"lower_bounds", "upper_bounds", b"upper_bounds"]) -> None: ...
...
class ObjectiveUpdatesProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_direction_update", b"_direction_update", "_offset_update", b"_offset_update", "_priority_update", b"_priority_update", "direction_update", b"direction_update", "linear_coefficients", b"linear_coefficients", "offset_update", b"offset_update", "priority_update", b"priority_update", "quadratic_coefficients", b"quadratic_coefficients"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_direction_update", b"_direction_update", "_offset_update", b"_offset_update", "_priority_update", b"_priority_update", "direction_update", b"direction_update", "linear_coefficients", b"linear_coefficients", "offset_update", b"offset_update", "priority_update", b"priority_update", "quadratic_coefficients", b"quadratic_coefficients"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_direction_update", b"_direction_update"]) -> typing_extensions.Literal["direction_update"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_offset_update", b"_offset_update"]) -> typing_extensions.Literal["offset_update"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_priority_update", b"_priority_update"]) -> typing_extensions.Literal["priority_update"] | None: ...
...
class AuxiliaryObjectivesUpdatesProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deleted_objective_ids", b"deleted_objective_ids", "new_objectives", b"new_objectives", "objective_updates", b"objective_updates"]) -> None: ...
...
class LinearConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["lower_bounds", b"lower_bounds", "upper_bounds", b"upper_bounds"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["lower_bounds", b"lower_bounds", "upper_bounds", b"upper_bounds"]) -> None: ...
...
class QuadraticConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deleted_constraint_ids", b"deleted_constraint_ids", "new_constraints", b"new_constraints"]) -> None: ...
