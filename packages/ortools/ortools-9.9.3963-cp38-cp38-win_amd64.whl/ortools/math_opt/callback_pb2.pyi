...
class CallbackDataProto(google.protobuf.message.Message):
    ...
    class PresolveStats(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_bound_changes", b"_bound_changes", "_coefficient_changes", b"_coefficient_changes", "_removed_constraints", b"_removed_constraints", "_removed_variables", b"_removed_variables", "bound_changes", b"bound_changes", "coefficient_changes", b"coefficient_changes", "removed_constraints", b"removed_constraints", "removed_variables", b"removed_variables"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_bound_changes", b"_bound_changes", "_coefficient_changes", b"_coefficient_changes", "_removed_constraints", b"_removed_constraints", "_removed_variables", b"_removed_variables", "bound_changes", b"bound_changes", "coefficient_changes", b"coefficient_changes", "removed_constraints", b"removed_constraints", "removed_variables", b"removed_variables"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_bound_changes", b"_bound_changes"]) -> typing_extensions.Literal["bound_changes"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_coefficient_changes", b"_coefficient_changes"]) -> typing_extensions.Literal["coefficient_changes"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_removed_constraints", b"_removed_constraints"]) -> typing_extensions.Literal["removed_constraints"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_removed_variables", b"_removed_variables"]) -> typing_extensions.Literal["removed_variables"] | None: ...
    ...
    class SimplexStats(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_dual_infeasibility", b"_dual_infeasibility", "_is_pertubated", b"_is_pertubated", "_iteration_count", b"_iteration_count", "_objective_value", b"_objective_value", "_primal_infeasibility", b"_primal_infeasibility", "dual_infeasibility", b"dual_infeasibility", "is_pertubated", b"is_pertubated", "iteration_count", b"iteration_count", "objective_value", b"objective_value", "primal_infeasibility", b"primal_infeasibility"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_dual_infeasibility", b"_dual_infeasibility", "_is_pertubated", b"_is_pertubated", "_iteration_count", b"_iteration_count", "_objective_value", b"_objective_value", "_primal_infeasibility", b"_primal_infeasibility", "dual_infeasibility", b"dual_infeasibility", "is_pertubated", b"is_pertubated", "iteration_count", b"iteration_count", "objective_value", b"objective_value", "primal_infeasibility", b"primal_infeasibility"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_dual_infeasibility", b"_dual_infeasibility"]) -> typing_extensions.Literal["dual_infeasibility"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_pertubated", b"_is_pertubated"]) -> typing_extensions.Literal["is_pertubated"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_iteration_count", b"_iteration_count"]) -> typing_extensions.Literal["iteration_count"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_objective_value", b"_objective_value"]) -> typing_extensions.Literal["objective_value"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_primal_infeasibility", b"_primal_infeasibility"]) -> typing_extensions.Literal["primal_infeasibility"] | None: ...
    ...
    class BarrierStats(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_complementarity", b"_complementarity", "_dual_infeasibility", b"_dual_infeasibility", "_dual_objective", b"_dual_objective", "_iteration_count", b"_iteration_count", "_primal_infeasibility", b"_primal_infeasibility", "_primal_objective", b"_primal_objective", "complementarity", b"complementarity", "dual_infeasibility", b"dual_infeasibility", "dual_objective", b"dual_objective", "iteration_count", b"iteration_count", "primal_infeasibility", b"primal_infeasibility", "primal_objective", b"primal_objective"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_complementarity", b"_complementarity", "_dual_infeasibility", b"_dual_infeasibility", "_dual_objective", b"_dual_objective", "_iteration_count", b"_iteration_count", "_primal_infeasibility", b"_primal_infeasibility", "_primal_objective", b"_primal_objective", "complementarity", b"complementarity", "dual_infeasibility", b"dual_infeasibility", "dual_objective", b"dual_objective", "iteration_count", b"iteration_count", "primal_infeasibility", b"primal_infeasibility", "primal_objective", b"primal_objective"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_complementarity", b"_complementarity"]) -> typing_extensions.Literal["complementarity"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_dual_infeasibility", b"_dual_infeasibility"]) -> typing_extensions.Literal["dual_infeasibility"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_dual_objective", b"_dual_objective"]) -> typing_extensions.Literal["dual_objective"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_iteration_count", b"_iteration_count"]) -> typing_extensions.Literal["iteration_count"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_primal_infeasibility", b"_primal_infeasibility"]) -> typing_extensions.Literal["primal_infeasibility"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_primal_objective", b"_primal_objective"]) -> typing_extensions.Literal["primal_objective"] | None: ...
    ...
    class MipStats(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_cutting_planes_in_lp", b"_cutting_planes_in_lp", "_dual_bound", b"_dual_bound", "_explored_nodes", b"_explored_nodes", "_number_of_solutions_found", b"_number_of_solutions_found", "_open_nodes", b"_open_nodes", "_primal_bound", b"_primal_bound", "_simplex_iterations", b"_simplex_iterations", "cutting_planes_in_lp", b"cutting_planes_in_lp", "dual_bound", b"dual_bound", "explored_nodes", b"explored_nodes", "number_of_solutions_found", b"number_of_solutions_found", "open_nodes", b"open_nodes", "primal_bound", b"primal_bound", "simplex_iterations", b"simplex_iterations"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_cutting_planes_in_lp", b"_cutting_planes_in_lp", "_dual_bound", b"_dual_bound", "_explored_nodes", b"_explored_nodes", "_number_of_solutions_found", b"_number_of_solutions_found", "_open_nodes", b"_open_nodes", "_primal_bound", b"_primal_bound", "_simplex_iterations", b"_simplex_iterations", "cutting_planes_in_lp", b"cutting_planes_in_lp", "dual_bound", b"dual_bound", "explored_nodes", b"explored_nodes", "number_of_solutions_found", b"number_of_solutions_found", "open_nodes", b"open_nodes", "primal_bound", b"primal_bound", "simplex_iterations", b"simplex_iterations"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_cutting_planes_in_lp", b"_cutting_planes_in_lp"]) -> typing_extensions.Literal["cutting_planes_in_lp"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_dual_bound", b"_dual_bound"]) -> typing_extensions.Literal["dual_bound"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_explored_nodes", b"_explored_nodes"]) -> typing_extensions.Literal["explored_nodes"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_number_of_solutions_found", b"_number_of_solutions_found"]) -> typing_extensions.Literal["number_of_solutions_found"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_open_nodes", b"_open_nodes"]) -> typing_extensions.Literal["open_nodes"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_primal_bound", b"_primal_bound"]) -> typing_extensions.Literal["primal_bound"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_simplex_iterations", b"_simplex_iterations"]) -> typing_extensions.Literal["simplex_iterations"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["barrier_stats", b"barrier_stats", "mip_stats", b"mip_stats", "presolve_stats", b"presolve_stats", "primal_solution_vector", b"primal_solution_vector", "runtime", b"runtime", "simplex_stats", b"simplex_stats"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["barrier_stats", b"barrier_stats", "event", b"event", "mip_stats", b"mip_stats", "presolve_stats", b"presolve_stats", "primal_solution_vector", b"primal_solution_vector", "runtime", b"runtime", "simplex_stats", b"simplex_stats"]) -> None: ...
...
class CallbackResultProto(google.protobuf.message.Message):
    ...
    class GeneratedLinearConstraint(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["linear_expression", b"linear_expression"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["is_lazy", b"is_lazy", "linear_expression", b"linear_expression", "lower_bound", b"lower_bound", "upper_bound", b"upper_bound"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cuts", b"cuts", "suggested_solutions", b"suggested_solutions", "terminate", b"terminate"]) -> None: ...
...
class CallbackRegistrationProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["mip_node_filter", b"mip_node_filter", "mip_solution_filter", b"mip_solution_filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["add_cuts", b"add_cuts", "add_lazy_constraints", b"add_lazy_constraints", "mip_node_filter", b"mip_node_filter", "mip_solution_filter", b"mip_solution_filter", "request_registration", b"request_registration"]) -> None: ...
