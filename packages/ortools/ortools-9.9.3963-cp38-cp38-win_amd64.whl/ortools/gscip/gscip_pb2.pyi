...
class GScipParameters(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_presolve", b"_presolve"]) -> typing_extensions.Literal["presolve"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_separating", b"_separating"]) -> typing_extensions.Literal["separating"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_silence_output", b"_silence_output"]) -> typing_extensions.Literal["silence_output"] | None: ...
...
class GScipSolvingStats(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["barrier_iterations", b"barrier_iterations", "best_bound", b"best_bound", "best_objective", b"best_objective", "deterministic_time", b"deterministic_time", "dual_simplex_iterations", b"dual_simplex_iterations", "first_lp_relaxation_bound", b"first_lp_relaxation_bound", "node_count", b"node_count", "primal_simplex_iterations", b"primal_simplex_iterations", "root_node_bound", b"root_node_bound", "total_lp_iterations", b"total_lp_iterations"]) -> None: ...
...
class GScipOutput(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["stats", b"stats", "status", b"status", "status_detail", b"status_detail"]) -> None: ...
