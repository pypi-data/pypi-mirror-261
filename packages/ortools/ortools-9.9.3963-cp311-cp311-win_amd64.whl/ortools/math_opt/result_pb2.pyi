...
class ProblemStatusProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dual_status", b"dual_status", "primal_or_dual_infeasible", b"primal_or_dual_infeasible", "primal_status", b"primal_status"]) -> None: ...
...
class SolveStatsProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["problem_status", b"problem_status", "solve_time", b"solve_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["barrier_iterations", b"barrier_iterations", "best_dual_bound", b"best_dual_bound", "best_primal_bound", b"best_primal_bound", "first_order_iterations", b"first_order_iterations", "node_count", b"node_count", "problem_status", b"problem_status", "simplex_iterations", b"simplex_iterations", "solve_time", b"solve_time"]) -> None: ...
...
class ObjectiveBoundsProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dual_bound", b"dual_bound", "primal_bound", b"primal_bound"]) -> None: ...
...
class TerminationProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["objective_bounds", b"objective_bounds", "problem_status", b"problem_status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["detail", b"detail", "limit", b"limit", "objective_bounds", b"objective_bounds", "problem_status", b"problem_status", "reason", b"reason"]) -> None: ...
...
class SolveResultProto(google.protobuf.message.Message):
    ...
    class PdlpOutput(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["convergence_information", b"convergence_information"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["convergence_information", b"convergence_information"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["gscip_output", b"gscip_output", "osqp_output", b"osqp_output", "pdlp_output", b"pdlp_output", "solve_stats", b"solve_stats", "solver_specific_output", b"solver_specific_output", "termination", b"termination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dual_rays", b"dual_rays", "gscip_output", b"gscip_output", "osqp_output", b"osqp_output", "pdlp_output", b"pdlp_output", "primal_rays", b"primal_rays", "solutions", b"solutions", "solve_stats", b"solve_stats", "solver_specific_output", b"solver_specific_output", "termination", b"termination"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["solver_specific_output", b"solver_specific_output"]) -> typing_extensions.Literal["gscip_output", "osqp_output", "pdlp_output"] | None: ...
