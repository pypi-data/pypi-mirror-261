...
class SolverResourcesProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_cpu", b"_cpu", "cpu", b"cpu"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_cpu", b"_cpu", "cpu", b"cpu"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_cpu", b"_cpu"]) -> typing_extensions.Literal["cpu"] | None: ...
...
class SolveRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["initializer", b"initializer", "model", b"model", "model_parameters", b"model_parameters", "parameters", b"parameters", "resources", b"resources"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["initializer", b"initializer", "model", b"model", "model_parameters", b"model_parameters", "parameters", b"parameters", "resources", b"resources", "solver_type", b"solver_type"]) -> None: ...
...
class SolveResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["messages", b"messages", "result", b"result"]) -> None: ...
