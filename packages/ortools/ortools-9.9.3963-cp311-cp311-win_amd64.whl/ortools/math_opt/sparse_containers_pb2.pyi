...
class SparseVectorFilterProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter_by_ids", b"filter_by_ids", "filtered_ids", b"filtered_ids", "skip_zero_values", b"skip_zero_values"]) -> None: ...
...
class SparseDoubleMatrixProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["coefficients", b"coefficients", "column_ids", b"column_ids", "row_ids", b"row_ids"]) -> None: ...
...
class LinearExpressionProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["coefficients", b"coefficients", "ids", b"ids", "offset", b"offset"]) -> None: ...
