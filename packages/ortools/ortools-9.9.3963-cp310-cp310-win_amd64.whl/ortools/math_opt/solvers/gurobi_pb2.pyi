...
class GurobiInitializerProto(google.protobuf.message.Message):
    ...
    class ISVKey(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["application_name", b"application_name", "expiration", b"expiration", "key", b"key", "name", b"name"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["isv_key", b"isv_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["isv_key", b"isv_key"]) -> None: ...
