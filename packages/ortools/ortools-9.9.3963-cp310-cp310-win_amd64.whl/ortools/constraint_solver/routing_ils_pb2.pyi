...
class RuinRecreateParameters(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["num_ruined_routes", b"num_ruined_routes", "recreate_strategy", b"recreate_strategy", "ruin_strategy", b"ruin_strategy"]) -> None: ...
...
class IteratedLocalSearchParameters(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ruin_recreate_parameters", b"ruin_recreate_parameters"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["acceptance_strategy", b"acceptance_strategy", "improve_perturbed_solution", b"improve_perturbed_solution", "perturbation_strategy", b"perturbation_strategy", "ruin_recreate_parameters", b"ruin_recreate_parameters"]) -> None: ...
