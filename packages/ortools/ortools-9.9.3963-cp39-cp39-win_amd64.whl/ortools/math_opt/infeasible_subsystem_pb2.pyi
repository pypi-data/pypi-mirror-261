...
class ModelSubsetProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["indicator_constraints", b"indicator_constraints", "linear_constraints", b"linear_constraints", "quadratic_constraints", b"quadratic_constraints", "second_order_cone_constraints", b"second_order_cone_constraints", "sos1_constraints", b"sos1_constraints", "sos2_constraints", b"sos2_constraints", "variable_bounds", b"variable_bounds", "variable_integrality", b"variable_integrality"]) -> None: ...
...
class ComputeInfeasibleSubsystemResultProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["infeasible_subsystem", b"infeasible_subsystem"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["feasibility", b"feasibility", "infeasible_subsystem", b"infeasible_subsystem", "is_minimal", b"is_minimal"]) -> None: ...
