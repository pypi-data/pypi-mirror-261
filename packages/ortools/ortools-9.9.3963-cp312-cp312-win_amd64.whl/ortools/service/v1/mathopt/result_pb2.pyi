...
class SolveStatsProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["barrier_iterations", b"barrier_iterations", "first_order_iterations", b"first_order_iterations", "node_count", b"node_count", "problem_status", b"problem_status", "simplex_iterations", b"simplex_iterations", "solve_time", b"solve_time"]) -> None: ...
...
class SolveResultProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["solve_stats", b"solve_stats", "termination", b"termination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dual_rays", b"dual_rays", "primal_rays", b"primal_rays", "solutions", b"solutions", "solve_stats", b"solve_stats", "termination", b"termination"]) -> None: ...
