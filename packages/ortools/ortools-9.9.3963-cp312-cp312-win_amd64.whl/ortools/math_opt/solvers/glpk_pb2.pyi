...
class GlpkParametersProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_compute_unbound_rays_if_possible", b"_compute_unbound_rays_if_possible", "compute_unbound_rays_if_possible", b"compute_unbound_rays_if_possible"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_compute_unbound_rays_if_possible", b"_compute_unbound_rays_if_possible", "compute_unbound_rays_if_possible", b"compute_unbound_rays_if_possible"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_compute_unbound_rays_if_possible", b"_compute_unbound_rays_if_possible"]) -> typing_extensions.Literal["compute_unbound_rays_if_possible"] | None: ...
