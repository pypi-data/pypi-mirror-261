...
class StrictnessProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bad_parameter", b"bad_parameter"]) -> None: ...
...
class SolverInitializerProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["gurobi", b"gurobi"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["gurobi", b"gurobi"]) -> None: ...
...
class SolveParametersProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_absolute_gap_tolerance", b"_absolute_gap_tolerance", "_best_bound_limit", b"_best_bound_limit", "_cutoff_limit", b"_cutoff_limit", "_iteration_limit", b"_iteration_limit", "_node_limit", b"_node_limit", "_objective_limit", b"_objective_limit", "_random_seed", b"_random_seed", "_relative_gap_tolerance", b"_relative_gap_tolerance", "_solution_limit", b"_solution_limit", "_solution_pool_size", b"_solution_pool_size", "_threads", b"_threads", "absolute_gap_tolerance", b"absolute_gap_tolerance", "best_bound_limit", b"best_bound_limit", "cp_sat", b"cp_sat", "cutoff_limit", b"cutoff_limit", "glop", b"glop", "glpk", b"glpk", "gscip", b"gscip", "gurobi", b"gurobi", "highs", b"highs", "iteration_limit", b"iteration_limit", "node_limit", b"node_limit", "objective_limit", b"objective_limit", "osqp", b"osqp", "pdlp", b"pdlp", "random_seed", b"random_seed", "relative_gap_tolerance", b"relative_gap_tolerance", "solution_limit", b"solution_limit", "solution_pool_size", b"solution_pool_size", "threads", b"threads", "time_limit", b"time_limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_absolute_gap_tolerance", b"_absolute_gap_tolerance", "_best_bound_limit", b"_best_bound_limit", "_cutoff_limit", b"_cutoff_limit", "_iteration_limit", b"_iteration_limit", "_node_limit", b"_node_limit", "_objective_limit", b"_objective_limit", "_random_seed", b"_random_seed", "_relative_gap_tolerance", b"_relative_gap_tolerance", "_solution_limit", b"_solution_limit", "_solution_pool_size", b"_solution_pool_size", "_threads", b"_threads", "absolute_gap_tolerance", b"absolute_gap_tolerance", "best_bound_limit", b"best_bound_limit", "cp_sat", b"cp_sat", "cutoff_limit", b"cutoff_limit", "cuts", b"cuts", "enable_output", b"enable_output", "glop", b"glop", "glpk", b"glpk", "gscip", b"gscip", "gurobi", b"gurobi", "heuristics", b"heuristics", "highs", b"highs", "iteration_limit", b"iteration_limit", "lp_algorithm", b"lp_algorithm", "node_limit", b"node_limit", "objective_limit", b"objective_limit", "osqp", b"osqp", "pdlp", b"pdlp", "presolve", b"presolve", "random_seed", b"random_seed", "relative_gap_tolerance", b"relative_gap_tolerance", "scaling", b"scaling", "solution_limit", b"solution_limit", "solution_pool_size", b"solution_pool_size", "threads", b"threads", "time_limit", b"time_limit"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_absolute_gap_tolerance", b"_absolute_gap_tolerance"]) -> typing_extensions.Literal["absolute_gap_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_best_bound_limit", b"_best_bound_limit"]) -> typing_extensions.Literal["best_bound_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_cutoff_limit", b"_cutoff_limit"]) -> typing_extensions.Literal["cutoff_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_iteration_limit", b"_iteration_limit"]) -> typing_extensions.Literal["iteration_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_node_limit", b"_node_limit"]) -> typing_extensions.Literal["node_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_objective_limit", b"_objective_limit"]) -> typing_extensions.Literal["objective_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_random_seed", b"_random_seed"]) -> typing_extensions.Literal["random_seed"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_relative_gap_tolerance", b"_relative_gap_tolerance"]) -> typing_extensions.Literal["relative_gap_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_solution_limit", b"_solution_limit"]) -> typing_extensions.Literal["solution_limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_solution_pool_size", b"_solution_pool_size"]) -> typing_extensions.Literal["solution_pool_size"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_threads", b"_threads"]) -> typing_extensions.Literal["threads"] | None: ...
