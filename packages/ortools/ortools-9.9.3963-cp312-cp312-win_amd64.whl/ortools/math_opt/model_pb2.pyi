...
class VariablesProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ids", b"ids", "integers", b"integers", "lower_bounds", b"lower_bounds", "names", b"names", "upper_bounds", b"upper_bounds"]) -> None: ...
...
class ObjectiveProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["linear_coefficients", b"linear_coefficients", "quadratic_coefficients", b"quadratic_coefficients"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["linear_coefficients", b"linear_coefficients", "maximize", b"maximize", "name", b"name", "offset", b"offset", "priority", b"priority", "quadratic_coefficients", b"quadratic_coefficients"]) -> None: ...
...
class LinearConstraintsProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ids", b"ids", "lower_bounds", b"lower_bounds", "names", b"names", "upper_bounds", b"upper_bounds"]) -> None: ...
...
class QuadraticConstraintProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["linear_terms", b"linear_terms", "quadratic_terms", b"quadratic_terms"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["linear_terms", b"linear_terms", "lower_bound", b"lower_bound", "name", b"name", "quadratic_terms", b"quadratic_terms", "upper_bound", b"upper_bound"]) -> None: ...
...
class SecondOrderConeConstraintProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["upper_bound", b"upper_bound"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["arguments_to_norm", b"arguments_to_norm", "name", b"name", "upper_bound", b"upper_bound"]) -> None: ...
...
class SosConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["expressions", b"expressions", "name", b"name", "weights", b"weights"]) -> None: ...
...
class IndicatorConstraintProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_indicator_id", b"_indicator_id", "expression", b"expression", "indicator_id", b"indicator_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_indicator_id", b"_indicator_id", "activate_on_zero", b"activate_on_zero", "expression", b"expression", "indicator_id", b"indicator_id", "lower_bound", b"lower_bound", "name", b"name", "upper_bound", b"upper_bound"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_indicator_id", b"_indicator_id"]) -> typing_extensions.Literal["indicator_id"] | None: ...
...
class ModelProto(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["linear_constraint_matrix", b"linear_constraint_matrix", "linear_constraints", b"linear_constraints", "objective", b"objective", "variables", b"variables"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auxiliary_objectives", b"auxiliary_objectives", "indicator_constraints", b"indicator_constraints", "linear_constraint_matrix", b"linear_constraint_matrix", "linear_constraints", b"linear_constraints", "name", b"name", "objective", b"objective", "quadratic_constraints", b"quadratic_constraints", "second_order_cone_constraints", b"second_order_cone_constraints", "sos1_constraints", b"sos1_constraints", "sos2_constraints", b"sos2_constraints", "variables", b"variables"]) -> None: ...
