...
When `reporting a bug <https://github.com/TexZK/hexrec/issues>`_ please include:
...
hexrec could always use more documentation, whether as part of the
official hexrec docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork `hexrec <https://github.com/TexZK/hexrec>`_
