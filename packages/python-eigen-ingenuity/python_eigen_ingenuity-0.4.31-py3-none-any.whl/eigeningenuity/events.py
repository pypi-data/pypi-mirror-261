...
from eigeningenuity.util import get_eigenserver, divide_chunks, parseEvents, _post_eigen_events
...
class EventLog (object):
    ...
    def _doJsonRequest(self,relative_url,chunks):
        url = self.baseurl + relative_url
        return _post_eigen_events(url,chunks,self.auth)
    ...
    def pushToEventlog(self, events):
        ...
        failures = self._doJsonRequest(relative_url, events)
