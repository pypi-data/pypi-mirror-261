...
class TheIntegrationToUpdate(BaseModel):
    ...
    record_id_prefix: Optional[StrictStr] = Field(default=None, description="A prefix that is prepended to all Record IDs added to the Collection.  For example, if \"proteins/flourescent\" is imported to a Collection \"my-collection\", and a Record with an ID of \"GFP\" is imported, the Record name will be \"collections/my-collection/sequences/proteins/flourescent/GFP\".", alias="recordIdPrefix")
    ...
    __properties: ClassVar[List[str]] = ["collection", "recordIdPrefix", "etag", "ncbi", "googleDrive"]
