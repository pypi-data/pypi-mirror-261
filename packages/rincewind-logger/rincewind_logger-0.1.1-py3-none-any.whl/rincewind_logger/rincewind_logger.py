...
class RincewindLogger:
    ...
    def setup(self, log_file_path: str, max_days: int, max_size_mb: int,
        ...
        file_handler = logging.handlers.TimedRotatingFileHandler(
            self.log_file_path, when='D', interval=1, backupCount=self.max_days, encoding='utf-8'
        )
...
# Example usage:
logger = ShellLogger()
logger.setup('/path/to/logfile.log', 30, 10, verbose=True)
print(logger.is_configured)  # True
