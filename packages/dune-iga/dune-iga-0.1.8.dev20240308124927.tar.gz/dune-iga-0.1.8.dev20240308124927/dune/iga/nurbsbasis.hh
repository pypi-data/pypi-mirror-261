  ...
  class NurbsLocalBasis {
   ...
   public:
    ...
    NurbsLocalBasis(const NurbsPreBasis<GV>* preBasis, const NurbsLocalFiniteElement<GV, R>* lFE)
      ...
      static_assert(std::is_copy_constructible_v<NurbsLocalBasis>);
      static_assert(std::is_copy_assignable_v<NurbsLocalBasis>);
    }
   ...
   private:
    const NurbsPreBasis<GV>* preBasis_{nullptr};

    const NurbsLocalFiniteElement<GV, R>* lFE_{nullptr};
