...
from quac.cons import (
    NIL, NDIM, SHAPE, KEYS, VALUES, __K__, __V__, __N__, __RETANNOT__, __KVTYPES__,
    __D__, __LIT__, __LITNAME__, __EMPTYVAL__
)
