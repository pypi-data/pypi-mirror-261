...
__all__ = ['iterable', 'itertype', 'iterq', 'listq', 'tupleq', 'nlen', 'len1', 'len2', 'len3', 'len4', 'npbool', 'boolic',
           ...
           'trackbacktype', 'functiontype', 'mapping', 'moduleq', 'callq', 'enumauto', 'enumdict', 'dictkeys',
           'dictvalues', 'dictitems', 'setq', 'dictq', 'sig', 'param', 'paramkind', 'logger', 'loggerq', 'ichain',
           'iprod', 'ziplong', 'artist', 'colormap', 'lcolormap', 'lscolormap', 'mplpatch', 'mplaxbase', 'mplaxes',
           ...
           'sparseq', 'arrayq', 'matrixq', 'cv2vidcap', 'pilimage', 'vidcap', 'image', 'groupkey', 'pddelegate',
           'pdcataccessor', 'pdindex', 'pdcatindex', 'pdseries', 'boolindex', 'catindex', 'boolindexq', 'catindexq',
           'indextype', 'indexlike', 'seriestype', 'serieslike', 'pddataframe', 'dataframe', 'pttype', 'pttypeq',
           'memfmt', 'presfmt', 'ptsize', 'ptsizeq', 'ptdevice', 'ptdeviceq', 'pttensor', 'inttensor', 'booltensor',
           'floattensor', 'longtensor', 'doubletensor', 'nantensor', 'tensor', 'tensorq', 'pttensorq', 'ptmodule',
