...
__all__ = ['iterable', 'itertype', 'iterq', 'listq', 'tupleq', 'nlen', 'len1', 'len2', 'len3', 'len4', 'npbool', 'boolic',
           ...
           'booltensor', 'floattensor', 'longtensor', 'doubletensor', 'nantensor', 'tensor', 'tensorq', 'pttensorq',
           'ptmodule', 'plmodule', 'nnmodule', 'ptdataset', 'pldatamodule', 'ptdataloader', 'neuralode', 'neuralsde',
...
class literal(Duck[T]):
    ...
    @classmethod
    def __metahook__(cls, mcls, name, bases, namespace, **kwargs):
        namespace.update(__lit__=kwargs.get('__lit__', getattr(cls, '__lit__', None)))
        super().__metahook__(mcls, name, bases, namespace, **kwargs)
        l = cls.__lit__
        isval = lambda obj, val: val == l
        cls.__expected__.update(__lit__=l)
