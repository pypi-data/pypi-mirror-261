...
__all__ = ['boolfunc', 'flagfunc', 'numeric', 'numbers', 'emptystring', 'notemptystring', 'pttn', 'dirpath', 'dirnames',
           ...
           'clslist', 'clsfloat', 'clsnum', 'clscomplex', 'slc', 'slcs', 'boolcall', 'boolcallq', 'boolcalls',
           'docgenfn', 'axesidxs', 'argstype', 'sysexcinfotype', 'sysformatstyle', 'bbox', 'rgb', 'rgba', 'color',
...
class boolcall(duck.annreturn[P, bool01]):
...
class bbox(duck.itertype[duck.int2, duck.int2]):
...
class rgba(duck.len4, duck.size[int, int, int, float]):
