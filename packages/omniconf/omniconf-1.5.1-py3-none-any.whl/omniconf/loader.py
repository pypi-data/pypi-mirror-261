...
from omniconf.backends import autodetection_backends, available_backends
...
def autoconfigure_backends(autoconfigure_prefix: Optional[str] = None) -> List[ConfigBackend]:
    """
    ...
    backend_settings.add(Setting(join_key(autoconfigure_prefix, "prefix"), _type=str))
...
def omniconf_load(
    ...
    backends: Optional[Sequence[ConfigBackend]] = None,
    autoconfigure_prefix: Optional[str] = None,
) -> None:
    """
