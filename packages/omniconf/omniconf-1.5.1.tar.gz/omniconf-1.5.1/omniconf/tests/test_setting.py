...
from omniconf.setting import DEFAULT_REGISTRY, Setting, SettingRegistry, setting
...
class TestSettingsRegistry(unittest.TestCase):
    ...
    def test_setting_registry_key_with_string(self) -> None:
    ...
    def test_setting_registry_key_with_object(self) -> None:
        obj = Mock()
        obj.key = "foo"
    ...
    def test_setting_registry_clear(self) -> None:
        self.assertEqual(len(self.registry.registry), 1)
        self.registry.clear()
        self.assertEqual(len(self.registry.registry), 0)

    def test_setting_registry_add(self) -> None:
        self.assertIn(self.setting, self.registry.registry.values())

    def test_setting_registry_has(self) -> None:
        self.assertTrue(self.registry.has("foo"))

    def test_setting_registry_get(self) -> None:
        self.assertEqual(self.registry.get("foo"), self.setting)

    def test_setting_registry_keys(self) -> None:
        self.assertEqual(self.registry.keys(), list(self.registry.registry.keys()))

    def test_setting_registry_list(self) -> None:
        self.assertEqual(self.registry.list(), list(self.registry.registry.values()))

    def test_setting_registry_remove(self) -> None:
...
class TestSettingMethod(unittest.TestCase):
    ...
    def test_setting_method(self) -> None:
    ...
    def test_setting_method_with_default_registry(self) -> None:
