...
class manganelo_scraper(abstract_scraper):
    ...
    def search(
        ...
        max_pgs: int = 5, 
        save: bool=False,
        manga_title_css: str='.panel-search-story .search-story-item a.item-img') -> pd.DataFrame:
    ...
    # download imgs/pgs to cbz from manganelo chapter link
    ...
    def chapters(
        ...
        num_views_css: str='.row-content-chapter .a-h span.chapter-view',
        date_css: str='.row-content-chapter .a-h span.chapter-time',
