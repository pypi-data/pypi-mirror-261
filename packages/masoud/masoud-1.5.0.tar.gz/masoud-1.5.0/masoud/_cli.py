...
@click.option(
    ...
    type=bool,
    default=False,
    help="Enable debug logging of the generated commands",
)
@click.pass_context
...
def deploy_cmd(
    ...
    has_dockerfile = localhost.dockerfile is not None

    if has_dockerfile and not no_build:
    ...
    for host in hosts:
        if has_dockerfile:
            ...
            docker.pull_image(service(host))
