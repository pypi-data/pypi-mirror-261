...
def analyse_electrode(filename, electrodes, hertz, low_cutoff=200, high_cutoff=3500, order=2, spikeduration=0.002, exit_time_s=0.00024, amplitude_drop=2, plot_validation=True, well_amnt=24, electrode_amnt=12):
    # Open the data file
