...
def analyse_electrode(filename, electrodes, low_cutoff, high_cutoff, order, hertz, spikeduration, exit_time_s, amplitude_drop, plot_validation, well_amnt, electrode_amnt):
    # Open the data file
