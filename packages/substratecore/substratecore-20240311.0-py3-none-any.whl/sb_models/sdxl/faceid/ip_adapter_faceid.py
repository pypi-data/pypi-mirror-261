# from https://github.com/tencent-ailab/IP-Adapter/tree/main/ip_adapter
import os
...
from sb_models.sdxl.faceid.utils import get_generator, is_torch2_available
from sb_models.sdxl.faceid.attention_processor_faceid import LoRAAttnProcessor, LoRAIPAttnProcessor

USE_DAFAULT_ATTN = False  # should be True for visualization_attnmap
if is_torch2_available() and (not USE_DAFAULT_ATTN):
    from sb_models.sdxl.faceid.attention_processor_faceid import (
        LoRAAttnProcessor2_0 as LoRAAttnProcessor,
        LoRAIPAttnProcessor2_0 as LoRAIPAttnProcessor,
    )
else:
    from sb_models.sdxl.faceid.attention_processor_faceid import LoRAAttnProcessor, LoRAIPAttnProcessor
from sb_models.sdxl.faceid.resampler import FeedForward, PerceiverAttention
...
class IPAdapterFaceIDPlus:
    def __init__(
        self, sd_pipe, image_encoder_path, ip_ckpt, device, lora_rank=128, num_tokens=4, torch_dtype=torch.float16
    ):
        self.device = device
