...
from sb_models.sdxl.instantid.pipeline_stable_diffusion_xl_instantid import StableDiffusionXLInstantIDPipeline

# BASE_ID = "stabilityai/stable-diffusion-xl-base-1.0"
BASE_ID = "wangqixun/YamerMIX_v8"
MODEL_DIR = "/model"
CACHE_DIR = "/cache"
OUT_PATH = "/root/outs"
MODEL_FOLDER = "sdxl"
...
class SDXL:
    def __init__(self):
        ...
        t0 = time.time()
        # NOTE: WIP, can't download the weights
