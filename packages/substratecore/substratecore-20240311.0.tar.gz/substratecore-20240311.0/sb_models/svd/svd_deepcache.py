...
# from sb_models.substratecore.models import GenerateImageOut # TODO
# from sb_models.usage_models import BaseStableDiffusionUsage # TODO
...
image = (
    ...
    # https://github.com/siliconflow/onediff/tree/main/onediff_diffusers_extensions#install-and-setup
    .run_commands(
        "pip install -U --pre oneflow -f https://github.com/siliconflow/oneflow_releases/releases/expanded_assets/community_cu118",
...
stub = Stub("svd_deepcache", image=image)
...
class SVD:
    def __init__(self):
        ...
        pipe = StableVideoDiffusionPipeline.from_pretrained(
            MODEL_ID,
            # use_auth_token=hf_token, # this appears to use the deepcache auth token?
    ...
    def generate(
    ...
    ) -> InferenceRun[Dict[str, Any], Dict[str, Any]]:
        import io
        ...
        image = crop_to_dimensions(image, 1024, 576)  # Model can only output these dims
        generator = torch.manual_seed(42)  # TODO: seed param
        ...
        output = pipe(
            ...
            # noise_aug_strength=noise_aug_strength,  # typed as int, actually float
            # deepcache
            cache_interval=3,
            cache_branch=0,
        )
        ...
        # TODO: usage
        return InferenceRun(result={"uri": uri}, usage={})
