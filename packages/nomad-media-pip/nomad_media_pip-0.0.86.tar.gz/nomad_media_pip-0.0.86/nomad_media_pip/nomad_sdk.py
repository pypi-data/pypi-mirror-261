...
class Nomad_SDK:
	...
	"""
	def create_live_output_profile(self, NAME: str, OUTPUT_TYPE: str, ENABLED: bool | None,
	...
	MANIFEST_TYPE (str): The manifest type of the live output profile group.
	...
	ARCHIVE_LIVE_OUTPUT_PROFILE (list): The archive live output profile of the live output profile group.
	dict format: {"description": "string", "id": "string"}
	LIVE_OUTPUT_PROFILE (list): The live output profile of the live output profile group.
	Returns:
	...
	def create_live_output_profile_group(self, NAME: str, IS_ENABLED: bool, MANIFEST_TYPE: str,
										 ...
										 ARCHIVE_LIVE_OUTPUT_PROFILE: list, LIVE_OUTPUT_PROFILE: list) -> dict:
		try:
			if self.config["apiType"] != "admin":
				raise Exception("This function is only available for admin API type.")
			...
			LIVE_OUTPUT_PROFILE_GROUP_INFO = _create_live_output_profile_group(self.token, 
				...
				LIVE_OUTPUT_TYPE, ARCHIVE_LIVE_OUTPUT_PROFILE, LIVE_OUTPUT_PROFILE, self.debug_mode)
