...
class Nomad_SDK:
	...
	def upload_asset(self, NAME: str | None, EXISTING_ASSET_ID: str | None, 
		...
		try:
			...
			START_UPLOAD_INFO = _start_upload(self.token, self.config["serviceApiUrl"], 
				NAME, EXISTING_ASSET_ID, RELATED_CONTENT_ID, LANGUAGE_ID,
	...
	def upload_related_asset(self, EXISTING_ASSET_ID: str, RELATED_ASSET_ID: str | None,
						  	 NEW_RELATED_ASSET_METATYPE: str | None, FILE: str,
							 UPLOAD_OVERWRITE_OPTION: str, CREATE_TRANSCRIBE_RELATED_ASSET: bool | None,
		...
		try:
			...
			START_UPLOAD_INFO = _start_related_asset_upload(self.token, self.config["serviceApiUrl"],
				EXISTING_ASSET_ID, RELATED_ASSET_ID, NEW_RELATED_ASSET_METATYPE, FILE, 
				UPLOAD_OVERWRITE_OPTION, CREATE_TRANSCRIBE_RELATED_ASSET, LANGUAGE_ID, 
				self.config["debugMode"])
