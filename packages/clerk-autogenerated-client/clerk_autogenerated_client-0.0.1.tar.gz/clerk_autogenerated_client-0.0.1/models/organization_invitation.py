...
from ..models.organization_invitation_role import OrganizationInvitationRole
...
class OrganizationInvitation:
    ...
    Attributes:
        ...
        role (Union[Unset, OrganizationInvitationRole]):
    ...
    role: Union[Unset, OrganizationInvitationRole] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_role, Unset):
            ...
            role = OrganizationInvitationRole(_role)
