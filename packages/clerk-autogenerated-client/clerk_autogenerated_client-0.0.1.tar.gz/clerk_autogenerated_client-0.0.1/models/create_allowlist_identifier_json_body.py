...
T = TypeVar("T", bound="CreateAllowlistIdentifierJsonBody")


@attr.s(auto_attribs=True)
class CreateAllowlistIdentifierJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_allowlist_identifier_json_body = cls(
            identifier=identifier,
            notify=notify,
        )

        return create_allowlist_identifier_json_body
