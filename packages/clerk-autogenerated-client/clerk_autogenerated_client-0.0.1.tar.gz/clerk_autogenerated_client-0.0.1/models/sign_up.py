...
class SignUp:
    ...
    Attributes:
        ...
        web3_wallet (Union[Unset, None, str]):
        ...
        created_session_id (Union[Unset, None, str]):
        created_user_id (Union[Unset, None, str]):
    ...
    web3_wallet: Union[Unset, None, str] = UNSET
    ...
    created_session_id: Union[Unset, None, str] = UNSET
    created_user_id: Union[Unset, None, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        web3_wallet = d.pop("web3_wallet", UNSET)
        ...
        created_session_id = d.pop("created_session_id", UNSET)

        created_user_id = d.pop("created_user_id", UNSET)
