...
if TYPE_CHECKING:
    from ..models.create_actor_token_json_body_actor import CreateActorTokenJsonBodyActor


T = TypeVar("T", bound="CreateActorTokenJsonBody")


@attr.s(auto_attribs=True)
class CreateActorTokenJsonBody:
    """
    Attributes:
        user_id (str): The ID of the user that can use the newly created sign in token.
        actor (CreateActorTokenJsonBodyActor): The actor payload. It needs to include a sub property which should
    ...
    user_id: str
    actor: "CreateActorTokenJsonBodyActor"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        actor = CreateActorTokenJsonBodyActor.from_dict(d.pop("actor"))
        ...
        create_actor_token_json_body = cls(
            user_id=user_id,
            actor=actor,
        ...
        return create_actor_token_json_body
