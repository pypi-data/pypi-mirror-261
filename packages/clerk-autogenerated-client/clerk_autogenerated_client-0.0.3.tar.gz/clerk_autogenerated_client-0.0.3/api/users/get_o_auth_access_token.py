...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/users/{user_id}/oauth_access_tokens/{provider}".format(client.base_url, user_id=user_id, provider=provider)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, List["GetOAuthAccessTokenResponse200Item"]]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, List["GetOAuthAccessTokenResponse200Item"]]]:
    return Response(
