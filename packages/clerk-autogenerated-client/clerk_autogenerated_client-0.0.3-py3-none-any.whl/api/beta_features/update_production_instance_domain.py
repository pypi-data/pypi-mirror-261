...
from ...models.update_production_instance_domain_json_body import UpdateProductionInstanceDomainJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: UpdateProductionInstanceDomainJsonBody,
) -> Dict[str, Any]:
    url = "{}/beta_features/domain".format(client.base_url)
