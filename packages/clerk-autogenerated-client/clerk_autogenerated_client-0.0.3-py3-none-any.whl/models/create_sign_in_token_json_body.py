...
T = TypeVar("T", bound="CreateSignInTokenJsonBody")


@attr.s(auto_attribs=True)
class CreateSignInTokenJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_sign_in_token_json_body = cls(
            user_id=user_id,
            expires_in_seconds=expires_in_seconds,
        )

        create_sign_in_token_json_body.additional_properties = d
        return create_sign_in_token_json_body
