...
if TYPE_CHECKING:
    from ..models.update_jwt_template_json_body_claims import UpdateJWTTemplateJsonBodyClaims


T = TypeVar("T", bound="UpdateJWTTemplateJsonBody")


@attr.s(auto_attribs=True)
class UpdateJWTTemplateJsonBody:
    """
    Attributes:
        name (Union[Unset, str]): JWT template name
        claims (Union[Unset, UpdateJWTTemplateJsonBodyClaims]): JWT template claims in JSON format
    ...
    claims: Union[Unset, "UpdateJWTTemplateJsonBodyClaims"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        claims: Union[Unset, UpdateJWTTemplateJsonBodyClaims]
        if isinstance(_claims, Unset):
            claims = UNSET
        else:
            claims = UpdateJWTTemplateJsonBodyClaims.from_dict(_claims)
        ...
        update_jwt_template_json_body = cls(
            name=name,
            claims=claims,
            lifetime=lifetime,
        ...
        update_jwt_template_json_body.additional_properties = d
        return update_jwt_template_json_body
