...
T = TypeVar("T", bound="UpdateProductionInstanceDomainJsonBody")


@attr.s(auto_attribs=True)
class UpdateProductionInstanceDomainJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_production_instance_domain_json_body = cls(
            home_url=home_url,
        )

        return update_production_instance_domain_json_body
