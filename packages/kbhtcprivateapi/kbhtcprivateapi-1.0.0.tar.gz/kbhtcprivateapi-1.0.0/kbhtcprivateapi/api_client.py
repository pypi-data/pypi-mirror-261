...
from kbhtcprivateapi import rest
from kbhtcprivateapi.configuration import Configuration
from kbhtcprivateapi.exceptions import ApiTypeError, ApiValueError, ApiException
from kbhtcprivateapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancel_post  # this is an instance of the class Endpoint
        api_instance.cancel_post()  # this invokes api_instance.cancel_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_post.callable or self.callable in this class
