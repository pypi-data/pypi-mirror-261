...
StepsType: TypeAlias = typing.Union[KeyedTuple[Step], typing.Mapping[str, Step], typing.Iterable[Step]]
...
class RecipeBundle(Bundle[RecipeRootType], IdMixin, MetaMixin, OptionsMixin, FilesMixin):
    ...
    @tests.setter
    def tests(self, tests: typing.Iterable | None):
        pass
    ...
    def create(self, *,
               id: str | None = None,
               meta: Meta | None = None,
               options: typing.Iterable[Option] | None = None,
               files: typing.Iterable[File] | None = None,
               steps: typing.Iterable[Step],
               tests: typing.Iterable | None = None) -> Self:
    ...
    def _collect_steps(self, node: RecipeRootType, *, args: BundleFactoryArguments) \
            -> typing.Generator[Step, None, None]:
    ...
    def _construct_steps_nodes(self, *, args: BundleConstructionArguments) \
            -> typing.Generator[StepsComplexType, None, None]:
        assert self._steps is not self.__unset, "Uninitialized attribute `steps`"
