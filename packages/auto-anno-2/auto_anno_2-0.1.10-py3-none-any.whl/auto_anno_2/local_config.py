config = {
    ...
    'openai': {
        'key': [
            ...
            # 'sk-jganxZoyZigB5qnK3725E223Ab97449198Ef9f287806E6D3',
        ],
    ...
    'zhipu': {
        'api_key': '982d3f35e6bae4941b9896c1d722f98a.OZB5MXxgV7qa0h11'
    }
}
...
def emb(txt):
    ...
    elif config['emb'] == 'openai':
        from .utils.api.openai_api import emb_aistudio as _emb
    else:
