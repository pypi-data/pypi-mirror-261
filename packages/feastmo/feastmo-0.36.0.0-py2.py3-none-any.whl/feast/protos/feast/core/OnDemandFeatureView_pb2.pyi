...
class OnDemandFeatureViewSpec(google.protobuf.message.Message):
    ...
    ON_DEMAND_SUBSTRAIT_TRANSFORMATION_FIELD_NUMBER: builtins.int
    ...
    @property
    def on_demand_substrait_transformation(self) -> global___OnDemandSubstraitTransformation: ...
    ...
    def __init__(self,
        *,
        ...
        on_demand_substrait_transformation : typing.Optional[global___OnDemandSubstraitTransformation] = ...,
        description : typing.Text = ...,
        tags : typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        owner : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["on_demand_substrait_transformation",b"on_demand_substrait_transformation","transformation",b"transformation","user_defined_function",b"user_defined_function"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","features",b"features","name",b"name","on_demand_substrait_transformation",b"on_demand_substrait_transformation","owner",b"owner","project",b"project","sources",b"sources","tags",b"tags","transformation",b"transformation","user_defined_function",b"user_defined_function"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["transformation",b"transformation"]) -> typing.Optional[typing_extensions.Literal["user_defined_function","on_demand_substrait_transformation"]]: ...
...
class OnDemandSubstraitTransformation(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["substrait_plan",b"substrait_plan"]) -> None: ...
global___OnDemandSubstraitTransformation = OnDemandSubstraitTransformation
