...
class Fuzzer(Thread):
    ...
    def brute(self,params_group,reqtype):
        ...
        if res[3]!="":
            return {"reflects":res[0],"different_type":res[1],"different_status":res[2],"diffs":res[3],"parameters":params_group,"request_type":reqtype,"value_type":self.value_type}
        return None
        ...
        for reqtype in self.request_types:
            ...
            if response != None:
                ...
                if "base" in self.originalresponse:
                    ...
                    if res[3]!="":
                         self.results_queue.put({"reflects":res[0],"different_type":res[1],"different_status":res[2],"diffs":res[3],"parameters":self.baseParams,"request_type":reqtype,"value_type":self.value_type})
            else:
