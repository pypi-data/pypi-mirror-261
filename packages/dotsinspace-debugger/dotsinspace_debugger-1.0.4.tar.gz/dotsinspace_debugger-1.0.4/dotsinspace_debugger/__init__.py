    ...
    try:
        ...
        if error:
            ...
            for e in error:
                ...
                dataToReturn.append(
                    {'message': errorMessageToLog if errorMessageToLog is not None or errorMessageToLog is not '' else 'Error is not tagged soon it will going to be tagged. Please use status for now.', 'status': str(errorStatusToLog)})
