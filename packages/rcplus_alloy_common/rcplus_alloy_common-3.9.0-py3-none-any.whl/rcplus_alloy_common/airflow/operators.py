...
class AlloyEcsRunTaskOperator(EcsRunTaskOperator):
    ...
    def __init__(self, *args, cluster: str = "", tenant: str | None = None, overrides: dict | None = None, **kwargs):
...
class AlloyDbtEcsRunTaskOperator(AlloyEcsRunTaskOperator):
    ...
    template_fields = tuple(AlloyEcsRunTaskOperator.template_fields) + ("database",)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        warnings.warn(
            f"{self.__class__.__name__} will be deprecated. Use AlloyDbtRunRefreshTaskOperator.",
            DeprecationWarning,
            stacklevel=2,
        )
        ...
        super().__init__(*args, task_definition=task_definition, overrides=overrides, **kwargs)
...
class AlloyDbtRunRefreshTaskOperator(AlloyEcsRunTaskOperator):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "overrides" in kwargs:
            self.log.warning(f"The overrides {kwargs['overrides']} will be replaced with {overrides}")
            kwargs.pop("overrides")

        super().__init__(*args, task_definition=task_definition, tenant=tenant, overrides=overrides, **kwargs)
