...
class Postgresql:
    ...
    def convert_decimal_str(string):
        ...
        while ("Decimal('" in string) & (decimal_number < 1e5):
            decimal_number = string[string.find(decimal_pattern) +
                                    len(decimal_pattern):string.find("')")]
            string = string[0:string.find(decimal_pattern)] + \
                     decimal_number + \
                     string[string.find(decimal_pattern) +
                            string[string.find(decimal_pattern):].find("')") + 2:]
