...
class LoadClassModel:
    Classification_Model_Url = "https://d2olrrfwjazc7n.cloudfront.net/website/assets/entity_extraction_model/classification/Classification_Model.zip"
    BASE_DIR = os.getcwd()
    ...
    def load_model(cls):
        try:
            ...
            if os.path.exists(cls.local_zip_file_path) and os.path.exists(os.path.join(cls.extract_to, 'Classification_Model')):
                ...
                model = tensorflow.keras.models.load_model(os.path.join(cls.extract_to, 'Classification_Model'))
                ...
                try:
                    ...
                    response = requests.get(cls.Classification_Model_Url)
