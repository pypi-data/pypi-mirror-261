...
def get_typed_dict_options(cls: Type[T], __pop_keyword: bool = True, __defaults: T | None = None, **kwargs) -> T:
    ...
    for k, v in itm:
        ...
        if (
            k in unm or # key is in the unmangled keywords
            k in ann or # key is a mangled keyword
            m in ann # if the mangled keyword is in the annotations
        ): 
            key = k.split(prv)[-1]
