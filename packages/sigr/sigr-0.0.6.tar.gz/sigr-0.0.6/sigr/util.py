...
# %% auto 0
__all__ = ['getname', 'private', 'mangled', 'unmangle', 'bound_arguments_format', 'decorated_format',
           ...
           'hasvpok', 'parameter_defaults', 'unbound_args', 'unbound_kwargs', 'bind_unbound_args',
           'bind_unbound_kwargs', 'handle_bound_methods', 'handle_bound_variadic']

# %% ../nbs/04_util.ipynb 6
from inspect import (ismethod, Signature, BoundArguments,)
from functools import wraps, partial
from itertools import chain, zip_longest

# %% ../nbs/04_util.ipynb 8
from typing import (Any, Callable, Iterable, Generator, overload)
...
from .grds import (isnone, notnone, istuple, isdict, isvarg, isvkws, isvpos, isvpok, notempty)
