"""
Django settings for sbdemo project.
...
SECRET_KEY = 's7f5e__j##er5e5^x=3wgp)nvabpdrjril$!$w^hix7a2b77n('
...
WSGI_APPLICATION = 'sbdemo.wsgi.application'
...
try:
    from serialbox.tests.local_settings import *
except:
    pass
