...
machine_name_validator = RegexValidator(
    machine_name_regex, _("Only numbers and letters are allowed. " "Invalid API Key.")
)
...
class BaseModel(models.Model):
    created_date = models.DateTimeField(
        ...
        help_text=_("The date and time that " "this record was created"),
        db_index=True,
    )
    modified_date = models.DateTimeField(
        auto_now=True,
        verbose_name=_("Last Modified"),
        help_text=_("The date and time that this" " record was modified last."),
        db_index=True,
    )
...
class Pool(BaseModel):
    ...
    readable_name = models.CharField(
        ...
        help_text=_("A human-readable name for use in GUIs and " "reports and such."),
        unique=True,
    )
    machine_name = models.CharField(
        ...
        help_text=_("A url/api-friendly unique key for use in API calls and " "such."),
        validators=[
    ...
    class Meta:
        ...
        permissions = (("allocate_numbers", "Can allocate numbers."),)
        ordering = ["readable_name", "machine_name"]
...
class Region(BaseModel):
    ...
    pool = models.ForeignKey(
        ...
        help_text=_("The Number Pool this region will " "belong to."),
...
class SequentialRegion(Region):
    ...
    start = models.BigIntegerField(
        ...
        help_text=_("The starting number for this region."),
    )
    end = models.BigIntegerField(
        null=False,
        blank=False,
        verbose_name=_("Ending Number"),
        help_text=_("The ending number for this region."),
    )
    state = models.BigIntegerField(
        ...
        help_text=_(
            "The State represents the current number in use "
    ...
    def save(self, *args, **kwargs):
        ...
        if not hasattr(self, "remaining"):
            ...
            raise AttributeError(
                _(
                    "Region instances must have a remaining "
...
class ResponseTemplate(BaseModel):
    ...
    description = models.TextField(
        ...
        help_text=_("A brief description of what this template does."),
    )
...
class Response(BaseModel):
    ...
    fulfilled = models.BooleanField(
        ...
        help_text=_("Whether or not the full request was fulfilled " "by the system"),
        null=False,
        blank=False,
    )
    type = models.CharField(
        ...
        verbose_name=_("Type"),
        help_text=_(
            "The type of response- either sequential, random, or " "list based."
        ),
    ...
    encoding = models.CharField(
        ...
        help_text=_("The number encoding, choices are base-36, hex or " "decimal."),
    ...
    pool = models.CharField(
        ...
        blank=False,
        verbose_name=_("Pool"),
        help_text=_("The machine_name value of the Pool that served " "the request."),
    )
    ...
    task_name = models.CharField(
        ...
        help_text=_(
            "If a response rule was configured for the pool "
