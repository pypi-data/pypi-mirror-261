...
class CLIWrapper:
    ...
    def __init__(self):
        ...
        sub_command.add_argument("--snapshot", help='Make LVol with snapshot capability, default is on',
                                 required=False, default="on", choices=["on", "off"])
        sub_command.add_argument("--max-size", help='LVol max size', dest='max_size')
