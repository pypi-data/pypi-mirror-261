...
class TestSimple(unittest.TestCase):
    ...
    def test_empty(self):
        ...
        try:
            ...
            self.assertEqual(str(e), "Measurement is not set, Timestamp is not set, Fields are not set, Tags are not set")
        ...
        try:
            ...
            self.assertEqual(str(e), "Timestamp is not set, Fields are not set, Tags are not set")
    ...
    def test_complex_json(self):
        ...
        open("test.txt", "w").write(influx_point.to_line_protocol())
