...
from volstreet.config import logger, token_exchange_dict, latency_logger, thread_local
        ...
        def wrapped(*args, **kwargs):
            with lock:
                ...
                if (
                    ...
                    latency_logger.info(
                        f"In access rate handling for {func.__name__}: Sleeping for {per_seconds} seconds."
                    )
