...
class DictionaryModelComponent(SilicaComponent):
    my_object: Dict = {}
    another = {
        'key1': 'value1',
    }
...
class DictionaryModelsTestCase(SilicaBrowserTestCase):
    ...
    def test_dictionaries_key_binding(self):
        ...
        time.sleep(0.5)
        self.assertTrue("simple: 'new'" in self.selenium.page_source)
    ...
    def test_dictionary_keys_2_levels_deep(self):
        ...
        time.sleep(0.5)
        self.assertTrue("2 levels: 'hey'" in self.selenium.page_source)
