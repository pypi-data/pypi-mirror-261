...
class BVContext:
    ...
    authenticated: bool
    salt: Incomplete
    def __init__(self, session: Session, rewriter: Optional[Rewriter], params: Dict[str, str]) -> None: ...
...
class ProxyServer(socketserver.ThreadingTCPServer):
    ...
    ctxts: Incomplete
    auth: Incomplete
    def __init__(self, server_address, conn: Connection, *, rewriter: Optional[Rewriter] = None, extensions: list[Extension] = [], auth: Optional[Dict[str, str]] = None) -> None: ...
