...
class TestAmznUkScraper:
    ...
    def test_load_item_page(self):
        ...
        solution = scrapr.solve_captcha("https://www.amazon.co.uk/errors/validateCaptcha")
...
confusion.”—Lydia Millet, New York Times Book Review"""  # noqa: RUF001
    ...
    def test_solve_captcha(self, monkeypatch, captcha_filepath):
        ...
        yafmlg_jpg = "https://images-na.ssl-images-amazon.com/captcha/docvmtpr/Captcha_iscohqjxdm.jpg"
        assert scrapr.solve_captcha(yafmlg_jpg) == "YAFMLG"
    ...
    def test_solve_captcha_fail(self, monkeypatch, captcha_notsolved_filepath):
        ...
        assert scrapr.solve_captcha("https://i.ibb.co/Cn2J1mS/notsolved.jpg") == ""
...
def test_get_failover_scraper_item_id_tb(monkeypatch):
    ...
    GIVEN a scraper object
    AND a driver object
    AND a vendor object with the "TBScraper" failover_scraper defined
    AND a item object which contains a "LINK" data element referring to a TB item
    AND a different isbn value
    WHEN I call scraper.get_failover_scraper_item_id with driver, vendor, and item
    THEN a TBScraper object is returned
    AND the TB item id is returned
    """
    isbn = "42"
    tb_id = "1234"
    ...
    s, i = scraper.get_failover_scraper_item_id(driver, vendor, item)
...
def test_get_failover_scraper_item_id_defined_scraper(monkeypatch):
    """
    GIVEN a scraper object
    AND a driver object
    AND a vendor object with the "GJScraper" failover_scraper defined
    AND a item object
    WHEN I call scraper.get_failover_scraper_item_id with driver, vendor, and item
...
def test_get_failover_scraper_item_id_unknown_scraper(monkeypatch):
    """
    GIVEN a scraper object
    AND a driver object
    AND a vendor object with an unknown failover_scraper defined
    AND a item object
    WHEN I call scraper.get_failover_scraper_item_id with driver, vendor, and item
    ...
    driver = Mock()
    vendor = Mock(name="mock_vendor")
    vendor.failover_scraper = "FooBarBaz"
    item = Mock()
    item.isbn = isbn
