...
stats = DNSurlSearch.CacheDnsStat('rasp', 'nicolas@jeudy.mooo.com', 'nicolas@jeudy.mooo.com', 'Filtered url stats test with Pi-Hole')
...
h.set_cache_file_name('pihole.log')
