...
def split_table_in_description(lines: List) -> str:
    """
    Split description tables to improve markdown rendering
    
    Args:
        lines (List): List of lines from the README.md file
        
    Returns:
    str: The description with tables at the end
    """
    normal_lines = []
    table_lines = []
    for line in lines:
    ...
    return LINE_ENDED.join(normal_lines) + LINE_ENDED + "\n".join(table_lines).strip()
