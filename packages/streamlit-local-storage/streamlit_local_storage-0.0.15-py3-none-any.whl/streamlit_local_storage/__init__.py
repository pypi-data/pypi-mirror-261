...
class LocalStorage:
    ...
    def getItem(self, itemKey:str, pause:int=2, key:str="get", default=None):
        """
        ...
        saved_key = self.localStorageManager(method="getItem", itemKey=itemKey, key=key, default=default) 
        if pause != None:
            time.sleep(pause) 
        return saved_key
