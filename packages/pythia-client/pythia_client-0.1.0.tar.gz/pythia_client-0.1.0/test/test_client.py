...
def test_upload_files():
    ...
    meta = [
        {"meta1": "value1", "source_test": "pytest_client_api", "group_id": timestamp},
        {"meta2": "value2", "source_test": "pytest_client_api", "group_id": timestamp},
    ]
...
def test_client_upload_files_from_bytes():
    ...
    meta = [
        {"meta3": "value3", "source_test": "pytest_client_api", "group_id": timestamp},
    ]
    indexing_mode = "unstructured"
    response = client.upload_files(
...
def test_client_get_indexing_task_by_s3_key():
    response = client.get_indexing_task_by_s3_key(group_id=timestamp, s3_key=ValueStorage.s3_keys[0])
