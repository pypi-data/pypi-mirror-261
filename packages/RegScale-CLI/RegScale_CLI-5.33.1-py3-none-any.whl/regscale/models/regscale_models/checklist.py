...
class Checklist(RegScaleModel):
    ...
    @property
    def parentControlId(self) -> int:
        """
        Return the parent control id

        :return: Parent control id
        :rtype: int
        """
        return self.assetId
    ...
    def _get_endpoints(cls) -> ConfigDict:
        """
        Override RegScaleModel and get endpoints for the Checklists model.
        ...
        endpoints = ConfigDict(  # type: ignore
            ...
            get_by_parent="/api/{model_slug}/getAllByParent/{intParentID}",
