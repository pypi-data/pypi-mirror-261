...
def create_or_update_regscale_checklists(*args) -> Checklist:
    ...
    :param args: Tuple containing Application, AWS Finding, AWS Resource, RegScale SSP ID
    ...
    new_checklist = create_checklist(
        existing_asset_id, status, results, comments, finding
    )
...
def create_checklist(
    ...
    :param existing_asset_id: Existing Asset ID
    :param status: Status
    :param results: Results
    :param comments: Comments
    :param finding: AWS Finding
    :return: New Checklist
    :rtype: Checklist
    """
    return Checklist(
