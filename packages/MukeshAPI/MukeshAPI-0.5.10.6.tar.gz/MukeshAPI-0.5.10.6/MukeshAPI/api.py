...
class MukeshAPI:
    ...
    def chatbot(self,args:str)->str:
        ...
        >>> print(response)
        """
        x = m("aHR0cHM6Ly9mYWxsZW54Ym90LnZlcmNlbC5hcHAvYXBpL2FwaWtleT01OTM1NjA4Mjk3LWZhbGxlbi11c2JrMzNrYnN1L2dyb3VwLWNvbnRyb2xsZXIvbXVrZXNoL21lc3NhZ2U9").decode("utf-8")
        full_url = f"{x}{args}"
    ...
    def bhagwatgita(self,chapter: int, shalok: int = 1) -> requests.Response:
        ...
        >>> print(verse_data)
        """
        xc=m("aHR0cHM6Ly93d3cuaG9seS1iaGFnYXZhZC1naXRhLm9yZy9jaGFwdGVyLw==").decode(encoding="utf-8")
        url = f"{xc}{chapter}/hi"
    ...
    >>> print(user_data)"""
        url = m('aHR0cHM6Ly9sZWV0Y29kZS5jb20vZ3JhcGhxbC8=').decode("utf-8")
    ...
    """
        ...
        n = m("aHR0cHM6Ly9weXBpLm9yZy9weXBpLw==").decode("utf-8")
    ...
    """
        ...
        n = m("aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS9zZWFyY2gvcmVwb3NpdG9yaWVzP3E9"
            ).decode("utf-8")
    ...
    """
        ...
        n = m("aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS91c2Vycy8=").decode("utf-8")
    ...
    def meme(self):
        ...
        n = m("aHR0cHM6Ly9tZW1lLWFwaS5jb20vZ2ltbWU=").decode("utf-8")
