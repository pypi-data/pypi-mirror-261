...
from mocr.connection.base import RemoteConnection
from mocr.connection.devtools import DevtoolsConnection
from mocr.constants import TARGET_ATTACH
...
class Connection(EventEmitter, RemoteConnection):
    ...
    async def create_session(self, target_info: dict) -> DevtoolsConnection:
        """
        Create a new `mocr.connection.DevtoolsConnection`.
