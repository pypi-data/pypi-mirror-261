...
from mocr.utils.remote import release_remote_object, serialize_remote_object

if TYPE_CHECKING:
    from mocr.execution.context import ExecutionContext
...
class JavascriptHandle():
    def __init__(
        ...
        JavascriptHandles are created automatically by `mocr.frame.FrameManager`
        and `mocr.browser.WebWorker`.
    ...
    def execution_context(self) -> ExecutionContext:
        """Get `mocr.execution.ExecutionContext` of this handle."""
