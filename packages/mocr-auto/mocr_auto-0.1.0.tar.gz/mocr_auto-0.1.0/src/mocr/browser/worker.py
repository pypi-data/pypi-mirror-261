...
class WebWorker(EventEmitter):
    def __init__(
        ...
        destroyed by it's parent `mocr.browser.Page`.
        ...
        Args:
            ...
            console_api_callback (Callable): Callback to run when the console
                ...
                `mocr.browser.Page`, will delete the handle due to given
    ...
    async def evaluate(self, page_function: str, *args: Any) -> dict | None:
        ...
        Run this `WebWorker`'s `mocr.execution.ExecutionContext.evaluate`.
    ...
    async def evaluate_handle(
        ...
        *args: Any,
        ...
        `mocr.execution.ExecutionContext.evaluate_handle`.
