...
from mocr.connection import Connection
...
from mocr.exceptions import BrowserError
...
class Browser(EventEmitter):
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            browser_type (Literal["chromium", "firefox"]): The type of browser.
            connection (`mocr.network.Connection`): Websocket connection.
    ...
    def process(self) -> Popen | None:
        """The local browser process. If created via `mocr.connect`, will
        return None.
        """
    ...
    def user_agent(self) -> str:
        ...
        with `mocr.browser.Page.set_user_agent`.
        """
    ...
    def browser_contexts(self) -> list[BrowserContext]:
        """
        A list of all `mocr.browser.BrowserContext` instances attached to this
    ...
    def ws_endpoint(self) -> str:
        """
        The websocket URL that this `Browser`'s `mocr.connection.Connection`
        object is using.
        """
    ...
    async def create_incognito_browser_context(self) -> BrowserContext:
        ...
        Returns:
            BrowserContext: A new `mocr.browser.BrowserContext`.
        """
    ...
    async def new_page(self) -> Page:
        ...
        Returns:
            Page: A new `mocr.browser.Page` at "about:blank".
        """
        return await self._default_context.new_page()

    def targets(self) -> list[Target]:
        """
        A list of all `mocr.browser.Target`s in all contexts attached to this
        `Browser` object.
    ...
    async def pages(self) -> list[Page]:
        """
        A list of all `mocr.browser.Page`s in all contexts attached to this
        `Browser` object.
