...
from mocr.browser.browser import Browser
from mocr.browser.target import Target
from mocr.connection import Connection
from mocr.constants import BROWSER_CLOSE
from mocr.download import browser_binary, ensure_binary
from mocr.utils import (
    add_event_listener,
    get_ws_endpoint,
...
class Launcher(ABC):
    ...
    def __init__(
        ...
        Example::
            ...
            async with ChromiumLauncher() as browser:
    ...
    def _default_args(
        ...
        args = args if args else []
        browser_arguments = self._custom_default_args(headless, user_data_dir, devtools)
    ...
    def _print_needs_install_message(binary: str) -> None:
        install_error = (
            ...
            f'\n\t{"*" * 53}'
            "\n\t* Please install binary via \"mocr install\" or       *"
    ...
    async def launch(self) -> Browser:
        """Start browser process and return a `mocr.browser.Browser` object."""
    ...
    async def ensure_initial_page(self, browser: Browser) -> None:
        ...
        Args:
            browser (Browser): Target `mocr.browser.Browser`.
        """
