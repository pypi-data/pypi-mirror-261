...
DEFAULT_FIREFOX_USER_PREFS = {
    ...
    'datareporting.healthreport.documentServerURI': f"http://dummy.test/dummy/healthreport/",
    ...
    'extensions.webservice.discoverURL': f"http://dummy.test/dummy/discoveryURL",
    ...
    'services.settings.server': f"http://dummy.test/dummy/blocklist/",
...
class FirefoxLauncher(Launcher):
    ...
    def _create_profile(self):
        ...
        if os.path.exists(prefs_path):
            prefs_backup_path = os.path.join(self.user_data_dir, "prefs.js.mocr")
    ...
    def _compute_launch_args(
        ...
        if profile_arg_index is not None:
            ...
            data_dir = tempfile.mkdtemp("mocr_dev_firefox_profile-")
