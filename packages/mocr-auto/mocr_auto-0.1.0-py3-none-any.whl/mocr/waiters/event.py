...
class EventWaiter():
    def __init__(
        ...
        the timer is cancelled. Otherwise, a `mocr.exceptions.MocrTimeoutError`
        is raised.
    ...
    async def _timeout_timer(self) -> None:
        ...
        self._reject_callback(
            MocrTimeoutError('Timeout exceeded while waiting for event.')
        )
    ...
    def wait(self) -> Awaitable:
        ...
        timer, otherwise, raise a `mocr.exceptions.MocrTimeoutError` exception.
