...
from mocr.constants import INPUT_TOUCH
from mocr.input.keyboard import Keyboard
...
class Touchscreen():
    def __init__(
        ...
        Args:
            ...
            keyboard (Keyboard): Active `mocr.input.Keyboard` from the parent
                `mocr.input.Keyboard`. Passes active modifiers such as CTRL.
        """
        self._client = client
