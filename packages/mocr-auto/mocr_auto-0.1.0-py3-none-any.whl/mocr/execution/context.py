...
from mocr.utils.remote import format_javascript_exception, is_javascript_method
...
EVALUATION_SCRIPT_URL = '__mocr_evaluation_script__'
...
class ExecutionContext():
    def __init__(
        ...
        Args:
            ...
            object_handle_factory (Any): Factory for handling remote objects.
                Should create `mocr.execution.JavascriptHandle` based objects.
            frame (Frame, optional): The `mocr.frame.Frame` that spawned this.
                Defaults to None.
        """
        self._client = client
        self._frame = frame
    ...
    def frame(self) -> Frame | None:
        """Parent `mocr.frame.Frame` that spawned this."""
        return self._frame
    ...
    async def evaluate(
        ...
        *args: Any,
        ...
        `mocr.execution.JavascriptHandle.json` on the result to return the
