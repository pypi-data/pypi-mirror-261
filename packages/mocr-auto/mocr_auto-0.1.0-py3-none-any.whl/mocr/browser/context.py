...
class BrowserContext(EventEmitter):
    def __init__(self, browser: Browser, context_id: str | None) -> None:
        ...
        context that `mocr.browser.Browser` starts with will be incognito.

        Args:
            browser (Browser): Parent `mocr.browser.Browser` object from which
    ...
    def incognito(self) -> bool:
        ...
        context spawned when the `mocr.browser.Browser` object is spawned is
        not incognito.
        """
    ...
    def browser(self) -> Browser:
        """The `mocr.browser.Browser` object this context is attached to."""
        return self._browser

    def targets(self) -> list[Target]:
        """
        A list of all `mocr.browser.Target`s in this context.
    ...
    async def pages(self) -> list[Page]:
        """
        A list of all `mocr.browser.Page`s in this context.
