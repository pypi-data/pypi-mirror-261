...
from mocr.connection.connection import DevtoolsConnection
from mocr.constants import EMULATION_ENABLE_TOUCH, EMULATION_OVERRIDE_METRICS
...
class ViewportManager():
    def __init__(self, client: DevtoolsConnection) -> None:
        ...
        Args:
            client (DevtoolsConnection): `mocr.network.DevtoolsConnection`
                object, shared from the parent `mocr.browser.Page`.
        """
        self._client = client
