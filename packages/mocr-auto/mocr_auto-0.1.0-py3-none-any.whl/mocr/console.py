...
from mocr.constants import LIFECYCLE_EVENTS
from mocr.download import ensure_binary, install_binary
...
async def scrape(
    ...
    Args:
        browser_type (str): Either "chromium" or "firefox".
...
def main() -> None:
    parser = ArgumentParser("mocr", description="A remote-controlled browser.")
