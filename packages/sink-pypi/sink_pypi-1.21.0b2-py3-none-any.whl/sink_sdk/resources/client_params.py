...
from ..types import (
    ...
    client_param_with_query_param_params,
)
...
__all__ = ["ClientParams", "AsyncClientParams"]


class ClientParams(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> ClientParamsWithRawResponse:
        return ClientParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ClientParamsWithStreamingResponse:
        return ClientParamsWithStreamingResponse(self)
    ...
    def with_query_param(
        ...
        *,
        ...
        """
        if client_path_or_query_param is None:
            client_path_or_query_param = self._client._get_client_path_or_query_param_query_param()
        if client_query_param is None:
            client_query_param = self._client._get_client_query_param_query_param()
        return self._post(
...
class AsyncClientParams(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncClientParamsWithRawResponse:
        return AsyncClientParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncClientParamsWithStreamingResponse:
        return AsyncClientParamsWithStreamingResponse(self)
...
class ClientParamsWithRawResponse:
    def __init__(self, client_params: ClientParams) -> None:
        self._client_params = client_params

        self.with_path_param = to_raw_response_wrapper(
            client_params.with_path_param,
        )
        self.with_path_param_and_standard = to_raw_response_wrapper(
            client_params.with_path_param_and_standard,
        )
        self.with_query_param = to_raw_response_wrapper(
            client_params.with_query_param,
        )


class AsyncClientParamsWithRawResponse:
    def __init__(self, client_params: AsyncClientParams) -> None:
        self._client_params = client_params

        self.with_path_param = async_to_raw_response_wrapper(
            client_params.with_path_param,
        )
        self.with_path_param_and_standard = async_to_raw_response_wrapper(
            client_params.with_path_param_and_standard,
        )
        self.with_query_param = async_to_raw_response_wrapper(
            client_params.with_query_param,
        )


class ClientParamsWithStreamingResponse:
    def __init__(self, client_params: ClientParams) -> None:
        self._client_params = client_params
...
class AsyncClientParamsWithStreamingResponse:
    def __init__(self, client_params: AsyncClientParams) -> None:
        self._client_params = client_params
