...
from .union_types import (
    ...
    UnionTypesWithStreamingResponse,
    AsyncUnionTypesWithStreamingResponse,
)
...
class Responses(SyncAPIResource):
    @cached_property
    def union_types(self) -> UnionTypes:
        return UnionTypes(self._client)
...
class AsyncResponses(AsyncAPIResource):
    @cached_property
    def union_types(self) -> AsyncUnionTypes:
        return AsyncUnionTypes(self._client)
...
class ResponsesWithRawResponse:
    ...
    @cached_property
    def union_types(self) -> UnionTypesWithRawResponse:
        return UnionTypesWithRawResponse(self._responses.union_types)
...
class AsyncResponsesWithRawResponse:
    ...
    @cached_property
    def union_types(self) -> AsyncUnionTypesWithRawResponse:
        return AsyncUnionTypesWithRawResponse(self._responses.union_types)
...
class ResponsesWithStreamingResponse:
    ...
    @cached_property
    def union_types(self) -> UnionTypesWithStreamingResponse:
        return UnionTypesWithStreamingResponse(self._responses.union_types)
...
class AsyncResponsesWithStreamingResponse:
    ...
    @cached_property
    def union_types(self) -> AsyncUnionTypesWithStreamingResponse:
        return AsyncUnionTypesWithStreamingResponse(self._responses.union_types)
