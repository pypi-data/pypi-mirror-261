...
__all__ = ["SchemaTypes", "AsyncSchemaTypes"]


class SchemaTypes(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> SchemaTypesWithRawResponse:
        return SchemaTypesWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> SchemaTypesWithStreamingResponse:
        return SchemaTypesWithStreamingResponse(self)
...
class AsyncSchemaTypes(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncSchemaTypesWithRawResponse:
        return AsyncSchemaTypesWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncSchemaTypesWithStreamingResponse:
        return AsyncSchemaTypesWithStreamingResponse(self)
...
class SchemaTypesWithRawResponse:
    def __init__(self, schema_types: SchemaTypes) -> None:
...
class AsyncSchemaTypesWithRawResponse:
    def __init__(self, schema_types: AsyncSchemaTypes) -> None:
        self._schema_types = schema_types
...
class SchemaTypesWithStreamingResponse:
    def __init__(self, schema_types: SchemaTypes) -> None:
        self._schema_types = schema_types
...
class AsyncSchemaTypesWithStreamingResponse:
    def __init__(self, schema_types: AsyncSchemaTypes) -> None:
        self._schema_types = schema_types
