...
class Duplicates(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> DuplicatesWithRawResponse:
        return DuplicatesWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> DuplicatesWithStreamingResponse:
        return DuplicatesWithStreamingResponse(self)
...
class AsyncDuplicates(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncDuplicatesWithRawResponse:
        return AsyncDuplicatesWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncDuplicatesWithStreamingResponse:
        return AsyncDuplicatesWithStreamingResponse(self)
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"id": body_id}, duplicate_body_and_path_params.DuplicateBodyAndPathParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
    ...
    async def query_and_body(
        ...
        *,
        ...
        return await self._post(
            "/mixed_params/duplicates/query_and_body",
            body=await async_maybe_transform(
                {"id": body_id}, duplicate_query_and_body_params.DuplicateQueryAndBodyParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                ...
                query=await async_maybe_transform(
                    {"id": query_id}, duplicate_query_and_body_params.DuplicateQueryAndBodyParams
                ),
            ),
            cast_to=BasicSharedModelObject,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                idempotency_key=idempotency_key,
                query=await async_maybe_transform(
                    {"id": query_id}, duplicate_query_and_path_params.DuplicateQueryAndPathParams
                ),
            ),
            cast_to=BasicSharedModelObject,
        )
...
class DuplicatesWithStreamingResponse:
    def __init__(self, duplicates: Duplicates) -> None:
        self._duplicates = duplicates
...
class AsyncDuplicatesWithStreamingResponse:
    def __init__(self, duplicates: AsyncDuplicates) -> None:
        self._duplicates = duplicates
