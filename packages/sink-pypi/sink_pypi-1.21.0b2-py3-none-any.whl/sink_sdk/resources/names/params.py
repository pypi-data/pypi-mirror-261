...
class Params(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> ParamsWithRawResponse:
        return ParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ParamsWithStreamingResponse:
        return ParamsWithStreamingResponse(self)
...
class AsyncParams(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncParamsWithRawResponse:
        return AsyncParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncParamsWithStreamingResponse:
        return AsyncParamsWithStreamingResponse(self)
...
class ParamsWithStreamingResponse:
    def __init__(self, params: Params) -> None:
        self._params = params
...
class AsyncParamsWithStreamingResponse:
    def __init__(self, params: AsyncParams) -> None:
        self._params = params
