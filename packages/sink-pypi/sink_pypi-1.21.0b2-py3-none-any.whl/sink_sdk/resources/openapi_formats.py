...
class OpenapiFormats(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> OpenapiFormatsWithRawResponse:
        return OpenapiFormatsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> OpenapiFormatsWithStreamingResponse:
        return OpenapiFormatsWithStreamingResponse(self)
...
class AsyncOpenapiFormats(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncOpenapiFormatsWithRawResponse:
        return AsyncOpenapiFormatsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncOpenapiFormatsWithStreamingResponse:
        return AsyncOpenapiFormatsWithStreamingResponse(self)
...
class OpenapiFormatsWithStreamingResponse:
    def __init__(self, openapi_formats: OpenapiFormats) -> None:
        self._openapi_formats = openapi_formats
...
class AsyncOpenapiFormatsWithStreamingResponse:
    def __init__(self, openapi_formats: AsyncOpenapiFormats) -> None:
        self._openapi_formats = openapi_formats
