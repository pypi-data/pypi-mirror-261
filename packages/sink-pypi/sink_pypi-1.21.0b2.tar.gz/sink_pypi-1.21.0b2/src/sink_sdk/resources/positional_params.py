...
class PositionalParams(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> PositionalParamsWithRawResponse:
        return PositionalParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> PositionalParamsWithStreamingResponse:
        return PositionalParamsWithStreamingResponse(self)
...
class AsyncPositionalParams(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncPositionalParamsWithRawResponse:
        return AsyncPositionalParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncPositionalParamsWithStreamingResponse:
        return AsyncPositionalParamsWithStreamingResponse(self)
...
class PositionalParamsWithStreamingResponse:
    def __init__(self, positional_params: PositionalParams) -> None:
        self._positional_params = positional_params
...
class AsyncPositionalParamsWithStreamingResponse:
    def __init__(self, positional_params: AsyncPositionalParams) -> None:
        self._positional_params = positional_params
