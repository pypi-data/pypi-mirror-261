...
class EmptyBody(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> EmptyBodyWithRawResponse:
        return EmptyBodyWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> EmptyBodyWithStreamingResponse:
        return EmptyBodyWithStreamingResponse(self)
...
class AsyncEmptyBody(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncEmptyBodyWithRawResponse:
        return AsyncEmptyBodyWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncEmptyBodyWithStreamingResponse:
        return AsyncEmptyBodyWithStreamingResponse(self)
...
class EmptyBodyWithStreamingResponse:
    def __init__(self, empty_body: EmptyBody) -> None:
        self._empty_body = empty_body
...
class AsyncEmptyBodyWithStreamingResponse:
    def __init__(self, empty_body: AsyncEmptyBody) -> None:
        self._empty_body = empty_body
