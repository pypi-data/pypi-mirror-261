...
class ModelReferencedInParentAndChildResourceWithRawResponse:
    ...
    def child(self) -> ChildWithRawResponse:
        return ChildWithRawResponse(self._model_referenced_in_parent_and_child.child)
...
class AsyncModelReferencedInParentAndChildResourceWithRawResponse:
    ...
    def child(self) -> AsyncChildWithRawResponse:
        return AsyncChildWithRawResponse(self._model_referenced_in_parent_and_child.child)
...
class ModelReferencedInParentAndChildResourceWithStreamingResponse:
    ...
    def child(self) -> ChildWithStreamingResponse:
        return ChildWithStreamingResponse(self._model_referenced_in_parent_and_child.child)
...
class AsyncModelReferencedInParentAndChildResourceWithStreamingResponse:
    ...
    def child(self) -> AsyncChildWithStreamingResponse:
        return AsyncChildWithStreamingResponse(self._model_referenced_in_parent_and_child.child)
