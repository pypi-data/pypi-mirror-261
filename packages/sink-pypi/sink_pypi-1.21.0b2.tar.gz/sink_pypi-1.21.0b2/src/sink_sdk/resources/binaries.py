...
class Binaries(SyncAPIResource):
    ...
    @cached_property
    def with_streaming_response(self) -> BinariesWithStreamingResponse:
        return BinariesWithStreamingResponse(self)
...
class AsyncBinaries(AsyncAPIResource):
    ...
    @cached_property
    def with_streaming_response(self) -> AsyncBinariesWithStreamingResponse:
        return AsyncBinariesWithStreamingResponse(self)
...
class BinariesWithStreamingResponse:
    def __init__(self, binaries: Binaries) -> None:
        self._binaries = binaries
...
class AsyncBinariesWithStreamingResponse:
    def __init__(self, binaries: AsyncBinaries) -> None:
        self._binaries = binaries
