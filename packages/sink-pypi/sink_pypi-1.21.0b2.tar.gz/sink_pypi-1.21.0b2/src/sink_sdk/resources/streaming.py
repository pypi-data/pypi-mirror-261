...
class Streaming(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> StreamingWithRawResponse:
        return StreamingWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> StreamingWithStreamingResponse:
        return StreamingWithStreamingResponse(self)
...
class AsyncStreaming(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncStreamingWithRawResponse:
        return AsyncStreamingWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncStreamingWithStreamingResponse:
        return AsyncStreamingWithStreamingResponse(self)
...
class StreamingWithStreamingResponse:
    def __init__(self, streaming: Streaming) -> None:
        self._streaming = streaming
...
class AsyncStreamingWithStreamingResponse:
    def __init__(self, streaming: AsyncStreaming) -> None:
        self._streaming = streaming
