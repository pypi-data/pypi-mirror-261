...
class QueryParams(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> QueryParamsWithRawResponse:
        return QueryParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> QueryParamsWithStreamingResponse:
        return QueryParamsWithStreamingResponse(self)
    ...
    def array(
        self,
        *,
        integer_array_param: Iterable[int] | NotGiven = NOT_GIVEN,
...
class AsyncQueryParams(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncQueryParamsWithRawResponse:
        return AsyncQueryParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncQueryParamsWithStreamingResponse:
        return AsyncQueryParamsWithStreamingResponse(self)
...
class QueryParamsWithStreamingResponse:
    def __init__(self, query_params: QueryParams) -> None:
        self._query_params = query_params
...
class AsyncQueryParamsWithStreamingResponse:
    def __init__(self, query_params: AsyncQueryParams) -> None:
        self._query_params = query_params
