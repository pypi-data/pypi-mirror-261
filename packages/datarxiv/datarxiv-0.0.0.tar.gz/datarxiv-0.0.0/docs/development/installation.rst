...
The latest released version of :obj:`datarxiv` can be installed from `PyPI <https://pypi.org/project/datarxiv/>`_ using `pip`.
...
.. code-block:: console
   ...
   $ python3 -m pip install git+https://github.com/bernardodionisi/datarxiv.git

Or from a specific branch.

.. code-block:: console

   $ python3 -m pip install git+https://github.com/bernardodionisi/datarxiv.git@branch
...
fashion from a local folder. This allows any changes in the current directory to be immediately seen upon the next `import datarxiv`.

Clone the repo wherever you'd like.

.. code-block:: console

    $ git clone https://github.com/bernardodionisi/datarxiv.git

Install the local folder using the `-e` or `--editable` flag.

.. code-block:: console

    $ python3 -m pip install -e datarxiv/
...
.. code-block:: console
   ...
   $ python3 -m pip install datarxiv[dev]
