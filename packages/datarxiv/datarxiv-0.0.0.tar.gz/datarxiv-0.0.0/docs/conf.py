...
# confuses Sphinx when parsing overloaded functions. When not building the documentation, the @set_module("datarxiv")
...
html_title = "datarxiv"
# html_favicon = "../logo/datarxiv-favicon-color.png"
# html_logo = "../logo/datarxiv-favicon-white.png"
...
html_theme_options = {
    ...
    "site_url": "https://datarxiv.readthedocs.io/",  # todo: <---- no read the docs?
    "repo_url": "https://github.com/bernardodionisi/datarxiv",
    "repo_name": "bernardodionisi/datarxiv",
    "social": [
        {
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/bernardodionisi/datarxiv",
        },
        {
            "icon": "fontawesome/brands/python",
            "link": "https://pypi.org/project/datarxiv/",
        },
    ],
    "edit_uri": "",
...
ipython_execlines = ["import datarxiv"]
...
#     member for member in dir(datarxiv.Array) if inspect.isdatadescriptor(getattr(type(datarxiv.Array), member, None))
# ]
# for p in ArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     ArrayMeta_property = getattr(datarxiv._domains._meta.ArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     delattr(datarxiv._domains._meta.ArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(datarxiv.Array, p, classproperty(ArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     setattr(datarxiv._domains._meta.ArrayMeta, p, ArrayMeta_property)
# 
# 
# FieldArrayMeta_properties = [
#     member
#     for member in dir(datarxiv.FieldArray)
#     if inspect.isdatadescriptor(getattr(type(datarxiv.FieldArray), member, None))
# ]
# for p in FieldArrayMeta_properties:
#     # Fetch the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         ArrayMeta_property = getattr(datarxiv._domains._meta.ArrayMeta, p)
#     FieldArrayMeta_property = getattr(datarxiv._fields._meta.FieldArrayMeta, p)
# 
#     # Temporarily delete the class properties from the private metaclasses
#     if p in ArrayMeta_properties:
#         delattr(datarxiv._domains._meta.ArrayMeta, p)
#     delattr(datarxiv._fields._meta.FieldArrayMeta, p)
# 
#     # Add a Python 3.9 style class property to the public class
#     setattr(datarxiv.FieldArray, p, classproperty(FieldArrayMeta_property))
# 
#     # Add back the class properties to the private metaclasses
#     if p in ArrayMeta_properties:
#         setattr(datarxiv._domains._meta.ArrayMeta, p, ArrayMeta_property)
#     setattr(datarxiv._fields._meta.FieldArrayMeta, p, FieldArrayMeta_property)
