    ...
    <div className="flex">
      ...
      <div className="flex-1 flex flex-col h-[100vh] overflow-auto  ">
        <div className="h-100 border-b border-customGray  w-[100%] px-8 py-4 flex flex-col justify-between gap-3">
          ...
          <h6 className="text-[18px] font-cerebriregular text-blackText">
            Profile
          </h6>
        ...
        <div className=" font-cerebriregular mt-4 mb-6">
          <div className="flex gap-8">
            <img src={userProfile} />
            <div className="text-customBlue text-[16px] gap-4 justify-center flex flex-col ">
              <div className="bg-customsky p-3 flex w-[114px] rounded-[10px] gap-3 ">
                <img src={gallery} />
                <span className="">Change</span>
              </div>
              <div className=" p-3 flex w-[114px] rounded-[10px] gap-3 border border-customBlue">
                <img src={trash} />
                <span>Remove</span>
              </div>
            </div>
      ...
      />
      <button className="bg-customBlue py-4 px-5 text-white w-[152px] rounded-[10px]" onClick={handleLogOut}>Logout</button>
          </div>
        </div>
        </div>
