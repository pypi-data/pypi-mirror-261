    ...
    <div className="flex font-cerebriregular">
      ...
      <div className="flex-1 flex-col h-[100vh] overflow-auto  ">
        <div className="h-100 border-b border-customGray  w-[100%] px-8 py-4 flex flex-col justify-between gap-3">
          <h2 className="text-[26px] font-cerebri text-blackText leading-[27px]">
            Settings
          </h2>
        ...
        <div className="px-6 py-10 flex-1">
          <div className="grid grid-cols-1 gap-9">
            <div className="flex bg-lightSky rounded-[10px] p-2 w-[335px] sm:w-[310px] h-[58px]">
              <div
                className={`px-5 py-2 sm:px-3 sm:text-[16px] flex gap-2 justify-center items-center cursor-pointer rounded-[10px] ${
                  selectedTab === 0 ? "bg-white text-customBlue" : "bg-lightSky"
                }`}
                onClick={() => handleTabClick(0)}
              >
                <img
                  src={selectedTab === 0 ? apperance : apperance1}
                  className="w-5 h-5  "
                />
                <span>Appearance</span>
              </div>
              <div
                className={`px-4 py-2  sm:px-3 sm:text-[16px] flex gap-2 justify-center items-center cursor-pointer rounded-[10px] ${
                  selectedTab === 1 ? "bg-white text-customBlue" : "bg-lightSky"
                }`}
                onClick={() => handleTabClick(1)}
              >
                <img
                  src={selectedTab === 0 ? setting : setting1}
                  className="w-5 h-5  "
                />
              ...
              <div className="grid grid-cols-1 gap-9">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="text-[16px] flex flex-col justify-around">
                      <p className="text-customBlue underline ">Change Logo</p>
                ...
                <div>
                  ...
                  <div className="flex gap-4 sm:grid sm:grid-cols-4">
                    <div className="rounded-[10px] border border-customGray w-[72px] h-[72px] flex items-center justify-center ">
                      <img src={grey} />
                    </div>
                    <div className="rounded-[10px] border border-customGray w-[72px] h-[72px] flex items-center justify-center">
                      <img src={yellow} />
            ...
            {selectedTab === 1 && (
              <div className="grid grid-cols-1 gap-10 w-1/3 lg:w-[100%] font-cerebriregular text-[16px]">
                <div>
                  ...
                  <select
                    id="language"
                    className="w-[310px] h-12 p-2 border border-gray-300 rounded-[10px] shadow-sm bg-gray-100 focus:outline-none"
                ...
                <div className="grid grid-cols-1 gap-6">
                  <div className="flex justify-between items-center">
                    <p>Archived chats</p>
                    <button className="bg-customGray py-2 px-4 rounded-[10px]">
                      Manage
                    </button>
                  </div>
                  <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <p>Delete Account</p>
                  <button className="bg-[#E84141] text-white py-2 px-4 rounded-[10px]">
                      Delete
                    </button>
                </div>
              </div>
