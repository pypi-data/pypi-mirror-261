...
def data_agent(data_tool):
    return KomodoAgent(shortcode="librarian",
                       ...
                       instructions='You MUST use the data sources available to retrieve the information needed for the task. Do not use any other sources. Describe answers in detail of up to 600 words and cite the sources.',
                       tools=[data_tool])
