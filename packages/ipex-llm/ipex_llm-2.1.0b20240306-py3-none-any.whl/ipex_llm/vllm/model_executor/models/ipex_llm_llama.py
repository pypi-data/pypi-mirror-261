...
class IpexLLMLlamaForCausalLM(IpexLLMModelForCausalLM):
    ...
    def forward(
        ...
        if is_decoding_stage:
            ...
            ipex_llm_kv_cache = construct_kv_cache_func(cur_seq_ids,
        ...
        if is_decoding_stage:
            if enable_vllm_se_batching:
                ...
                for seq_group_meta_data in seq_group_meta_data_lists:
                    ...
                    current_seq_len = ipex_llm_kv_cache[0][batch][0].size(2)
                    batch += 1
                    seq_ids = list(seq_group_meta_data.seq_data.keys())
