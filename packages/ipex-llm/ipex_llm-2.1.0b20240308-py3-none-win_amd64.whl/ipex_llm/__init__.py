...
if BIGDL_COMPATIBLE_MODE:
    ...
    ipex_llm_modules = [module_name for module_name in sys.modules if 'ipex_llm' in module_name]
    for module in ipex_llm_modules:
        bigdl_llm_module = module.replace('ipex_llm', 'bigdl.llm')
        sys.modules[bigdl_llm_module] = sys.modules[module]
