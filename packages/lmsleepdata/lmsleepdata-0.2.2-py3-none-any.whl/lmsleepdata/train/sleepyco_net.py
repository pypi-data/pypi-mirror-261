...
feature_len_dict = [[12, 60, 300], [24, 120, 600], [36, 180, 900], [48, 240, 1200], [60, 300, 1500], [72, 360, 1800],
                 [84, 420, 2100], [96, 480, 2400], [108, 540, 2700], [120, 600, 3000]]
...
class Transformer(nn.Module):
    ...
    def __init__(self, nheads, num_encoder_layers, pool='attn'):
        ...
        self.fc = nn.Linear(self.model_dim, 5)
