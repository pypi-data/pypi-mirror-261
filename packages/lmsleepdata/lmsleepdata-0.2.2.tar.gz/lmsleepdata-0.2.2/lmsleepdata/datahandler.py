...
class DataHandler(object):
    ...
    def load_data_file(self, data_name, eeg_path, acc_path, ble_path, sti_path, person_info=None):
        ...
        if eeg_2_channel.shape[0] > 2:
            self.ECG = (eeg_2_channel[2, :] - 32767) / 65536 * 2.5 * 1000 * 1000 / 100 / 1000  # mV
            self.EMG = (eeg_2_channel[3, :] - 32767) / 65536 * 2.5 * 1000 * 1000 / 100 / 1000  # mV
    ...
    def load_data(self, device_type, data_name, data_path, patient_info=None):
        ...
        self.header_mac, self.box_mac = self.get_mac(self.data_path)
        eeg_path = None
        acc_path = None
        sti_path = None
        ble_path = None
    ...
    def get_mac(self, data_path):
        data_path = os.path.join(data_path, 'eeg.eeg')
