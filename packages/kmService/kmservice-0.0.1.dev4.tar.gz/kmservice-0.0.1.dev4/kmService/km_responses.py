...
class KmLintMeasure:
    ...
    def display(self) -> str:
        ...
        """
        # todo: make helper function so it can be used on more places.
    ...
    def geojson(self) -> str:
        ...
        Returns:
            The GeoJSON string.
        """
        return dumps(GeoJsonFeatureCollection(self.get_geojson_features()), indent=4)
...
class PointResponse:
    ...
    Args:
        ...
        km_line: The kilometers line.
        km_point: The kilometers point.
        reference_line: The reference line, if any.
    """
        ...
        if self.reference_line:
            features.append(
                GeoJsonFeature(
                    ...
                    {"type": "raai", "km": self.input_data.input_km},
                )
            )
        return features
