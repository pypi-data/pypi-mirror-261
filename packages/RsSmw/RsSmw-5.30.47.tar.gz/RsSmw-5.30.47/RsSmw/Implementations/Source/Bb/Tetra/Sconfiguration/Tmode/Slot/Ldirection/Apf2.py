...
class Apf2Cls:
	...
	def set(self, apf_2: List[str], testMode=repcap.TestMode.Default, slot=repcap.Slot.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tetra.sconfiguration.tmode.slot.ldirection.apf2.set(apf_2 = ['rawAbc1', 'rawAbc2', 'rawAbc3'], testMode = repcap.TestMode.Default, slot = repcap.Slot.Default, channel = repcap.Channel.Default) \n
