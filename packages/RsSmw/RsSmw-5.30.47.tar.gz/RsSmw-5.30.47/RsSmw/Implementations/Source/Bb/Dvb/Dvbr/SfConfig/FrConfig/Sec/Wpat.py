...
class WpatCls:
	...
	def set(self, wpat: List[str], sfCfgIxNull=repcap.SfCfgIxNull.Default, frCfgIxNull=repcap.FrCfgIxNull.Default, indexNull=repcap.IndexNull.Default) -> None:
		...
		Snippet: driver.source.bb.dvb.dvbr.sfConfig.frConfig.sec.wpat.set(wpat = ['rawAbc1', 'rawAbc2', 'rawAbc3'], sfCfgIxNull = repcap.SfCfgIxNull.Default, frCfgIxNull = repcap.FrCfgIxNull.Default, indexNull = repcap.IndexNull.Default) \n
