...
class TpatternCls:
	...
	def set(self, tpattern: List[str], bitcount: int, testMode=repcap.TestMode.Default, slot=repcap.Slot.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tetra.sconfiguration.tmode.slot.ldirection.tpattern.set(tpattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, testMode = repcap.TestMode.Default, slot = repcap.Slot.Default, channel = repcap.Channel.Default) \n
