...
class ZpiCls:
	...
	def set(self, zero_pow_conf: List[str], cellNull=repcap.CellNull.Default, indexNull=repcap.IndexNull.Default) -> None:
		...
		Snippet: driver.source.bb.v5G.downlink.csis.cell.zprs.zpi.set(zero_pow_conf = ['rawAbc1', 'rawAbc2', 'rawAbc3'], cellNull = repcap.CellNull.Default, indexNull = repcap.IndexNull.Default) \n
