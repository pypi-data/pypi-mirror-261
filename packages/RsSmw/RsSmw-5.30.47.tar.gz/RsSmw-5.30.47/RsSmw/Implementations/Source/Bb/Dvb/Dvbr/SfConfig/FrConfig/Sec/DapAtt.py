...
class DapAttCls:
	...
	def set(self, dap_att: List[str], bitcount: int, sfCfgIxNull=repcap.SfCfgIxNull.Default, frCfgIxNull=repcap.FrCfgIxNull.Default, indexNull=repcap.IndexNull.Default) -> None:
		...
		Snippet: driver.source.bb.dvb.dvbr.sfConfig.frConfig.sec.dapAtt.set(dap_att = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, sfCfgIxNull = repcap.SfCfgIxNull.Default, frCfgIxNull = repcap.FrCfgIxNull.Default, indexNull = repcap.IndexNull.Default) \n
