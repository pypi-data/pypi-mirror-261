...
class SdPatternCls:
	...
	def set(self, sd_pattern: List[str], bitcount: int, testMode=repcap.TestMode.Default, slot=repcap.Slot.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tetra.sconfiguration.tmode.slot.ldirection.sdata.sdPattern.set(sd_pattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, testMode = repcap.TestMode.Default, slot = repcap.Slot.Default, channel = repcap.Channel.Default) \n
