...
class Apf1Cls:
	...
	def set(self, apf_1: List[str], testMode=repcap.TestMode.Default, slot=repcap.Slot.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tetra.sconfiguration.tmode.slot.ldirection.apf1.set(apf_1 = ['rawAbc1', 'rawAbc2', 'rawAbc3'], testMode = repcap.TestMode.Default, slot = repcap.Slot.Default, channel = repcap.Channel.Default) \n
