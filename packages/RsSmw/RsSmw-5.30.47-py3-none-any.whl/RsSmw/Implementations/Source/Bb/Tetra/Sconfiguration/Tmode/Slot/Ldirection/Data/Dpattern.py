...
class DpatternCls:
	...
	def set(self, dpattern: List[str], bitcount: int, testMode=repcap.TestMode.Default, slot=repcap.Slot.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tetra.sconfiguration.tmode.slot.ldirection.data.dpattern.set(dpattern = ['rawAbc1', 'rawAbc2', 'rawAbc3'], bitcount = 1, testMode = repcap.TestMode.Default, slot = repcap.Slot.Default, channel = repcap.Channel.Default) \n
