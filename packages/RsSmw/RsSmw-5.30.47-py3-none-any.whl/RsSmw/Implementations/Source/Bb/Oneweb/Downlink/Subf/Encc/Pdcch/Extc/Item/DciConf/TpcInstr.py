...
class TpcInstrCls:
	...
	def set(self, tpc_command: List[str], subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> None:
		...
		Snippet: driver.source.bb.oneweb.downlink.subf.encc.pdcch.extc.item.dciConf.tpcInstr.set(tpc_command = ['rawAbc1', 'rawAbc2', 'rawAbc3'], subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
