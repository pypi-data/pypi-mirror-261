...
for i in range(3):
    myrio1.write_digital_port(myRIO_library.RED)
    time.sleep(1)
    myrio1.write_digital_port(myRIO_library.GREEN)
    time.sleep(1)
    myrio1.write_digital_port(myRIO_library.BLUE)
    time.sleep(1)

print('End of digital tests')
myrio1.write_digital_port(myRIO_library.RGB_OFF)