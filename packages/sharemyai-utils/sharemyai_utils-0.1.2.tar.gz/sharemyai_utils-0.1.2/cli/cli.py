...
from .lib import create_venv, get_and_download_plugin, get_current_user, get_my_workers, install_requirements, install_torch_requirements, login_with_token, post_register_worker, run_plugin
...
def run_worker(plugin_id):
    ...
    # then, run the plugin
    run_plugin(venv_path, plugin_path)
    return
