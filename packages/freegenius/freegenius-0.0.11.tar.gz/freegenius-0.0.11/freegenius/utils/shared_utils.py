...
City: {g.city}"""
    ...
    def add_tool(signature):
        ...
        collection = SharedUtil.get_tool_collection("tools")
        metadata = {
            "name": name,
...
class CallOllama:
    ...
    def runCompletion(messages: dict, noFunctionCall: bool = False):
        ...
        if noFunctionCall:
            ...
            # 2. Tool Selection
            tool_name, tool_schema = CallOllama.selectTool(user_request)
    ...
    @staticmethod
    @check_ollama_errors
    def screen_user_request(messages: dict, user_request: str, model: str = config.ollamaDefaultModel) -> bool:
        """
...
"""
    ...
    def selectTool(user_request):
        ...
        return metadatas["name"], json.loads(metadatas["parameters"])
