...
class ModuleCatalog(QWidget):
    ...
    def __init__(self, parent_host, claid, host_name):
        ...
        for category_index, module_category in enumerate(modules_by_categories):
            ...
            list_widget.addItems(module_list)  # Add some example items
            list_widget.setMaximumHeight(200)  #  the value as needed
        ...
        # Create layout for the QGraphicsView
    ...
    def handle_list_selection(self):
        ...
        print("list selection done")

    def on_module_selected(self, item_text):
        # You can fill out this function with your custom logic
    ...
    def show_information_for_module(self, module_type: str):
        ...
        self.rect_item.set_id(module_type)
    ...
    def generate_channel_descriptions(self, module_annotation):
        ...
        for channel, description in zip(module_annotation.channel_definition, module_annotation.channel_description):
            ...
            print(channel)
            data_types_dict[channel.channel] = channel.WhichOneof("payload_oneof")
    ...
    def on_ok_button_clicked(self):
        ...
        while(len(properties) > 0 and len(empty_properties) != 0):

            property_dialog = PropertyInputDialog(properties, property_descriptions, property_hints)
            property_dialog.exec_()

            if(property_dialog.cancelled()):
                return
            
            self.defined_properties = property_dialog.get_defined_properties()
        ...
        module = self.parent_host.add_module(module_name, module_type, 0, 0, input_channels, output_channels,\
