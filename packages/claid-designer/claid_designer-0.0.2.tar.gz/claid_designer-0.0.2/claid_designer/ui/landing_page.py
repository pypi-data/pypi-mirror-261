...
class LandingPage(QWidget):
    ...
    def init_ui(self):
        ...
        title.setFont(QFont("San Francisco", 20, QFont.Bold, False))
        ...
        label.setFont(QFont("San Francisco", 36, QFont.Bold, False))
        label.setAlignment(Qt.AlignCenter)
        label.setStyleSheet("color: #FFFFFF")
        layout.addWidget(label)
        layout.addStretch(2)

         # Centered a rounded Start button
        self.start_button = QPushButton("Begin")
        self.start_button.setStyleSheet("QPushButton { font-family: San Francisco, sans-serif; font-size: 18px; background-color: #F44336; color: white; border: none; border-radius: 10px; font-weight: bold; }"
                                    "QPushButton:hover { background-color: #E57373; }"
                                    "QPushButton:pressed { background-color: #B71C1C; }")
        self.start_button.setMinimumWidth(200)  # Adjust the width as needed
        self.start_button.setMinimumHeight(50)  # Adjust the height as needed
        ...
        info_text.setFont(QFont("San Francisco", 16))
        ...
        link_label.setFont(QFont("San Francisco", 16))
        # linkLabel.setStyleSheet("margin-top: 20px;")  # Add some space above the link
        ...
        self.line_edit.setMinimumWidth(200)  # Adjust the width as needed
        self.line_edit.setMinimumHeight(25)  # Adjust the height as needed
        self.line_edit.setStyleSheet("QLineEdit { background-color: white; border-radius: 5px; }")
        self.line_edit.move(self.start_button.pos())
        ...
        # Example pictures (replace these paths with your actual picture paths)
        ...
        speakers = QLabel("""<b>Speakers:</b><br>
                          ...
                          Fan Wu (fanwu@ethz.ch)<br>
                          Stephan Altmüller (stephan@klaravision.com)""", self)
        speakers.setFont(QFont("San Francisco", 16))
        ...
        pixmap2 = QPixmap(os.path.join(current_path, "images", "amld_logo.png"))
        ...
        close_button.setStyleSheet(
            "QPushButton { background-color: none; color: white; border: none; }"
    ...
    def mousePressEvent(self, event: QMouseEvent):
        if event.button() == Qt.LeftButton:
            self.dragging = True
            #TODO: The dragging produces an error if you click on button and move the mouse outside button
    ...
    def animate_line_edit(self):
        ...
        self.setFocus()
        start_pos = self.start_button.pos()
        end_pos = self.start_button.pos() - QPoint(0, self.start_button.geometry().height())
