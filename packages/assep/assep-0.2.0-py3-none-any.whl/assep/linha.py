class Linha:
    ...
    def __create_dicInfo_LinhaAnafas(self):
        ...
        dicinfo_linhaAnafas["suscept_neg"] = (52,57)
    ...
    def __get_dataANF(self):
        ...
        dic["suscept_neg"] = self.line_code[self.dicInfo_LinhaAnafas["suscept_neg"][0]:self.dicInfo_LinhaAnafas["suscept_neg"][1]].strip()
    ...
    def analyze_linha_ana(self, list_dic_dlin):
        """
        ...
        for index, dic in enumerate(list_dic_dlin):
            ...
            if dic["codigo_atualizacao"] == "" or dic["codigo_atualizacao"] == "0" or dic["codigo_atualizacao"] == "A":
                ...
                #     if not (df_Barra["Tipo MidPoint"][df_Barra["Número"] == dic["barra_de"]]).empty:
                #         tipo_barra_de = (df_Barra["Tipo MidPoint"][df_Barra["Número"] == dic["barra_de"]]).iloc[0]
                ...
                # if (dic["tipo_circuito"] == "T"):
                #     # Verifica se a barra existe no servidor SIGER
                #     if not (df_Barra["Tipo MidPoint"][df_Barra["Número"] == dic["barra_para"]]).empty:
                #         tipo_barra_para = (df_Barra["Tipo MidPoint"][df_Barra["Número"] == dic["barra_para"]]).iloc[0]
    ...
    def analyze_linha_from_folder(self, path_decks):        
        # Análise deck a deck
        dic_errors = {}
        for index, deck in enumerate(path_decks):
            ...
            if extension == "PWF":
                ...
                list_errors = self.analyze_linha_ana(list_dic)
