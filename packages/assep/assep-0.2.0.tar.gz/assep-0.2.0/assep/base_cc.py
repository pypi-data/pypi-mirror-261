...
class BaseCC:
    ...
    def analise_cc_only(self, dic_ANA, dic_results):
        ...
        df_DBAR_15 = (df_DBAR_15[df_DBAR_15.duplicated("Nome", keep=False)]).sort_values(by='Nome', ascending=False)
        dic_results["df_DBAR_15"] = df_DBAR_15
    ...
    def __make_estado_global(self, Estado, Estado_De, Estado_Para):
        Estado_Global = "" if ((Estado == "") and (Estado_De == "") and (Estado_Para == "")) else "D"
