...
def install():
    """
    Run pip-sync and install 'tinkerforge2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(
        module=tinkerforge2mqtt,
        package_path=PACKAGE_ROOT,
        distribution_name='tinkerforge2mqtt',
    )
...
def fix_code_style(color: bool, verbosity: int):
    """
    Fix code style of all tinkerforge2mqtt source code files via darker
    """
