...
class AnalyzerSegmentColumnsDiagnosticRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, interval, dataset_id, analyzer_id, segment, *args, **kwargs):  # noqa: E501
        """AnalyzerSegmentColumnsDiagnosticRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, interval, dataset_id, analyzer_id, segment, *args, **kwargs):  # noqa: E501
        """AnalyzerSegmentColumnsDiagnosticRequest - a model defined in OpenAPI
