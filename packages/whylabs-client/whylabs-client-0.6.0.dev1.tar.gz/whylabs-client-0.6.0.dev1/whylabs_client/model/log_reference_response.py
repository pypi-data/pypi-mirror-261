...
class LogReferenceResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, model_id, alias, upload_timestamp, upload_url, *args, **kwargs):  # noqa: E501
        """LogReferenceResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, model_id, alias, upload_timestamp, upload_url, *args, **kwargs):  # noqa: E501
        """LogReferenceResponse - a model defined in OpenAPI
